...
public class CertificateRequest {
  ...
  public static org.bouncycastle.tls.CertificateRequest parse(TlsContext paramTlsContext, InputStream paramInputStream) throws IOException {
    ProtocolVersion protocolVersion = paramTlsContext.getServerVersion();
    ...
    if (bool1) {
      ...
      return new org.bouncycastle.tls.CertificateRequest(arrayOfByte1, vector2, vector3, vector4);
    } 
    ...
    return new org.bouncycastle.tls.CertificateRequest(arrayOfShort, vector, vector1);
  }
}


/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\tls\CertificateRequest.class
