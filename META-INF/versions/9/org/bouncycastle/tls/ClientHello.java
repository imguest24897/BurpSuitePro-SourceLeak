...
public class ClientHello {
  ...
  public static org.bouncycastle.tls.ClientHello parse(ByteArrayInputStream paramByteArrayInputStream, OutputStream paramOutputStream) throws TlsFatalAlert {
    try {
  ...
  private static org.bouncycastle.tls.ClientHello implParse(ByteArrayInputStream paramByteArrayInputStream, OutputStream paramOutputStream) throws IOException {
    ...
    return new org.bouncycastle.tls.ClientHello(protocolVersion, arrayOfByte1, arrayOfByte2, arrayOfByte3, arrayOfInt, hashtable, -1);
  }
}


/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\tls\ClientHello.class
