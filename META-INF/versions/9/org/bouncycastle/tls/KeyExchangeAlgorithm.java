...
public class KeyExchangeAlgorithm {
  ...
  public static boolean isAnonymous(int paramInt) {
    switch (paramInt) {
      case 11:
      case 12:
      case 20:
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\tls\KeyExchangeAlgorithm.class
