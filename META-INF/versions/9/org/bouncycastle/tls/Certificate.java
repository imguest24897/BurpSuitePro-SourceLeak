...
public class Certificate {
  ...
  public static final org.bouncycastle.tls.Certificate EMPTY_CHAIN = new org.bouncycastle.tls.Certificate(EMPTY_CERTS);
  
  public static final org.bouncycastle.tls.Certificate EMPTY_CHAIN_TLS13 = new org.bouncycastle.tls.Certificate(TlsUtils.EMPTY_BYTES, EMPTY_CERT_ENTRIES);
  ...
  public static org.bouncycastle.tls.Certificate parse(TlsContext paramTlsContext, InputStream paramInputStream, OutputStream paramOutputStream) throws IOException {
    return parse(new ParseOptions(), paramTlsContext, paramInputStream, paramOutputStream);
  }
  
  public static org.bouncycastle.tls.Certificate parse(ParseOptions paramParseOptions, TlsContext paramTlsContext, InputStream paramInputStream, OutputStream paramOutputStream) throws IOException {
    ...
    if (i == 0)
      return !bool ? EMPTY_CHAIN : ((arrayOfByte1.length < 1) ? EMPTY_CHAIN_TLS13 : new org.bouncycastle.tls.Certificate(s, arrayOfByte1, EMPTY_CERT_ENTRIES)); 
    ...
    return new org.bouncycastle.tls.Certificate(s, arrayOfByte1, arrayOfCertificateEntry);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\tls\Certificate.class
