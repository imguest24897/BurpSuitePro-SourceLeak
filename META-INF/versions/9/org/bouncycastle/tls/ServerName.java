...
public final class ServerName {
  ...
  public static org.bouncycastle.tls.ServerName parse(InputStream paramInputStream) throws IOException {
    short s = TlsUtils.readUint8(paramInputStream);
    byte[] arrayOfByte = TlsUtils.readOpaque16(paramInputStream, 1);
    return new org.bouncycastle.tls.ServerName(s, arrayOfByte);
  }
}


/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\tls\ServerName.class
