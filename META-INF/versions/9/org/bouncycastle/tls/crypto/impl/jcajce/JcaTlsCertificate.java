...
public class JcaTlsCertificate implements TlsCertificate {
  ...
  public static org.bouncycastle.tls.crypto.impl.jcajce.JcaTlsCertificate convert(JcaTlsCrypto paramJcaTlsCrypto, TlsCertificate paramTlsCertificate) throws IOException {
    return (paramTlsCertificate instanceof org.bouncycastle.tls.crypto.impl.jcajce.JcaTlsCertificate) ? (org.bouncycastle.tls.crypto.impl.jcajce.JcaTlsCertificate)paramTlsCertificate : new org.bouncycastle.tls.crypto.impl.jcajce.JcaTlsCertificate(paramJcaTlsCrypto, paramTlsCertificate.getEncoded());
  }
  ...
  public TlsEncryptor createEncryptor(int paramInt) throws IOException {
    ...
    switch (paramInt) {
      case 3:
        ...
        return (TlsEncryptor)new JcaTlsRSAEncryptor(this.crypto, this.pubKeyRSA);
    } 
  ...
  public TlsVerifier createVerifier(short paramShort) throws IOException {
    ...
    switch (paramShort) {
      case 2:
        return (TlsVerifier)new JcaTlsDSAVerifier(this.crypto, getPubKeyDSS());
      case 3:
        return (TlsVerifier)new JcaTlsECDSAVerifier(this.crypto, getPubKeyEC());
      case 1:
        validateRSA_PKCS1();
        return (TlsVerifier)new JcaTlsRSAVerifier(this.crypto, getPubKeyRSA());
      case 9:
      case 10:
      case 11:
        validateRSA_PSS_PSS(paramShort);
        i = SignatureScheme.from((short)8, paramShort);
        return (TlsVerifier)new JcaTlsRSAPSSVerifier(this.crypto, getPubKeyRSA(), i);
      case 4:
      case 5:
      case 6:
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\tls\crypto\impl\jcajce\JcaTlsCertificate.class
