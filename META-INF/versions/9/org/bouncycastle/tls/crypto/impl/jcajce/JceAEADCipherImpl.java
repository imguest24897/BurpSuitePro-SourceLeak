...
public class JceAEADCipherImpl implements TlsAEADCipherImpl {
  ...
  private static boolean checkForAEAD() {
    return ((Boolean)AccessController.<Boolean>doPrivileged((PrivilegedAction<Boolean>)new Object())).booleanValue();
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\tls\crypto\impl\jcajce\JceAEADCipherImpl.class
