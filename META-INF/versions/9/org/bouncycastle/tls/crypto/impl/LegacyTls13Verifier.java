...
public final class LegacyTls13Verifier implements TlsVerifier {
  ...
  public TlsStreamVerifier getStreamVerifier(DigitallySigned paramDigitallySigned) throws IOException {
    ...
    byte[] arrayOfByte = paramDigitallySigned.getSignature();
    return (TlsStreamVerifier)new Object(this, arrayOfByte);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\tls\crypto\impl\LegacyTls13Verifier.class
