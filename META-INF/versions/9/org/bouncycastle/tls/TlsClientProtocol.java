...
public class TlsClientProtocol extends TlsProtocol {
  ...
  public void connect(TlsClient paramTlsClient) throws IOException {
    ...
    paramTlsClient.init((TlsClientContext)this.tlsClientContext);
    paramTlsClient.notifyCloseHandle((TlsCloseable)this);
  ...
  protected TlsContext getContext() {
    return (TlsContext)this.tlsClientContext;
  }
  
  AbstractTlsContext getContextAdmin() {
    return (AbstractTlsContext)this.tlsClientContext;
  }
  
  protected TlsPeer getPeer() {
    return (TlsPeer)this.tlsClient;
  }
    ...
    switch (paramShort) {
      case 11:
        switch (this.connection_state) {
          ...
          case 11:
            receive13ServerCertificate((ByteArrayInputStream)paramHandshakeMessageInput);
      ...
      case 13:
        switch (this.connection_state) {
          case 21:
            throw new TlsFatalAlert((short)10);
          case 5:
            receive13CertificateRequest((ByteArrayInputStream)paramHandshakeMessageInput, false);
      ...
      case 15:
        switch (this.connection_state) {
          case 7:
            receive13ServerCertificateVerify((ByteArrayInputStream)paramHandshakeMessageInput);
      ...
      case 8:
        switch (this.connection_state) {
          case 4:
            receive13EncryptedExtensions((ByteArrayInputStream)paramHandshakeMessageInput);
      ...
      case 20:
        switch (this.connection_state) {
          ...
          case 9:
            receive13ServerFinished((ByteArrayInputStream)paramHandshakeMessageInput);
            paramHandshakeMessageInput.updateHash((TlsHash)this.handshakeHash);
            ...
            if (null != this.certificateRequest) {
              ...
              if (null != tlsCredentialedSigner) {
                DigitallySigned digitallySigned = TlsUtils.generate13CertificateVerify((TlsContext)this.tlsClientContext, tlsCredentialedSigner, this.handshakeHash);
            ...
            TlsUtils.establish13PhaseApplication((TlsContext)this.tlsClientContext, arrayOfByte, this.recordStream);
      ...
      case 24:
        ...
        return;
      case 4:
        receive13NewSessionTicket((ByteArrayInputStream)paramHandshakeMessageInput);
        return;
      case 2:
        switch (this.connection_state) {
          case 1:
            throw new TlsFatalAlert((short)80);
          case 3:
            serverHello = receiveServerHelloMessage((ByteArrayInputStream)paramHandshakeMessageInput);
    ...
    switch (paramShort) {
      case 11:
        switch (this.connection_state) {
          ...
          case 6:
            this.authentication = TlsUtils.receiveServerCertificate((TlsClientContext)this.tlsClientContext, this.tlsClient, (ByteArrayInputStream)paramHandshakeMessageInput, this.serverExtensions);
            break;
          default:
            throw new TlsFatalAlert((short)10);
        } 
        ...
        switch (this.connection_state) {
          case 7:
            if (securityParameters.getStatusRequestVersion() < 1)
              throw new TlsFatalAlert((short)10); 
            this.certificateStatus = CertificateStatus.parse((TlsContext)this.tlsClientContext, (InputStream)paramHandshakeMessageInput);
            assertEmpty((ByteArrayInputStream)paramHandshakeMessageInput);
      ...
      case 23:
        switch (this.connection_state) {
          case 4:
            handleSupplementalData(readSupplementalDataMessage((ByteArrayInputStream)paramHandshakeMessageInput));
            return;
        } 
        throw new TlsFatalAlert((short)10);
      case 14:
        switch (this.connection_state) {
          ...
          case 11:
            ...
            bool = TlsUtils.isSSL((TlsContext)this.tlsClientContext);
            if (bool)
              establishMasterSecret((TlsContext)this.tlsClientContext, this.keyExchange); 
            securityParameters.sessionHash = TlsUtils.getCurrentPRFHash(this.handshakeHash);
            if (!bool)
              establishMasterSecret((TlsContext)this.tlsClientContext, this.keyExchange); 
            this.recordStream.setPendingCipher(TlsUtils.initCipher((TlsContext)this.tlsClientContext));
            if (tlsCredentialedSigner != null) {
              DigitallySigned digitallySigned = TlsUtils.generateCertificateVerifyClient((TlsClientContext)this.tlsClientContext, tlsCredentialedSigner, signatureAndHashAlgorithm, tlsStreamSigner, this.handshakeHash);
      ...
      case 12:
        switch (this.connection_state) {
          ...
          case 8:
            handleServerCertificate();
            this.keyExchange.processServerKeyExchange((InputStream)paramHandshakeMessageInput);
            assertEmpty((ByteArrayInputStream)paramHandshakeMessageInput);
            break;
          default:
            throw new TlsFatalAlert((short)10);
      ...
      case 13:
        switch (this.connection_state) {
          ...
          case 8:
            ...
            this.keyExchange.skipServerKeyExchange();
          case 10:
            receiveCertificateRequest((ByteArrayInputStream)paramHandshakeMessageInput);
      ...
      case 4:
        switch (this.connection_state) {
          case 18:
            ...
            receiveNewSessionTicket((ByteArrayInputStream)paramHandshakeMessageInput);
            break;
          default:
            throw new TlsFatalAlert((short)10);
        } 
  ...
  protected void handleServerCertificate() throws IOException {
    TlsUtils.processServerCertificate((TlsClientContext)this.tlsClientContext, this.certificateStatus, this.keyExchange, this.authentication, this.clientExtensions, this.serverExtensions);
  }
  ...
  protected void handleSupplementalData(Vector paramVector) throws IOException {
    ...
    this.keyExchange = TlsUtils.initKeyExchangeClient((TlsClientContext)this.tlsClientContext, this.tlsClient);
  }
  ...
  protected void process13HelloRetryRequest(ServerHello paramServerHello) throws IOException {
    ...
    TlsUtils.negotiatedVersionTLSClient((TlsClientContext)this.tlsClientContext, this.tlsClient);
  ...
  protected void process13ServerHello(ServerHello paramServerHello, boolean paramBoolean) throws IOException {
    ...
    this.clientAgreements = null;
    this.clientBinders = null;
    TlsUtils.establish13PhaseSecrets((TlsContext)this.tlsClientContext, tlsSecret1, tlsSecret2);
    invalidateSession();
    this.tlsSession = TlsUtils.importSession(securityParameters.getSessionID(), null);
  }
  ...
  protected void process13ServerHelloCoda(ServerHello paramServerHello, boolean paramBoolean) throws IOException {
    ...
    TlsUtils.establish13PhaseHandshake((TlsContext)this.tlsClientContext, arrayOfByte, this.recordStream);
    if (!paramBoolean) {
  ...
  protected void receive13CertificateRequest(ByteArrayInputStream paramByteArrayInputStream, boolean paramBoolean) throws IOException {
    ...
    if (this.selectedPSK13)
      throw new TlsFatalAlert((short)10); 
    CertificateRequest certificateRequest = CertificateRequest.parse((TlsContext)this.tlsClientContext, paramByteArrayInputStream);
  ...
  protected void receive13ServerCertificate(ByteArrayInputStream paramByteArrayInputStream) throws IOException {
    if (this.selectedPSK13)
      throw new TlsFatalAlert((short)10); 
    this.authentication = TlsUtils.receive13ServerCertificate((TlsClientContext)this.tlsClientContext, this.tlsClient, paramByteArrayInputStream, this.serverExtensions);
    handleServerCertificate();
  }
  ...
  protected void receive13ServerCertificateVerify(ByteArrayInputStream paramByteArrayInputStream) throws IOException {
    ...
    if (null == certificate || certificate.isEmpty())
      throw new TlsFatalAlert((short)80); 
    CertificateVerify certificateVerify = CertificateVerify.parse((TlsContext)this.tlsClientContext, paramByteArrayInputStream);
    assertEmpty(paramByteArrayInputStream);
    TlsUtils.verify13CertificateVerifyServer((TlsClientContext)this.tlsClientContext, this.handshakeHash, certificateVerify);
  }
  ...
  protected void send13ClientHelloRetry() throws IOException {
    ...
    if (null != this.clientBinders) {
      this.clientBinders = TlsUtils.addPreSharedKeyToClientHelloRetry((TlsClientContext)this.tlsClientContext, this.clientBinders, hashtable);
      if (null == this.clientBinders)
        this.tlsClient.notifySelectedPSK(null); 
    } 
    if (this.retryGroup < 0)
      throw new TlsFatalAlert((short)80); 
    this.clientAgreements = TlsUtils.addKeyShareToClientHelloRetry((TlsClientContext)this.tlsClientContext, hashtable, this.retryGroup);
    this.recordStream.setIgnoreChangeCipherSpec(true);
    sendChangeCipherSpecMessage();
  ...
  protected void sendClientHello() throws IOException {
    ...
    securityParameters.clientRandom = createRandomBlock(bool3, (TlsContext)this.tlsClientContext);
    ...
    this.clientBinders = TlsUtils.addPreSharedKeyToClientHello((TlsClientContext)this.tlsClientContext, this.tlsClient, this.clientExtensions, arrayOfInt);
    this.clientAgreements = TlsUtils.addKeyShareToClientHello((TlsClientContext)this.tlsClientContext, this.tlsClient, this.clientExtensions);
  ...
  protected void sendClientHelloMessage() throws IOException {
    ...
    this.clientHello.encode((TlsContext)this.tlsClientContext, (OutputStream)handshakeMessageOutput);
    handshakeMessageOutput.prepareClientHello(this.handshakeHash, this.clientHello.getBindersSize());
    if (null != this.clientBinders)
      OfferedPsks.encodeBinders((OutputStream)handshakeMessageOutput, this.tlsClientContext.getCrypto(), this.handshakeHash, this.clientBinders); 
  ...
  protected void sendClientKeyExchange() throws IOException {
    ...
    this.keyExchange.generateClientKeyExchange((OutputStream)handshakeMessageOutput);
    handshakeMessageOutput.send(this);
  }
  ...
  protected void skip13ServerCertificate() throws IOException {
    if (!this.selectedPSK13)
      throw new TlsFatalAlert((short)10); 
    this.authentication = TlsUtils.skip13ServerCertificate((TlsClientContext)this.tlsClientContext);
  }
}


/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\tls\TlsClientProtocol.class
