...
class Poly {
  ...
  public static void baseMultMontgomery(org.bouncycastle.pqc.crypto.crystals.kyber.Poly paramPoly1, org.bouncycastle.pqc.crypto.crystals.kyber.Poly paramPoly2, org.bouncycastle.pqc.crypto.crystals.kyber.Poly paramPoly3) {
    for (byte b = 0; b < 64; b++) {
  ...
  public void addCoeffs(org.bouncycastle.pqc.crypto.crystals.kyber.Poly paramPoly) {
    for (byte b = 0; b < 'Ā'; b++)
  ...
  public void polySubtract(org.bouncycastle.pqc.crypto.crystals.kyber.Poly paramPoly) {
    for (byte b = 0; b < 'Ā'; b++)
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\pqc\crypto\crystals\kyber\Poly.class
