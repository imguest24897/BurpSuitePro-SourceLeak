...
class Utils {
  ...
  static ASN1ObjectIdentifier kyberOidLookup(KyberParameters paramKyberParameters) {
    return (ASN1ObjectIdentifier)kyberOids.get(paramKyberParameters);
  }
  
  static KyberParameters kyberParamsLookup(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    return (KyberParameters)kyberParams.get(paramASN1ObjectIdentifier);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\pqc\crypt\\util\Utils.class
