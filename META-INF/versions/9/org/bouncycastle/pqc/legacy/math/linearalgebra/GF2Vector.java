...
public class GF2Vector extends Vector {
  ...
  public GF2Vector(org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector paramGF2Vector) {
  ...
  public static org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector OS2VP(int paramInt, byte[] paramArrayOfbyte) {
    if (paramInt < 0)
      throw new ArithmeticException("negative length"); 
    int i = paramInt + 7 >> 3;
    if (paramArrayOfbyte.length > i)
      throw new ArithmeticException("length mismatch"); 
    return new org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector(paramInt, LittleEndianConversions.toIntArray(paramArrayOfbyte));
  }
  ...
  public Vector add(Vector paramVector) {
    if (!(paramVector instanceof org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector))
      throw new ArithmeticException("vector is not defined over GF(2)"); 
    org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector gF2Vector = (org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector)paramVector;
    if (this.length != gF2Vector.length)
      throw new ArithmeticException("length mismatch"); 
    int[] arrayOfInt = IntUtils.clone(((org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector)paramVector).v);
    for (int i = arrayOfInt.length - 1; i >= 0; i--)
      arrayOfInt[i] = arrayOfInt[i] ^ this.v[i]; 
    return new org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector(this.length, arrayOfInt);
  }
  ...
  public Vector multiply(Permutation paramPermutation) {
    ...
    if (this.length != arrayOfInt.length)
      throw new ArithmeticException("length mismatch"); 
    org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector gF2Vector = new org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector(this.length);
  ...
  public org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector extractVector(int[] paramArrayOfint) {
    int i = paramArrayOfint.length;
    if (paramArrayOfint[i - 1] > this.length)
      throw new ArithmeticException("invalid index set"); 
    org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector gF2Vector = new org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector(i);
    for (byte b = 0; b < i; b++) {
  ...
  public org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector extractLeftVector(int paramInt) {
    if (paramInt > this.length)
      throw new ArithmeticException("invalid length"); 
    if (paramInt == this.length)
      return new org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector(this); 
    org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector gF2Vector = new org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector(paramInt);
    int i = paramInt >> 5;
    int j = paramInt & 0x1F;
  ...
  public org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector extractRightVector(int paramInt) {
    if (paramInt > this.length)
      throw new ArithmeticException("invalid length"); 
    if (paramInt == this.length)
      return new org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector(this); 
  ...
  public boolean equals(Object paramObject) {
    if (!(paramObject instanceof org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector))
      return false; 
    org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector gF2Vector = (org.bouncycastle.pqc.legacy.math.linearalgebra.GF2Vector)paramObject;
    return (this.length == gF2Vector.length && IntUtils.equals(this.v, gF2Vector.v));
  }
  
  public int hashCode() {
    null = this.length;
    return null * 31 + Arrays.hashCode(this.v);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\pqc\legacy\math\linearalgebra\GF2Vector.class
