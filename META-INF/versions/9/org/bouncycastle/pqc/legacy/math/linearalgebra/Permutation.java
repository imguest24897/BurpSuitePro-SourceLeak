...
public class Permutation {
  ...
  public org.bouncycastle.pqc.legacy.math.linearalgebra.Permutation computeInverse() {
    org.bouncycastle.pqc.legacy.math.linearalgebra.Permutation permutation = new org.bouncycastle.pqc.legacy.math.linearalgebra.Permutation(this.perm.length);
    for (int i = this.perm.length - 1; i >= 0; i--)
      permutation.perm[this.perm[i]] = i; 
    return permutation;
  }
  
  public org.bouncycastle.pqc.legacy.math.linearalgebra.Permutation rightMultiply(org.bouncycastle.pqc.legacy.math.linearalgebra.Permutation paramPermutation) {
  ...
  public boolean equals(Object paramObject) {
    if (!(paramObject instanceof org.bouncycastle.pqc.legacy.math.linearalgebra.Permutation))
      return false; 
    org.bouncycastle.pqc.legacy.math.linearalgebra.Permutation permutation = (org.bouncycastle.pqc.legacy.math.linearalgebra.Permutation)paramObject;
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\pqc\legacy\math\linearalgebra\Permutation.class
