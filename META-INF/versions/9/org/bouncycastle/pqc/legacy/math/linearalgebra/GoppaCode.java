...
public final class GoppaCode {
  ...
  public static MaMaPe computeSystematicForm(GF2Matrix paramGF2Matrix, SecureRandom paramSecureRandom) {
    ...
    while (true) {
      ...
      if (bool) {
        GF2Matrix gF2Matrix3 = (GF2Matrix)gF2Matrix.rightMultiply((Matrix)gF2Matrix1);
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\pqc\legacy\math\linearalgebra\GoppaCode.class
