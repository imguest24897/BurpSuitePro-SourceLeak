...
public final class ByteUtils {
  ...
  public static byte[] fromHexString(String paramString) {
    char[] arrayOfChar = Strings.toUpperCase(paramString).toCharArray();
    byte b1 = 0;
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\pqc\legacy\math\linearalgebra\ByteUtils.class
