...
abstract class JsseUtils {
  ...
  static String getJcaSignatureAlgorithmBC(String paramString1, String paramString2) {
    return !paramString1.endsWith("withRSAandMGF1") ? paramString1 : (paramString1 + ":" + paramString1);
  }
  
  static String getKeyType13(String paramString, int paramInt) {
    return (paramInt < 0) ? paramString : (paramString + "/" + paramString);
  }
  ...
  static String getAlertRaisedLogMessage(String paramString, short paramShort1, short paramShort2) {
    return paramString + " raised " + paramString + " " + AlertLevel.getText(paramShort1) + " alert";
  }
  
  static String getAlertReceivedLogMessage(String paramString, short paramShort1, short paramShort2) {
    return paramString + " received " + paramString + " " + AlertLevel.getText(paramShort1) + " alert";
  }
  ...
  static BCSNIServerName convertSNIServerName(ServerName paramServerName) {
    ...
    return (BCSNIServerName)new BCUnknownServerName(s, arrayOfByte);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\jsse\provider\JsseUtils.class
