...
class ProvX509KeyManager extends BCX509ExtendedKeyManager {
  private static final Logger LOG = Logger.getLogger(org.bouncycastle.jsse.provider.ProvX509KeyManager.class.getName());
  ...
  private final Map<String, SoftReference<KeyStore.PrivateKeyEntry>> cachedEntries = Collections.synchronizedMap((Map<String, SoftReference<KeyStore.PrivateKeyEntry>>)new Object(this, 16, 0.75F, true));
  ...
  private static void addECFilter13(Map<String, PublicKeyFilter> paramMap, int paramInt) {
    ...
    if (null != str) {
      ...
      if (null != aSN1ObjectIdentifier) {
        ...
        addFilterToMap(paramMap, str1, (PublicKeyFilter)eCPublicKeyFilter13);
        return;
      } 
    } 
  ...
  private static void addFilter(Map<String, PublicKeyFilter> paramMap, int paramInt, String paramString, Class<? extends PublicKey> paramClass, String... paramVarArgs) {
    ...
    for (String str : paramVarArgs)
      addFilterToMap(paramMap, str, (PublicKeyFilter)defaultPublicKeyFilter); 
  }
  ...
  protected BCX509Key getKeyBC(String paramString1, String paramString2) {
    ...
    return (BCX509Key)(TlsUtils.isNullOrEmpty((Object[])arrayOfX509Certificate) ? null : new ProvX509Key(paramString1, privateKey, arrayOfX509Certificate));
  }
  ...
  private BCX509Key createKeyBC(String paramString1, int paramInt, String paramString2, KeyStore paramKeyStore, X509Certificate[] paramArrayOfX509Certificate) throws KeyStoreException, NoSuchAlgorithmException, UnrecoverableKeyException {
    ...
    return (BCX509Key)((key instanceof PrivateKey) ? new ProvX509Key(paramString1, (PrivateKey)key, paramArrayOfX509Certificate) : null);
  }
  ...
  private static String getAlias(Match paramMatch, String paramString) {
    return "" + paramMatch.builderIndex + "." + paramMatch.builderIndex + paramMatch.localAlias;
  }
  ...
  private static boolean isSuitableChain(boolean paramBoolean1, JcaJceHelper paramJcaJceHelper, X509Certificate[] paramArrayOfX509Certificate, BCAlgorithmConstraints paramBCAlgorithmConstraints, boolean paramBoolean2) {
    try {
      ...
      byte b = -1;
      ProvAlgorithmChecker.checkChain(paramBoolean1, paramJcaJceHelper, paramBCAlgorithmConstraints, set, paramArrayOfX509Certificate, keyPurposeId, b);
      return true;
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\jsse\provider\ProvX509KeyManager.class
