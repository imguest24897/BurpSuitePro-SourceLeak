...
class ProvSSLServerSocket extends SSLServerSocket {
  ...
  public synchronized Socket accept() throws IOException {
    ...
    implAccept((Socket)provSSLSocketDirect);
    provSSLSocketDirect.notifyConnected();
    return (Socket)provSSLSocketDirect;
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\jsse\provider\ProvSSLServerSocket.class
