...
class ProvX509Key implements BCX509Key {
  private static final Logger LOG = Logger.getLogger(org.bouncycastle.jsse.provider.ProvX509Key.class.getName());
  ...
  static org.bouncycastle.jsse.provider.ProvX509Key from(X509KeyManager paramX509KeyManager, String paramString1, String paramString2) {
    ...
    return (null == privateKey) ? null : new org.bouncycastle.jsse.provider.ProvX509Key(paramString1, privateKey, arrayOfX509Certificate);
  }
  
  static org.bouncycastle.jsse.provider.ProvX509Key validate(X509KeyManager paramX509KeyManager, boolean paramBoolean, String paramString1, String paramString2, TransportData paramTransportData) {
    if (null == paramX509KeyManager)
      throw new NullPointerException("'x509KeyManager' cannot be null"); 
    if (null == paramString1 || null == paramString2)
      return null; 
  ...
  private static X509Certificate[] getCertificateChain(X509KeyManager paramX509KeyManager, String paramString) {
    ...
    if (JsseUtils.containsNull((Object[])arrayOfX509Certificate)) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\9\org\bouncycastle\jsse\provider\ProvX509Key.class
