...
class Zb {
  ...
  public static long Zu(long paramLong1, long paramLong2) {
    if (((paramLong1 | paramLong2) & 0xFF80FF80FF80FF80L) != 0L)
      return -1L; 
    long l = Long.compress(paramLong1, 71777214294589695L) << 32L | Long.compress(paramLong2, 71777214294589695L);
    return Zp(l);
  }
  ...
  public static long Zp(long paramLong) {
    ...
    return Long.compress(l8, 1085102592571150095L);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\META-INF\versions\21\com\fasterxml\Zz\Zb.class
