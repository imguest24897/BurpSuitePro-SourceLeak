...
class CRMFHelper {
          ...
          public Object doInJCE() throws CRMFException, InvalidAlgorithmParameterException, InvalidKeyException, InvalidParameterSpecException, NoSuchAlgorithmException, NoSuchPaddingException, NoSuchProviderException {
            ...
            if (aSN1Primitive != null && !(aSN1Primitive instanceof org.bouncycastle.asn1.ASN1Null)) {
              try {
                ...
                if (aSN1ObjectIdentifier.equals((ASN1Primitive)CMSAlgorithm.DES_EDE3_CBC) || aSN1ObjectIdentifier.equals((ASN1Primitive)CMSAlgorithm.IDEA_CBC) || aSN1ObjectIdentifier.equals((ASN1Primitive)CMSAlgorithm.AES128_CBC) || aSN1ObjectIdentifier.equals((ASN1Primitive)CMSAlgorithm.AES192_CBC) || aSN1ObjectIdentifier.equals((ASN1Primitive)CMSAlgorithm.AES256_CBC)) {
                  cipher.init(2, sKey, new IvParameterSpec(ASN1OctetString.getInstance(aSN1Primitive).getOctets()));
                } else {
                  throw noSuchAlgorithmException;
                } 
              } 
            } else if (aSN1ObjectIdentifier.equals((ASN1Primitive)CMSAlgorithm.DES_EDE3_CBC) || aSN1ObjectIdentifier.equals((ASN1Primitive)CMSAlgorithm.IDEA_CBC) || aSN1ObjectIdentifier.equals((ASN1Primitive)CMSAlgorithm.CAST5_CBC)) {
  ...
  MessageDigest createDigest(ASN1ObjectIdentifier paramASN1ObjectIdentifier) throws CRMFException {
    try {
      ...
      return this.helper.createMessageDigest(paramASN1ObjectIdentifier.getId());
    } catch (GeneralSecurityException generalSecurityException) {
      throw new CRMFException("cannot create cipher: " + generalSecurityException.getMessage(), generalSecurityException);
    } 
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\cert\crmf\jcajce\CRMFHelper.class
