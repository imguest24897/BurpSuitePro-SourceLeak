...
public class V3TBSCertificateGenerator {
  ...
  private ASN1Sequence generateTBSStructure() {
    ASN1EncodableVector aSN1EncodableVector1 = new ASN1EncodableVector(10);
    ...
    return (ASN1Sequence)new DERSequence(aSN1EncodableVector1);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\asn1\x509\V3TBSCertificateGenerator.class
