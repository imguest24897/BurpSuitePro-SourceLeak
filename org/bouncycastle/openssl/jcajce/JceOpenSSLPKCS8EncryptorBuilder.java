...
public class JceOpenSSLPKCS8EncryptorBuilder {
  ...
  public JceOpenSSLPKCS8EncryptorBuilder setPassword(char[] paramArrayOfchar) {
    this.password = paramArrayOfchar;
    return this;
  }
  ...
  public OutputEncryptor build() throws OperatorCreationException {
    ...
    return new OutputEncryptor() {
        ...
        public OutputStream getOutputStream(OutputStream param1OutputStream) {
          return (OutputStream)new CipherOutputStream(param1OutputStream, JceOpenSSLPKCS8EncryptorBuilder.this.cipher);
        }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\openssl\jcajce\JceOpenSSLPKCS8EncryptorBuilder.class
