...
public class JceKTSKeyWrapper extends AsymmetricKeyWrapper {
  ...
  public byte[] generateWrappedKey(GenericKey paramGenericKey) throws OperatorException {
    Cipher cipher = this.helper.createAsymmetricWrapper(getAlgorithmIdentifier().getAlgorithm(), new HashMap<>());
    try {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\operator\jcajce\JceKTSKeyWrapper.class
