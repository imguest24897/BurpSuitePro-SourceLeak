...
public class GMSSPrivateKey extends ASN1Object {
  ...
  public static GMSSPrivateKey getInstance(Object paramObject) {
    return (paramObject instanceof GMSSPrivateKey) ? (GMSSPrivateKey)paramObject : ((paramObject != null) ? new GMSSPrivateKey(ASN1Sequence.getInstance(paramObject)) : null);
  }
  ...
  private static int checkBigIntegerInIntRange(ASN1Encodable paramASN1Encodable) {
    return ((ASN1Integer)paramASN1Encodable).intValueExact();
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\pqc\asn1\GMSSPrivateKey.class
