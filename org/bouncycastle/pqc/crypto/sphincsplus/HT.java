...
class HT {
  ...
  SIG_XMSS xmss_sign(byte[] paramArrayOfbyte1, byte[] paramArrayOfbyte2, int paramInt, byte[] paramArrayOfbyte3, ADRS paramADRS) {
    ...
    for (byte b = 0; b < this.engine.H_PRIME; b++) {
      ...
      arrayOfByte[b] = treehash(paramArrayOfbyte2, i * (1 << b), b, paramArrayOfbyte3, aDRS);
    } 
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\pqc\crypto\sphincsplus\HT.class
