...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
  ...
  private void initializeDefault() {
    ...
    int[] arrayOfInt3 = { 2, 2, 2, 2 };
    GMSSKeyGenerationParameters gMSSKeyGenerationParameters = new GMSSKeyGenerationParameters(null, new GMSSParameters(arrayOfInt1.length, arrayOfInt1, arrayOfInt2, arrayOfInt3));
    initialize(gMSSKeyGenerationParameters);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\pqc\legacy\crypto\gmss\GMSSKeyPairGenerator.class
