...
class ProvKeyManagerFactorySpi extends KeyManagerFactorySpi {
  ...
  protected void engineInit(KeyStore paramKeyStore, char[] paramArrayOfchar) throws KeyStoreException, NoSuchAlgorithmException, UnrecoverableKeyException {
    this.x509KeyManager = new ProvX509KeyManagerSimple(this.isInFipsMode, this.helper, paramKeyStore, paramArrayOfchar);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jsse\provider\ProvKeyManagerFactorySpi.class
