...
class ProvX509TrustManager extends BCX509ExtendedTrustManager {
  ...
  private X509Certificate[] buildCertPath(X509Certificate[] paramArrayOfX509Certificate, BCAlgorithmConstraints paramBCAlgorithmConstraints, List<byte[]> paramList) throws GeneralSecurityException {
    ...
    pKIXBuilderParameters.addCertPathChecker(new ProvAlgorithmChecker(this.isInFipsMode, this.helper, paramBCAlgorithmConstraints));
  ...
  private static void addStatusResponses(CertPathBuilder paramCertPathBuilder, PKIXBuilderParameters paramPKIXBuilderParameters, X509Certificate[] paramArrayOfX509Certificate, List<byte[]> paramList) {
    ...
    if (!hashMap.isEmpty())
      try {
        PKIXUtil.addStatusResponses(paramCertPathBuilder, paramPKIXBuilderParameters, (Map)hashMap);
  ...
  private static X509CertSelector createTargetCertConstraints(final X509Certificate eeCert, final CertSelector userConstraints) {
    return new X509CertSelector() {
        public boolean match(Certificate param1Certificate) {
          return (super.match(param1Certificate) && (null == userConstraints || userConstraints.match(param1Certificate)));
        }
      };
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jsse\provider\ProvX509TrustManager.class
