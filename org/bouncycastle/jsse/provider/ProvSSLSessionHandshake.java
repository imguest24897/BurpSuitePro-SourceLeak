...
class ProvSSLSessionHandshake extends ProvSSLSessionBase {
  ...
  public List<BCSNIServerName> getRequestedServerNames() {
    Vector<ServerName> vector = this.securityParameters.getClientServerNames();
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jsse\provider\ProvSSLSessionHandshake.class
