...
class ProvSSLEngine extends SSLEngine implements BCSSLEngine, ProvTlsManager {
  ...
  public BCX509Key chooseClientKey(String[] paramArrayOfString, Principal[] paramArrayOfPrincipal) {
    return getContextData().getX509KeyManager().chooseEngineClientKeyBC(paramArrayOfString, JsseUtils.<Principal>clone(paramArrayOfPrincipal), this);
  }
  
  public BCX509Key chooseServerKey(String[] paramArrayOfString, Principal[] paramArrayOfPrincipal) {
    return getContextData().getX509KeyManager().chooseEngineServerKeyBC(paramArrayOfString, JsseUtils.<Principal>clone(paramArrayOfPrincipal), this);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jsse\provider\ProvSSLEngine.class
