...
abstract class ProvSSLSessionBase extends BCExtendedSSLSession {
  ...
  public boolean equals(Object paramObject) {
    if (this == paramObject)
      return true; 
    if (!(paramObject instanceof ProvSSLSessionBase))
      return false; 
    ProvSSLSessionBase provSSLSessionBase = (ProvSSLSessionBase)paramObject;
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jsse\provider\ProvSSLSessionBase.class
