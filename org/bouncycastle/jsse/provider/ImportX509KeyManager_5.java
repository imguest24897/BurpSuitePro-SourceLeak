...
final class ImportX509KeyManager_5 extends BCX509ExtendedKeyManager implements ImportX509KeyManager {
  ...
  protected BCX509Key getKeyBC(String paramString1, String paramString2) {
    return ProvX509Key.from(this.x509KeyManager, paramString1, paramString2);
  }
  
  protected BCX509Key validateKeyBC(boolean paramBoolean, String paramString1, String paramString2, Socket paramSocket) {
    return ProvX509Key.validate(this.x509KeyManager, paramBoolean, paramString1, paramString2, TransportData.from(paramSocket));
  }
  
  protected BCX509Key validateKeyBC(boolean paramBoolean, String paramString1, String paramString2, SSLEngine paramSSLEngine) {
    return ProvX509Key.validate(this.x509KeyManager, paramBoolean, paramString1, paramString2, TransportData.from(paramSSLEngine));
  }
}


/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jsse\provider\ImportX509KeyManager_5.class
