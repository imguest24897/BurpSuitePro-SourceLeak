...
class CipherSuiteInfo {
  ...
  static CipherSuiteInfo forCipherSuite(int paramInt, String paramString) {
    ...
    return new CipherSuiteInfo(paramInt, paramString, bool, Collections.unmodifiableSet(hashSet2), Collections.unmodifiableSet(hashSet1));
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jsse\provider\CipherSuiteInfo.class
