...
class PropertyUtils {
  ...
  static boolean getBooleanSecurityProperty(String paramString, boolean paramBoolean) {
    ...
    if (null != str) {
      if ("true".equalsIgnoreCase(str)) {
        LOG.info("Found boolean security property [" + paramString + "]: " + '\001');
        return true;
      } 
      if ("false".equalsIgnoreCase(str)) {
        LOG.info("Found boolean security property [" + paramString + "]: " + Character.MIN_VALUE);
        return false;
      } 
  ...
  static boolean getBooleanSystemProperty(String paramString, boolean paramBoolean) {
    ...
    if (null != str) {
      if ("true".equalsIgnoreCase(str)) {
        LOG.info("Found boolean system property [" + paramString + "]: " + '\001');
        return true;
      } 
      if ("false".equalsIgnoreCase(str)) {
        LOG.info("Found boolean system property [" + paramString + "]: " + Character.MIN_VALUE);
        return false;
      } 
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jsse\provider\PropertyUtils.class
