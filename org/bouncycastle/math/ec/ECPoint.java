...
public abstract class ECPoint {
  ...
  boolean implIsValid(final boolean decompressed, final boolean checkOrder) {
    if (isInfinity())
      return true; 
    ValidityPrecompInfo validityPrecompInfo = (ValidityPrecompInfo)getCurve().precompute(this, "bc_validity", new PreCompCallback() {
          public PreCompInfo precompute(PreCompInfo param1PreCompInfo) {
            ValidityPrecompInfo validityPrecompInfo = (param1PreCompInfo instanceof ValidityPrecompInfo) ? (ValidityPrecompInfo)param1PreCompInfo : null;
            ...
            if (checkOrder && !validityPrecompInfo.hasOrderPassed()) {
  ...
  public ECPoint scaleXNegateY(ECFieldElement paramECFieldElement) {
  ...
  public ECPoint scaleYNegateX(ECFieldElement paramECFieldElement) {
  ...
  public static abstract class AbstractF2m extends ECPoint {
    ...
    protected boolean satisfiesOrder() {
      ...
      if (ECConstants.FOUR.equals(bigInteger)) {
        ECPoint eCPoint = normalize();
        ECFieldElement eCFieldElement1 = eCPoint.getAffineXCoord();
        ECFieldElement eCFieldElement2 = ((ECCurve.AbstractF2m)this.curve).solveQuadraticEquation(eCFieldElement1.add(this.curve.getA()));
        if (null == eCFieldElement2)
          return false; 
        ECFieldElement eCFieldElement3 = eCPoint.getAffineYCoord();
        ECFieldElement eCFieldElement4 = eCFieldElement1.multiply(eCFieldElement2).add(eCFieldElement3);
    ...
    public ECPoint scaleX(ECFieldElement param1ECFieldElement) {
      ...
      switch (i) {
        case 5:
          ...
          return getCurve().createRawPoint(eCFieldElement1, eCFieldElement4, getRawZCoords());
        case 6:
          eCFieldElement1 = getRawXCoord();
          eCFieldElement2 = getRawYCoord();
          ...
          return getCurve().createRawPoint(eCFieldElement4, eCFieldElement5, new ECFieldElement[] { eCFieldElement6 });
      } 
      return super.scaleX(param1ECFieldElement);
    }
    
    public ECPoint scaleXNegateY(ECFieldElement param1ECFieldElement) {
      return scaleX(param1ECFieldElement);
    }
    ...
    public ECPoint scaleY(ECFieldElement param1ECFieldElement) {
      ...
      switch (i) {
        ...
        case 6:
          ...
          return getCurve().createRawPoint(eCFieldElement1, eCFieldElement3, getRawZCoords());
      } 
      return super.scaleY(param1ECFieldElement);
    }
    
    public ECPoint scaleYNegateX(ECFieldElement param1ECFieldElement) {
      return scaleY(param1ECFieldElement);
    }
    ...
    public AbstractF2m tau() {
      ...
      switch (i) {
        ...
        case 5:
          ...
          return (AbstractF2m)eCCurve.createRawPoint(eCFieldElement1.square(), eCFieldElement2.square());
        case 1:
        case 6:
          eCFieldElement2 = this.y;
          eCFieldElement3 = this.zs[0];
          return (AbstractF2m)eCCurve.createRawPoint(eCFieldElement1.square(), eCFieldElement2.square(), new ECFieldElement[] { eCFieldElement3.square() });
      } 
      throw new IllegalStateException("unsupported coordinate system");
    }
    ...
    public AbstractF2m tauPow(int param1Int) {
      ...
      switch (i) {
        ...
        case 5:
          eCFieldElement2 = this.y;
          return (AbstractF2m)eCCurve.createRawPoint(eCFieldElement1.squarePow(param1Int), eCFieldElement2.squarePow(param1Int));
        case 1:
        case 6:
          eCFieldElement2 = this.y;
          eCFieldElement3 = this.zs[0];
          return (AbstractF2m)eCCurve.createRawPoint(eCFieldElement1.squarePow(param1Int), eCFieldElement2.squarePow(param1Int), new ECFieldElement[] { eCFieldElement3.squarePow(param1Int) });
      } 
      throw new IllegalStateException("unsupported coordinate system");
    }
  }
  ...
  public static class F2m extends AbstractF2m {
    F2m(ECCurve param1ECCurve, ECFieldElement param1ECFieldElement1, ECFieldElement param1ECFieldElement2) {
      super(param1ECCurve, param1ECFieldElement1, param1ECFieldElement2);
    }
    
    F2m(ECCurve param1ECCurve, ECFieldElement param1ECFieldElement1, ECFieldElement param1ECFieldElement2, ECFieldElement[] param1ArrayOfECFieldElement) {
      super(param1ECCurve, param1ECFieldElement1, param1ECFieldElement2, param1ArrayOfECFieldElement);
    }
    ...
    public ECPoint add(ECPoint param1ECPoint) {
      ...
      switch (i) {
        ...
        case 1:
          ...
          return new F2m(eCCurve, eCFieldElement19, eCFieldElement21, new ECFieldElement[] { eCFieldElement22 });
        case 6:
          if (eCFieldElement1.isZero())
          ...
          if (eCFieldElement2.isZero()) {
            ...
            if (eCFieldElement15.isZero())
              return new F2m(eCCurve, eCFieldElement15, eCCurve.getB().sqrt()); 
          ...
          return new F2m(eCCurve, eCFieldElement15, eCFieldElement16, new ECFieldElement[] { eCFieldElement17 });
      } 
      throw new IllegalStateException("unsupported coordinate system");
    }
    ...
    public ECPoint twice() {
      ...
      switch (i) {
        ...
        case 1:
          ...
          return new F2m(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 });
        case 6:
          eCFieldElement2 = this.y;
          eCFieldElement3 = this.zs[0];
          bool = eCFieldElement3.isOne();
          ...
          if (eCFieldElement9.isZero())
            return new F2m(eCCurve, eCFieldElement9, eCCurve.getB().sqrt()); 
          eCFieldElement10 = eCFieldElement9.square();
          ...
          return new F2m(eCCurve, eCFieldElement10, eCFieldElement13, new ECFieldElement[] { eCFieldElement11 });
      } 
      throw new IllegalStateException("unsupported coordinate system");
    }
    ...
    public ECPoint negate() {
      ...
      switch (getCurveCoordinateSystem()) {
        case 0:
          eCFieldElement2 = this.y;
          return new F2m(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement1));
        case 1:
          eCFieldElement2 = this.y;
          eCFieldElement3 = this.zs[0];
          return new F2m(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement1), new ECFieldElement[] { eCFieldElement3 });
        case 5:
          eCFieldElement2 = this.y;
          return new F2m(this.curve, eCFieldElement1, eCFieldElement2.addOne());
        case 6:
          eCFieldElement2 = this.y;
          eCFieldElement3 = this.zs[0];
          return new F2m(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
      } 
      throw new IllegalStateException("unsupported coordinate system");
    }
  }
  ...
  public static class Fp extends AbstractFp {
    Fp(ECCurve param1ECCurve, ECFieldElement param1ECFieldElement1, ECFieldElement param1ECFieldElement2) {
      super(param1ECCurve, param1ECFieldElement1, param1ECFieldElement2);
    }
    
    Fp(ECCurve param1ECCurve, ECFieldElement param1ECFieldElement1, ECFieldElement param1ECFieldElement2, ECFieldElement[] param1ArrayOfECFieldElement) {
      super(param1ECCurve, param1ECFieldElement1, param1ECFieldElement2, param1ArrayOfECFieldElement);
    }
    ...
    public ECPoint add(ECPoint param1ECPoint) {
      ...
      switch (i) {
        case 0:
          ...
          return new Fp(eCCurve, eCFieldElement9, eCFieldElement10);
        case 1:
          eCFieldElement5 = this.zs[0];
          eCFieldElement6 = param1ECPoint.zs[0];
          ...
          return new Fp(eCCurve, eCFieldElement21, eCFieldElement22, new ECFieldElement[] { eCFieldElement23 });
        case 2:
        case 4:
          eCFieldElement5 = this.zs[0];
          eCFieldElement6 = param1ECPoint.zs[0];
          ...
          return new Fp(eCCurve, eCFieldElement8, eCFieldElement10, arrayOfECFieldElement);
      } 
      throw new IllegalStateException("unsupported coordinate system");
    }
    ...
    public ECPoint twice() {
      ...
      switch (i) {
        ...
        case 1:
          ...
          return new Fp(eCCurve, eCFieldElement12, eCFieldElement14, new ECFieldElement[] { eCFieldElement16 });
        case 2:
          eCFieldElement3 = this.zs[0];
          bool = eCFieldElement3.isOne();
          ...
          return new Fp(eCCurve, eCFieldElement11, eCFieldElement12, new ECFieldElement[] { eCFieldElement13 });
        case 4:
    ...
    public ECPoint timesPow2(int param1Int) {
      ...
      switch (i) {
        case 0:
          ...
          return new Fp(eCCurve, eCFieldElement3.multiply(eCFieldElement6), eCFieldElement1.multiply(eCFieldElement7));
        case 1:
          eCFieldElement3 = eCFieldElement3.multiply(eCFieldElement4);
          eCFieldElement4 = eCFieldElement4.multiply(eCFieldElement4.square());
          return new Fp(eCCurve, eCFieldElement3, eCFieldElement1, new ECFieldElement[] { eCFieldElement4 });
        case 2:
          return new Fp(eCCurve, eCFieldElement3, eCFieldElement1, new ECFieldElement[] { eCFieldElement4 });
        case 4:
          return new Fp(eCCurve, eCFieldElement3, eCFieldElement1, new ECFieldElement[] { eCFieldElement4, eCFieldElement2 });
      } 
      throw new IllegalStateException("unsupported coordinate system");
    }
    ...
    public ECPoint negate() {
      ...
      ECCurve eCCurve = getCurve();
      int i = eCCurve.getCoordinateSystem();
      return (0 != i) ? new Fp(eCCurve, this.x, this.y.negate(), this.zs) : new Fp(eCCurve, this.x, this.y.negate());
    }
    ...
    protected Fp twiceJacobianModified(boolean param1Boolean) {
      ...
      return new Fp(getCurve(), eCFieldElement10, eCFieldElement13, new ECFieldElement[] { eCFieldElement15, eCFieldElement14 });
    }
  }
}


/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\math\ec\ECPoint.class
