  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] paramArrayOfECPoint, int paramInt1, final int len) {
    ...
    return (ECLookupTable)new AbstractECLookupTable() {
        ...
        public ECPoint lookup(int param1Int) {
          ...
          for (byte b2 = 0; b2 < len; b2++) {
            ...
            for (byte b = 0; b < 12; b++) {
              ...
              arrayOfInt2[b] = arrayOfInt2[b] ^ table[b1 + 12 + b] & i;
            } 
            b1 += 24;
          } 
        ...
        public ECPoint lookupVar(int param1Int) {
          int[] arrayOfInt1 = Nat.create(12);
          int[] arrayOfInt2 = Nat.create(12);
          int i = param1Int * 12 * 2;
          for (byte b = 0; b < 12; b++) {
            arrayOfInt1[b] = table[i + b];
            arrayOfInt2[b] = table[i + 12 + b];
          } 
          return createPoint(arrayOfInt1, arrayOfInt2);
        }
        
        private ECPoint createPoint(int[] param1ArrayOfint1, int[] param1ArrayOfint2) {
          return SecP384R1Curve.this.createRawPoint((ECFieldElement)new SecP384R1FieldElement(param1ArrayOfint1), (ECFieldElement)new SecP384R1FieldElement(param1ArrayOfint2), SecP384R1Curve.SECP384R1_AFFINE_ZS);
        }
      };
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\math\ec\custom\sec\SecP384R1Curve.class
