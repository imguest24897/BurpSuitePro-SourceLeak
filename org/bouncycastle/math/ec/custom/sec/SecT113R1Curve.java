  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] paramArrayOfECPoint, int paramInt1, final int len) {
    ...
    return (ECLookupTable)new AbstractECLookupTable() {
        ...
        private ECPoint createPoint(long[] param1ArrayOflong1, long[] param1ArrayOflong2) {
          return SecT113R1Curve.this.createRawPoint((ECFieldElement)new SecT113FieldElement(param1ArrayOflong1), (ECFieldElement)new SecT113FieldElement(param1ArrayOflong2), SecT113R1Curve.SECT113R1_AFFINE_ZS);
        }
      };
  }
}
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\math\ec\custom\sec\SecT113R1Curve.class
