  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] paramArrayOfECPoint, int paramInt1, final int len) {
    ...
    return (ECLookupTable)new AbstractECLookupTable() {
        ...
        private ECPoint createPoint(int[] param1ArrayOfint1, int[] param1ArrayOfint2) {
          return SecP256R1Curve.this.createRawPoint((ECFieldElement)new SecP256R1FieldElement(param1ArrayOfint1), (ECFieldElement)new SecP256R1FieldElement(param1ArrayOfint2), SecP256R1Curve.SECP256R1_AFFINE_ZS);
        }
      };
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\math\ec\custom\sec\SecP256R1Curve.class
