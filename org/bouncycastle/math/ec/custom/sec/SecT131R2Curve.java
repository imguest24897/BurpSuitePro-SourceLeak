  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] paramArrayOfECPoint, int paramInt1, final int len) {
    ...
    return (ECLookupTable)new AbstractECLookupTable() {
        ...
        private ECPoint createPoint(long[] param1ArrayOflong1, long[] param1ArrayOflong2) {
          return SecT131R2Curve.this.createRawPoint((ECFieldElement)new SecT131FieldElement(param1ArrayOflong1), (ECFieldElement)new SecT131FieldElement(param1ArrayOflong2), SecT131R2Curve.SECT131R2_AFFINE_ZS);
        }
      };
  }
}
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\math\ec\custom\sec\SecT131R2Curve.class
