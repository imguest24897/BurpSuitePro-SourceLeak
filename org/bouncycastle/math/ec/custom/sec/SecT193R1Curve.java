  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] paramArrayOfECPoint, int paramInt1, final int len) {
    ...
    return (ECLookupTable)new AbstractECLookupTable() {
        ...
        private ECPoint createPoint(long[] param1ArrayOflong1, long[] param1ArrayOflong2) {
          return SecT193R1Curve.this.createRawPoint((ECFieldElement)new SecT193FieldElement(param1ArrayOflong1), (ECFieldElement)new SecT193FieldElement(param1ArrayOflong2), SecT193R1Curve.SECT193R1_AFFINE_ZS);
        }
      };
  }
}
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\math\ec\custom\sec\SecT193R1Curve.class
