  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] paramArrayOfECPoint, int paramInt1, final int len) {
    ...
    return (ECLookupTable)new AbstractECLookupTable() {
        ...
        private ECPoint createPoint(int[] param1ArrayOfint1, int[] param1ArrayOfint2) {
          return SecP256K1Curve.this.createRawPoint((ECFieldElement)new SecP256K1FieldElement(param1ArrayOfint1), (ECFieldElement)new SecP256K1FieldElement(param1ArrayOfint2), SecP256K1Curve.SECP256K1_AFFINE_ZS);
        }
      };
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\math\ec\custom\sec\SecP256K1Curve.class
