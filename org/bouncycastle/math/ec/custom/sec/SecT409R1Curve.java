  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] paramArrayOfECPoint, int paramInt1, final int len) {
    ...
    return (ECLookupTable)new AbstractECLookupTable() {
        ...
        private ECPoint createPoint(long[] param1ArrayOflong1, long[] param1ArrayOflong2) {
          return SecT409R1Curve.this.createRawPoint((ECFieldElement)new SecT409FieldElement(param1ArrayOflong1), (ECFieldElement)new SecT409FieldElement(param1ArrayOflong2), SecT409R1Curve.SECT409R1_AFFINE_ZS);
        }
      };
  }
}
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\math\ec\custom\sec\SecT409R1Curve.class
