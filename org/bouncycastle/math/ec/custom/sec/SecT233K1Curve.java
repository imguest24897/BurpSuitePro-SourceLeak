  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] paramArrayOfECPoint, int paramInt1, final int len) {
    ...
    return (ECLookupTable)new AbstractECLookupTable() {
        ...
        private ECPoint createPoint(long[] param1ArrayOflong1, long[] param1ArrayOflong2) {
          return SecT233K1Curve.this.createRawPoint((ECFieldElement)new SecT233FieldElement(param1ArrayOflong1), (ECFieldElement)new SecT233FieldElement(param1ArrayOflong2), SecT233K1Curve.SECT233K1_AFFINE_ZS);
        }
      };
  }
}
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\math\ec\custom\sec\SecT233K1Curve.class
