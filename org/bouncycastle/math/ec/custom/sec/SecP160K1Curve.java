  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] paramArrayOfECPoint, int paramInt1, final int len) {
    ...
    return (ECLookupTable)new AbstractECLookupTable() {
        ...
        private ECPoint createPoint(int[] param1ArrayOfint1, int[] param1ArrayOfint2) {
          return SecP160K1Curve.this.createRawPoint((ECFieldElement)new SecP160R2FieldElement(param1ArrayOfint1), (ECFieldElement)new SecP160R2FieldElement(param1ArrayOfint2), SecP160K1Curve.SECP160K1_AFFINE_ZS);
        }
      };
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\math\ec\custom\sec\SecP160K1Curve.class
