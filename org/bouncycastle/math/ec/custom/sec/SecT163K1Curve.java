  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] paramArrayOfECPoint, int paramInt1, final int len) {
    ...
    return (ECLookupTable)new AbstractECLookupTable() {
        ...
        private ECPoint createPoint(long[] param1ArrayOflong1, long[] param1ArrayOflong2) {
          return SecT163K1Curve.this.createRawPoint((ECFieldElement)new SecT163FieldElement(param1ArrayOflong1), (ECFieldElement)new SecT163FieldElement(param1ArrayOflong2), SecT163K1Curve.SECT163K1_AFFINE_ZS);
        }
      };
  }
}
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\math\ec\custom\sec\SecT163K1Curve.class
