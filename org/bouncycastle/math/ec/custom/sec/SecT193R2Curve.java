  ...
  public ECLookupTable createCacheSafeLookupTable(ECPoint[] paramArrayOfECPoint, int paramInt1, final int len) {
    ...
    return (ECLookupTable)new AbstractECLookupTable() {
        ...
        public ECPoint lookupVar(int param1Int) {
          ...
          int i = param1Int * 4 * 2;
          for (byte b = 0; b < 4; b++) {
            arrayOfLong1[b] = arrayOfLong1[b] ^ table[i + b];
            arrayOfLong2[b] = arrayOfLong2[b] ^ table[i + 4 + b];
          } 
          return createPoint(arrayOfLong1, arrayOfLong2);
        }
        
        private ECPoint createPoint(long[] param1ArrayOflong1, long[] param1ArrayOflong2) {
          return SecT193R2Curve.this.createRawPoint((ECFieldElement)new SecT193FieldElement(param1ArrayOflong1), (ECFieldElement)new SecT193FieldElement(param1ArrayOflong2), SecT193R2Curve.SECT193R2_AFFINE_ZS);
        }
      };
  }
}
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\math\ec\custom\sec\SecT193R2Curve.class
