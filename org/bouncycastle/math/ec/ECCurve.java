...
public abstract class ECCurve {
  ...
  public static abstract class AbstractF2m extends ECCurve {
    ...
    private static FiniteField buildField(int param1Int1, int param1Int2, int param1Int3, int param1Int4) {
      if (param1Int1 > Properties.asInteger("org.bouncycastle.ec.max_f2m_field_size", 1142))
        throw new IllegalArgumentException("field size out of range: " + param1Int1); 
      (new int[3])[0] = 0;
      (new int[3])[1] = param1Int2;
      (new int[3])[2] = param1Int1;
      (new int[5])[0] = 0;
      (new int[5])[1] = param1Int2;
      (new int[5])[2] = param1Int3;
      (new int[5])[3] = param1Int4;
      (new int[5])[4] = param1Int1;
      int[] arrayOfInt = ((param1Int3 | param1Int4) == 0) ? new int[3] : new int[5];
      return (FiniteField)FiniteFields.getBinaryExtensionField(arrayOfInt);
    }
  ...
  public static class F2m extends AbstractF2m {
    ...
    public ECFieldElement fromBigInteger(BigInteger param1BigInteger) {
      if (param1BigInteger == null || param1BigInteger.signum() < 0 || param1BigInteger.bitLength() > this.m)
        throw new IllegalArgumentException("x value invalid in F2m field element"); 
      (new int[1])[0] = this.k1;
      (new int[3])[0] = this.k1;
      (new int[3])[1] = this.k2;
      (new int[3])[2] = this.k3;
      int[] arrayOfInt = ((this.k2 | this.k3) == 0) ? new int[1] : new int[3];
      return new ECFieldElement.F2m(this.m, arrayOfInt, new LongArray(param1BigInteger));
    }
  ...
  public static class Fp extends AbstractFp {
    ...
    public Fp(BigInteger param1BigInteger1, BigInteger param1BigInteger2, BigInteger param1BigInteger3, BigInteger param1BigInteger4, BigInteger param1BigInteger5) {
      this(param1BigInteger1, param1BigInteger2, param1BigInteger3, param1BigInteger4, param1BigInteger5, false);
    }
    
    public Fp(BigInteger param1BigInteger1, BigInteger param1BigInteger2, BigInteger param1BigInteger3, BigInteger param1BigInteger4, BigInteger param1BigInteger5, boolean param1Boolean) {
      super(param1BigInteger1);
      if (param1Boolean) {
        this.q = param1BigInteger1;
        knownQs.add(param1BigInteger1);
      } else if (knownQs.contains(param1BigInteger1) || validatedQs.contains(param1BigInteger1)) {
        this.q = param1BigInteger1;
      } else {
        ...
        int k = param1BigInteger1.bitLength();
        if (i < k)
          throw new IllegalArgumentException("Fp q value out of range"); 
        if (Primes.hasAnySmallFactors(param1BigInteger1) || !Primes.isMRProbablePrime(param1BigInteger1, CryptoServicesRegistrar.getSecureRandom(), ECCurve.getNumberOfIterations(k, j)))
          throw new IllegalArgumentException("Fp q value not prime"); 
        validatedQs.add(param1BigInteger1);
        this.q = param1BigInteger1;
      } 
    ...
    public ECFieldElement fromBigInteger(BigInteger param1BigInteger) {
      if (param1BigInteger == null || param1BigInteger.signum() < 0 || param1BigInteger.compareTo(this.q) >= 0)
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\math\ec\ECCurve.class
