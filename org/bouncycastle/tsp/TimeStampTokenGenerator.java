...
public class TimeStampTokenGenerator {
  ...
  public TimeStampTokenGenerator(final SignerInfoGenerator signerInfoGen, DigestCalculator paramDigestCalculator, ASN1ObjectIdentifier paramASN1ObjectIdentifier, boolean paramBoolean) throws IllegalArgumentException, TSPException {
    ...
    try {
      ...
      outputStream.close();
      if (paramDigestCalculator.getAlgorithmIdentifier().getAlgorithm().equals((ASN1Primitive)OIWObjectIdentifiers.idSHA1)) {
  ...
  public TimeStampToken generate(TimeStampRequest paramTimeStampRequest, BigInteger paramBigInteger, Date paramDate, Extensions paramExtensions) throws TSPException {
    ...
    AlgorithmIdentifier algorithmIdentifier = paramTimeStampRequest.getMessageImprintAlgID();
    ...
    if (paramTimeStampRequest.getReqPolicy() != null)
      aSN1ObjectIdentifier = paramTimeStampRequest.getReqPolicy(); 
    ...
    TSTInfo tSTInfo = new TSTInfo(aSN1ObjectIdentifier, messageImprint, new ASN1Integer(paramBigInteger), aSN1GeneralizedTime, accuracy, aSN1Boolean, aSN1Integer, this.tsa, extensions);
    try {
      ...
      if (!this.otherRevoc.isEmpty())
        for (ASN1ObjectIdentifier aSN1ObjectIdentifier1 : this.otherRevoc.keySet())
          cMSSignedDataGenerator.addOtherRevocationInfo(aSN1ObjectIdentifier1, (Store)new CollectionStore((Collection)this.otherRevoc.get(aSN1ObjectIdentifier1)));  
  ...
  private ASN1GeneralizedTime createGeneralizedTime(Date paramDate) throws TSPException {
    ...
    SimpleDateFormat simpleDateFormat = (this.locale == null) ? new SimpleDateFormat(str, LocaleUtil.EN_Locale) : new SimpleDateFormat(str, this.locale);
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tsp\TimeStampTokenGenerator.class
