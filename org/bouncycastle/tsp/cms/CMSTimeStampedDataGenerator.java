...
public class CMSTimeStampedDataGenerator extends CMSTimeStampedGenerator {
  ...
  public CMSTimeStampedData generate(TimeStampToken paramTimeStampToken, InputStream paramInputStream) throws CMSException {
    ...
    return new CMSTimeStampedData(new ContentInfo(CMSObjectIdentifiers.timestampedData, (ASN1Encodable)new TimeStampedData((ASN1IA5String)dERIA5String, this.metaData, (ASN1OctetString)bEROctetString, new Evidence(new TimeStampTokenEvidence(timeStampAndCRL)))));
  }
}


/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tsp\cms\CMSTimeStampedDataGenerator.class
