...
public class TimeStampResponse {
  ...
  public String getStatusString() {
    if (this.resp.getStatus().getStatusString() != null) {
      ...
      for (byte b = 0; b != pKIFreeText.size(); b++)
        stringBuffer.append(pKIFreeText.getStringAtUTF8(b).getString()); 
  ...
  public void validate(TimeStampRequest paramTimeStampRequest) throws TSPException {
    ...
    //   102: invokevirtual equals : (Lorg/bouncycastle/asn1/ASN1Primitive;)Z
    //   105: ifne -> 118
  ...
  public byte[] getEncoded(String paramString) throws IOException {
    return "DL".equals(paramString) ? ((this.timeStampToken == null) ? (new DLSequence((ASN1Encodable)this.resp.getStatus())).getEncoded(paramString) : (new DLSequence(new ASN1Encodable[] { (ASN1Encodable)this.resp.getStatus(), (ASN1Encodable)this.timeStampToken.toCMSSignedData().toASN1Structure() })).getEncoded(paramString)) : this.resp.getEncoded(paramString);
  }
}


/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tsp\TimeStampResponse.class
