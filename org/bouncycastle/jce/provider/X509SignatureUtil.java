...
class X509SignatureUtil {
  ...
  static String getSignatureName(AlgorithmIdentifier paramAlgorithmIdentifier) {
    ...
    if (aSN1Encodable != null && !derNull.equals(aSN1Encodable)) {
      ...
      if (paramAlgorithmIdentifier.getAlgorithm().equals((ASN1Primitive)X9ObjectIdentifiers.ecdsa_with_SHA2)) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jce\provider\X509SignatureUtil.class
