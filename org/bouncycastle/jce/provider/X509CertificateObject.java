        ...
        if (extension.getExtnValue() != null) {
          ...
          try {
            ...
            if (aSN1ObjectIdentifier.equals((ASN1Primitive)MiscObjectIdentifiers.netscapeCertType)) {
              stringBuffer.append(new NetscapeCertType((ASN1BitString)aSN1InputStream.readObject())).append(str);
              continue;
            } 
            if (aSN1ObjectIdentifier.equals((ASN1Primitive)MiscObjectIdentifiers.netscapeRevocationURL)) {
              stringBuffer.append(new NetscapeRevocationURL((ASN1IA5String)aSN1InputStream.readObject())).append(str);
              continue;
            } 
            if (aSN1ObjectIdentifier.equals((ASN1Primitive)MiscObjectIdentifiers.verisignCzagExtension)) {
              stringBuffer.append(new VerisignCzagExtension((ASN1IA5String)aSN1InputStream.readObject())).append(str);
              continue;
            } 
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jce\provider\X509CertificateObject.class
