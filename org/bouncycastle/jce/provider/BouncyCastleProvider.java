...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
  ...
  public final Provider.Service getService(final String type, final String algorithm) {
    String str1 = Strings.toUpperCase(algorithm);
    final String key = type + "." + str1;
    Provider.Service service = this.serviceMap.get(str2);
    if (service == null)
      synchronized (this) {
        if (!this.serviceMap.containsKey(str2)) {
          service = AccessController.<Provider.Service>doPrivileged(new PrivilegedAction<Provider.Service>() {
                public Provider.Service run() {
                  Provider.Service service = BouncyCastleProvider.this.getService(type, algorithm);
                  if (service == null)
                    return null; 
  ...
  private void loadServiceClass(String paramString1, String paramString2) {
    Class<AlgorithmProvider> clazz = ClassUtil.loadClass(BouncyCastleProvider.class, paramString1 + paramString2 + "$Mappings");
    if (clazz != null)
      try {
  ...
  public void addAlgorithm(String paramString1, ASN1ObjectIdentifier paramASN1ObjectIdentifier, String paramString2, Map<String, String> paramMap) {
    addAlgorithm(paramString1, paramASN1ObjectIdentifier, paramString2);
    addAttributes(paramString1 + "." + paramASN1ObjectIdentifier, paramMap);
    addAttributes(paramString1 + ".OID." + paramASN1ObjectIdentifier, paramMap);
  }
  ...
  private static CryptoServiceProperties service(String paramString, int paramInt) {
    return new JcaCryptoService(paramString, paramInt);
  }
  ...
  private static class JcaCryptoService implements CryptoServiceProperties {
    ...
    JcaCryptoService(String param1String, int param1Int) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jce\provider\BouncyCastleProvider.class
