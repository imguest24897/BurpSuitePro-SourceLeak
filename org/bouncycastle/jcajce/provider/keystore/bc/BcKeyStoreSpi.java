...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
  ...
  private Key decodeKey(DataInputStream paramDataInputStream) throws IOException {
    ...
    try {
      switch (i) {
        case 0:
          return BouncyCastleProvider.getPrivateKey(PrivateKeyInfo.getInstance(arrayOfByte));
        case 1:
          return BouncyCastleProvider.getPublicKey(SubjectPublicKeyInfo.getInstance(arrayOfByte));
        case 2:
  ...
  public void engineSetKeyEntry(String paramString, Key paramKey, char[] paramArrayOfchar, Certificate[] paramArrayOfCertificate) throws KeyStoreException {
    if (paramKey instanceof java.security.PrivateKey) {
      ...
      if (paramKey.getEncoded() == null) {
        this.table.put(paramString, new StoreEntry(paramString, new Date(), 2, paramKey, paramArrayOfCertificate));
        return;
      } 
    } 
    try {
  ...
  private static class BCKeyStoreException extends KeyStoreException {
    ...
    public BCKeyStoreException(String param1String, Exception param1Exception) {
      super(param1String);
      this.cause = param1Exception;
    }
  ...
  public static class BouncyCastleStore extends BcKeyStoreSpi {
    ...
    public void engineLoad(InputStream param1InputStream, char[] param1ArrayOfchar) throws IOException {
      ...
      DigestInputStream digestInputStream = new DigestInputStream((InputStream)cipherInputStream, (Digest)sHA1Digest);
      ...
      Streams.readFully((InputStream)cipherInputStream, arrayOfByte3);
      if (!Arrays.constantTimeAreEqual(arrayOfByte2, arrayOfByte3)) {
        this.table.clear();
        throw new IOException("KeyStore integrity check failed.");
      } 
    ...
    public void engineStore(OutputStream param1OutputStream, char[] param1ArrayOfchar) throws IOException {
      ...
      saveStore((OutputStream)new TeeOutputStream((OutputStream)cipherOutputStream, (OutputStream)digestOutputStream));
  ...
  private class StoreEntry {
    ...
    StoreEntry(String param1String, Key param1Key, char[] param1ArrayOfchar, Certificate[] param1ArrayOfCertificate) throws Exception {
      ...
      CipherOutputStream cipherOutputStream = new CipherOutputStream(dataOutputStream, cipher);
      dataOutputStream = new DataOutputStream((OutputStream)cipherOutputStream);
    ...
    Object getObject(char[] param1ArrayOfchar) throws NoSuchAlgorithmException, UnrecoverableKeyException {
      ...
      if (this.type == 4) {
        ...
        try {
          ...
          CipherInputStream cipherInputStream = new CipherInputStream(dataInputStream, cipher);
          try {
            return BcKeyStoreSpi.this.decodeKey(new DataInputStream((InputStream)cipherInputStream));
          } catch (Exception exception) {
            ...
            Key key = null;
            try {
              key = BcKeyStoreSpi.this.decodeKey(new DataInputStream((InputStream)cipherInputStream));
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jcajce\provider\keystore\bc\BcKeyStoreSpi.class
