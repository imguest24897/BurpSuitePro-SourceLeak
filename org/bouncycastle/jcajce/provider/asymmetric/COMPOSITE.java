...
public class COMPOSITE {
  ...
  private static class CompositeKeyInfoConverter implements AsymmetricKeyInfoConverter {
    ...
    public PrivateKey generatePrivate(PrivateKeyInfo param1PrivateKeyInfo) throws IOException {
      ASN1Sequence aSN1Sequence = ASN1Sequence.getInstance(param1PrivateKeyInfo.parsePrivateKey());
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jcajce\provider\asymmetric\COMPOSITE.class
