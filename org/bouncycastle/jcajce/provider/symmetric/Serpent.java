...
public final class Serpent {
  ...
  public static class SerpentGMAC extends BaseMac {
    public SerpentGMAC() {
      super((Mac)new GMac((GCMModeCipher)new GCMBlockCipher((BlockCipher)new SerpentEngine())));
    }
  }
  ...
  public static class TSerpentGMAC extends BaseMac {
    public TSerpentGMAC() {
      super((Mac)new GMac((GCMModeCipher)new GCMBlockCipher((BlockCipher)new TnepresEngine())));
    }
  }
}


/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jcajce\provider\symmetric\Serpent.class
