...
public final class ARIA {
  ...
  public static class CCM extends BaseBlockCipher {
    public CCM() {
      super((AEADBlockCipher)new CCMBlockCipher((BlockCipher)new ARIAEngine()), false, 12);
    }
  }
  ...
  public static class GCM extends BaseBlockCipher {
    public GCM() {
      super((AEADBlockCipher)new GCMBlockCipher((BlockCipher)new ARIAEngine()));
    }
  }
  
  public static class GMAC extends BaseMac {
    public GMAC() {
      super((Mac)new GMac((GCMModeCipher)new GCMBlockCipher((BlockCipher)new ARIAEngine())));
    }
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jcajce\provider\symmetric\ARIA.class
