...
public class BCFKSLoadStoreParameter extends BCLoadStoreParameter {
  ...
  public static class Builder {
    ...
    private PBKDFConfig storeConfig = (PBKDFConfig)(new PBKDF2Config.Builder()).withIterationCount(16384).withSaltLength(64).withPRF(PBKDF2Config.PRF_SHA512).build();
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\jcajce\BCFKSLoadStoreParameter.class
