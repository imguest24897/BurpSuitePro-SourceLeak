...
public class CertificateStatus {
  ...
  public static CertificateStatus parse(TlsContext paramTlsContext, InputStream paramInputStream) throws IOException {
    OCSPResponse oCSPResponse;
    ...
    switch (s) {
      ...
      case 2:
        ...
        vector2.trimToSize();
        vector1 = vector2;
        return new CertificateStatus(s, vector1);
    } 
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tls\CertificateStatus.class
