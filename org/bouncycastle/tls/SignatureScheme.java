...
public class SignatureScheme {
  ...
  public static String getText(int paramInt) {
    return getName(paramInt) + "(0x" + Integer.toHexString(paramInt) + ")";
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tls\SignatureScheme.class
