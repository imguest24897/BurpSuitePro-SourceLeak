...
public class TrustedAuthority {
  ...
  public static TrustedAuthority parse(InputStream paramInputStream) throws IOException {
    byte[] arrayOfByte1;
    X500Name x500Name1;
    byte[] arrayOfByte2;
    ...
    switch (s) {
      ...
      case 3:
        ...
        return new TrustedAuthority(s, arrayOfByte1);
      case 0:
        arrayOfByte1 = null;
        return new TrustedAuthority(s, arrayOfByte1);
      case 2:
        ...
        x500Name1 = x500Name2;
        return new TrustedAuthority(s, x500Name1);
    } 
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tls\TrustedAuthority.class
