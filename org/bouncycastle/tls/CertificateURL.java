...
public class CertificateURL {
  ...
  public CertificateURL(short paramShort, Vector paramVector) {
    ...
    if (paramShort == 1 && paramVector.size() != 1)
      throw new IllegalArgumentException("'urlAndHashList' must contain exactly one entry when type is " + CertChainType.getText(paramShort)); 
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tls\CertificateURL.class
