...
public class JceTlsSecret extends AbstractTlsSecret {
  ...
  public static JceTlsSecret convert(JcaTlsCrypto paramJcaTlsCrypto, TlsSecret paramTlsSecret) {
    if (paramTlsSecret instanceof JceTlsSecret)
      return (JceTlsSecret)paramTlsSecret; 
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tls\crypto\impl\jcajce\JceTlsSecret.class
