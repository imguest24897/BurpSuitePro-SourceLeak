...
public class SignatureAndHashAlgorithm {
  ...
  public static SignatureAndHashAlgorithm getInstance(short paramShort1, short paramShort2) {
    switch (paramShort1) {
      case 8:
  ...
  private static SignatureAndHashAlgorithm getInstanceIntrinsic(short paramShort) {
    switch (paramShort) {
      case 7:
        return ed25519;
      case 8:
  ...
  private static SignatureAndHashAlgorithm create(int paramInt) {
    short s1 = SignatureScheme.getHashAlgorithm(paramInt);
    short s2 = SignatureScheme.getSignatureAlgorithm(paramInt);
    return create(s1, s2);
  }
  
  private static SignatureAndHashAlgorithm create(short paramShort1, short paramShort2) {
    return new SignatureAndHashAlgorithm(paramShort1, paramShort2);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tls\SignatureAndHashAlgorithm.class
