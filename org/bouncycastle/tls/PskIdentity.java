...
public class PskIdentity {
  ...
  public static PskIdentity parse(InputStream paramInputStream) throws IOException {
    byte[] arrayOfByte = TlsUtils.readOpaque16(paramInputStream, 1);
    long l = TlsUtils.readUint32(paramInputStream);
    return new PskIdentity(arrayOfByte, l);
  }
  
  public boolean equals(Object paramObject) {
    if (!(paramObject instanceof PskIdentity))
      return false; 
    PskIdentity pskIdentity = (PskIdentity)paramObject;
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tls\PskIdentity.class
