...
public class TlsSRPKeyExchange extends AbstractTlsKeyExchange {
  ...
  public void processServerKeyExchange(InputStream paramInputStream) throws IOException {
    ...
    if (this.keyExchange != 21) {
      ...
      teeInputStream = new TeeInputStream(paramInputStream, digestInputBuffer);
    } 
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tls\TlsSRPKeyExchange.class
