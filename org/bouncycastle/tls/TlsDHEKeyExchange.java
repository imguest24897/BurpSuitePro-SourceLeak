...
public class TlsDHEKeyExchange extends AbstractTlsKeyExchange {
  ...
  public byte[] generateServerKeyExchange() throws IOException {
    ...
    TlsUtils.writeOpaque16(arrayOfByte, digestInputBuffer);
  ...
  public void processServerKeyExchange(InputStream paramInputStream) throws IOException {
    DigestInputBuffer digestInputBuffer = new DigestInputBuffer();
    TeeInputStream teeInputStream = new TeeInputStream(paramInputStream, digestInputBuffer);
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tls\TlsDHEKeyExchange.class
