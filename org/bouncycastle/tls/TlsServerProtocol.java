...
public class TlsServerProtocol extends TlsProtocol {
  ...
  public void accept(TlsServer paramTlsServer) throws IOException {
    ...
    paramTlsServer.init(this.tlsServerContext);
    paramTlsServer.notifyCloseHandle(this);
  ...
  protected ServerHello generate13ServerHello(ClientHello paramClientHello, HandshakeMessageInput paramHandshakeMessageInput, boolean paramBoolean) throws IOException {
    ...
    OfferedPsks.SelectedConfig selectedConfig = TlsUtils.selectPreSharedKey(this.tlsServerContext, this.tlsServer, hashtable1, paramHandshakeMessageInput, this.handshakeHash, paramBoolean);
    ...
    TlsUtils.establish13PhaseSecrets(this.tlsServerContext, tlsSecret1, tlsSecret2);
  ...
  protected ServerHello generateServerHello(ClientHello paramClientHello, HandshakeMessageInput paramHandshakeMessageInput) throws IOException {
    ...
    securityParameters.serverRandom = createRandomBlock(bool1, this.tlsServerContext);
    ...
    switch (paramShort) {
      case 11:
        switch (this.connection_state) {
          case 20:
            receive13ClientCertificate(paramHandshakeMessageInput);
      ...
      case 15:
        switch (this.connection_state) {
          case 15:
            receive13ClientCertificateVerify(paramHandshakeMessageInput);
      ...
      case 1:
        switch (this.connection_state) {
          case 0:
            throw new TlsFatalAlert((short)80);
          case 2:
            clientHello = receiveClientHelloMessage(paramHandshakeMessageInput);
      ...
      case 20:
        switch (this.connection_state) {
          ...
          case 17:
            receive13ClientFinished(paramHandshakeMessageInput);
  ...
  protected void handleHandshakeMessage(short paramShort, HandshakeMessageInput paramHandshakeMessageInput) throws IOException {
    ...
    switch (paramShort) {
      ...
      case 23:
        switch (this.connection_state) {
          case 12:
            this.tlsServer.processClientSupplementalData(readSupplementalDataMessage(paramHandshakeMessageInput));
      ...
      case 11:
        switch (this.connection_state) {
          ...
          case 14:
            receiveCertificateMessage(paramHandshakeMessageInput);
            this.connection_state = 15;
            return;
        } 
        throw new TlsFatalAlert((short)10);
      case 16:
        switch (this.connection_state) {
          ...
          case 15:
            receiveClientKeyExchangeMessage(paramHandshakeMessageInput);
        ...
        switch (this.connection_state) {
          case 16:
            if (!expectCertificateVerifyMessage())
              throw new TlsFatalAlert((short)10); 
            receiveCertificateVerifyMessage(paramHandshakeMessageInput);
            paramHandshakeMessageInput.updateHash(this.handshakeHash);
            this.connection_state = 17;
            return;
        } 
  ...
  protected void handleAlertWarningMessage(short paramShort) throws IOException {
    if (41 == paramShort && null != this.certificateRequest && TlsUtils.isSSL(this.tlsServerContext))
      switch (this.connection_state) {
        case 12:
          this.tlsServer.processClientSupplementalData((Vector)null);
        case 14:
  ...
  protected void notifyClientCertificate(Certificate paramCertificate) throws IOException {
    if (null == this.certificateRequest)
      throw new TlsFatalAlert((short)80); 
    TlsUtils.processClientCertificate(this.tlsServerContext, paramCertificate, this.keyExchange, this.tlsServer);
  }
  ...
  protected void receive13ClientCertificate(ByteArrayInputStream paramByteArrayInputStream) throws IOException {
    ...
    Certificate certificate = Certificate.parse(parseOptions, this.tlsServerContext, paramByteArrayInputStream, null);
  ...
  protected void receive13ClientCertificateVerify(ByteArrayInputStream paramByteArrayInputStream) throws IOException {
    ...
    if (null == certificate || certificate.isEmpty())
      throw new TlsFatalAlert((short)80); 
    CertificateVerify certificateVerify = CertificateVerify.parse(this.tlsServerContext, paramByteArrayInputStream);
    assertEmpty(paramByteArrayInputStream);
    TlsUtils.verify13CertificateVerifyClient(this.tlsServerContext, this.handshakeHash, certificateVerify);
  }
  ...
  protected void receiveCertificateVerifyMessage(ByteArrayInputStream paramByteArrayInputStream) throws IOException {
    DigitallySigned digitallySigned = DigitallySigned.parse(this.tlsServerContext, paramByteArrayInputStream);
    assertEmpty(paramByteArrayInputStream);
  ...
  protected void receiveClientKeyExchangeMessage(ByteArrayInputStream paramByteArrayInputStream) throws IOException {
    ...
    assertEmpty(paramByteArrayInputStream);
    boolean bool = TlsUtils.isSSL(this.tlsServerContext);
    if (bool)
  ...
  protected void send13EncryptedExtensionsMessage(Hashtable paramHashtable) throws IOException {
    ...
    TlsUtils.writeOpaque16(arrayOfByte, handshakeMessageOutput);
  ...
  protected void send13ServerHelloCoda(ServerHello paramServerHello, boolean paramBoolean) throws IOException {
    ...
    TlsUtils.establish13PhaseHandshake(this.tlsServerContext, arrayOfByte1, this.recordStream);
    ...
    if (!this.selectedPSK13) {
      ...
      this.connection_state = 7;
      DigitallySigned digitallySigned = TlsUtils.generate13CertificateVerify(this.tlsServerContext, tlsCredentialedSigner, this.handshakeHash);
    ...
    TlsUtils.establish13PhaseApplication(this.tlsServerContext, arrayOfByte2, this.recordStream);
    this.recordStream.enablePendingCipherWrite();
  }
  ...
  protected void sendCertificateRequestMessage(CertificateRequest paramCertificateRequest) throws IOException {
    ...
    paramCertificateRequest.encode(this.tlsServerContext, handshakeMessageOutput);
    handshakeMessageOutput.send(this);
  }
  ...
  protected void sendCertificateStatusMessage(CertificateStatus paramCertificateStatus) throws IOException {
    ...
    paramCertificateStatus.encode(handshakeMessageOutput);
    handshakeMessageOutput.send(this);
  }
  ...
  protected void sendNewSessionTicketMessage(NewSessionTicket paramNewSessionTicket) throws IOException {
    ...
    paramNewSessionTicket.encode(handshakeMessageOutput);
    handshakeMessageOutput.send(this);
  }
  ...
  protected void sendServerHelloMessage(ServerHello paramServerHello) throws IOException {
    ...
    paramServerHello.encode(this.tlsServerContext, handshakeMessageOutput);
    handshakeMessageOutput.send(this);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tls\TlsServerProtocol.class
