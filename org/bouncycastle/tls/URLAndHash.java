...
public class URLAndHash {
  ...
  public URLAndHash(String paramString, byte[] paramArrayOfbyte) {
    if (TlsUtils.isNullOrEmpty(paramString) || paramString.length() >= 65536)
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\tls\URLAndHash.class
