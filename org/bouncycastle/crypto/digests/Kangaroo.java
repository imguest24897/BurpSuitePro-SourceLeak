...
public final class Kangaroo {
  ...
  static abstract class KangarooBase implements ExtendedDigest, Xof {
    ...
    KangarooBase(int param1Int1, int param1Int2, int param1Int3, CryptoServicePurpose param1CryptoServicePurpose) {
      ...
      CryptoServicesRegistrar.checkConstraints(Utils.getDefaultProperties((Digest)this, param1Int1, param1CryptoServicePurpose));
    }
  ...
  public static class KangarooTwelve extends KangarooBase {
    ...
    public KangarooTwelve(int param1Int, CryptoServicePurpose param1CryptoServicePurpose) {
      super(128, 12, param1Int, param1CryptoServicePurpose);
    }
    
    public KangarooTwelve(CryptoServicePurpose param1CryptoServicePurpose) {
      this(32, param1CryptoServicePurpose);
    }
  ...
  public static class MarsupilamiFourteen extends KangarooBase {
    ...
    public MarsupilamiFourteen(int param1Int, CryptoServicePurpose param1CryptoServicePurpose) {
      super(256, 14, param1Int, param1CryptoServicePurpose);
    }
    
    public MarsupilamiFourteen(CryptoServicePurpose param1CryptoServicePurpose) {
      this(32, param1CryptoServicePurpose);
    }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\crypto\digests\Kangaroo.class
