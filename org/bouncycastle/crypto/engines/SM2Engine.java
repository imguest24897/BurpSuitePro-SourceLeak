...
public class SM2Engine {
  ...
  public SM2Engine(Mode paramMode) {
    this((Digest)new SM3Digest(), paramMode);
  }
  ...
  public void init(boolean paramBoolean, CipherParameters paramCipherParameters) {
    ...
    CryptoServicesRegistrar.checkConstraints((CryptoServiceProperties)new DefaultServiceProperties("SM2", ConstraintUtils.bitsOfSecurityFor(this.ecParams.getCurve()), this.ecKey, Utils.getPurpose(paramBoolean)));
  }
  ...
  private void kdf(Digest paramDigest, ECPoint paramECPoint, byte[] paramArrayOfbyte) {
    ...
    while (j < paramArrayOfbyte.length) {
      ...
      Bytes.xorTo(k, arrayOfByte, 0, paramArrayOfbyte, j);
      j += k;
    } 
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\crypto\engines\SM2Engine.class
