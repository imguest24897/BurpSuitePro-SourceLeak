...
public class ESTResponse {
  ...
  public long getAbsoluteReadLimit() {
    return (this.absoluteReadLimit == null) ? Long.MAX_VALUE : this.absoluteReadLimit.longValue();
  }
  ...
  private void process() throws IOException {
    ...
    boolean bool = this.headers.getFirstValueOrEmpty("Transfer-Encoding").equalsIgnoreCase("chunked");
    if (bool) {
    ...
    if (this.contentLength.equals(ZERO) && !bool)
  ...
  public String getHeaderOrEmpty(String paramString) {
    return this.headers.getFirstValueOrEmpty(paramString);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\est\ESTResponse.class
