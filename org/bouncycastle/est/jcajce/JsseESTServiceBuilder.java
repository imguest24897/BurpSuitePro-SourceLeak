...
public class JsseESTServiceBuilder extends ESTServiceBuilder {
  ...
  public JsseESTServiceBuilder(String paramString, int paramInt, SSLSocketFactoryCreator paramSSLSocketFactoryCreator) {
  ...
  public JsseESTServiceBuilder(String paramString, int paramInt, X509TrustManager paramX509TrustManager) {
    super(paramString + ":" + paramInt);
  ...
  public JsseESTServiceBuilder(String paramString, int paramInt, X509TrustManager[] paramArrayOfX509TrustManager) {
    this(paramString + ":" + paramInt, paramArrayOfX509TrustManager);
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\est\jcajce\JsseESTServiceBuilder.class
