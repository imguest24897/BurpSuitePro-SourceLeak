...
class CTEBase64InputStream extends InputStream {
  ...
  public CTEBase64InputStream(InputStream paramInputStream) {
  ...
  protected int pullFromSrc() throws IOException {
    ...
    byte b = 0;
    do {
      if (this.max != null && this.read > this.max.longValue())
        return -1; 
      i = this.src.read();
      if (i >= 33 || i == 13 || i == 10) {
    ...
    } while (i > -1 && b < this.rawBuf.length && i != 10);
    if (b > 0) {
      try {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\org\bouncycastle\est\CTEBase64InputStream.class
