...
public class Zi extends Zp {
  ...
  public Zi() {
    super(List.of(Page.class.getSimpleName()));
  }
  
  public boolean Zp(Zxf paramZxf) {
    return (super.Zp(paramZxf) && paramZxf.ZO().name().ZS().equals(a));
  }
  ...
  static {
    ...
    //   4: iconst_m1
    //   5: goto -> 14
    //   8: putstatic net/portswigger/devtools/client/impl/Zi.a : Ljava/lang/String;
    //   11: goto -> 153
    //   14: dup_x2
    //   15: pop
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\net\portswigger\devtools\client\impl\Zi.class
