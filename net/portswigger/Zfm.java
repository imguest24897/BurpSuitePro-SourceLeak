...
public interface Zfm {
  public static final Pattern Zq;
  
  public static final Pattern ZU;
  ...
  static {
    ...
    //   5: iconst_0
    //   6: istore #4
    //   8: ldc '*fVo@,8\}:8GGtHX&?*fVo\Z,\8g6t+7V,BZ['
    //   10: dup
    //   11: astore_3
    ...
    //   221: putstatic net/portswigger/Zfm.Zq : Ljava/util/regex/Pattern;
    //   224: aload_0
    //   225: iconst_1
    //   226: aaload
    //   227: invokestatic compile : (Ljava/lang/String;)Ljava/util/regex/Pattern;
    //   230: putstatic net/portswigger/Zfm.ZU : Ljava/util/regex/Pattern;
    //   233: return
  }
}


/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\net\portswigger\Zfm.class
