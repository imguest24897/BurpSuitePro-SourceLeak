...
public class XML {
  ...
  public int hashCode() {
    return Objects.hash(new Object[] { this.name, this.namespace, this.prefix, this.attribute, this.wrapped, this.extensions });
  }
  ...
  public void addExtension(String paramString, Object paramObject) {
    if (paramString == null || paramString.isEmpty() || !paramString.startsWith(a(2619, -6643)))
      return; 
  ...
  public void addExtension31(String paramString, Object paramObject) {
    if (paramString != null && (paramString.startsWith(a(2623, 14248)) || paramString.startsWith(a(2617, 2858))))
      return; 
  ...
  public XML extensions(Map<String, Object> paramMap) {
    this.extensions = paramMap;
    return this;
  }
  ...
  public String toString() {
    ...
    stringBuilder.append(a(2618, -18010));
    stringBuilder.append(a(2610, -29376)).append(toIndentedString(this.name)).append("\n");
    stringBuilder.append(a(2611, 1328)).append(toIndentedString(this.namespace)).append("\n");
    stringBuilder.append(a(2609, 18135)).append(toIndentedString(this.prefix)).append("\n");
    stringBuilder.append(a(2621, 29247)).append(toIndentedString(this.attribute)).append("\n");
    stringBuilder.append(a(2616, 9896)).append(toIndentedString(this.wrapped)).append("\n");
    stringBuilder.append("}");
    return stringBuilder.toString();
  }
  
  private String toIndentedString(Object paramObject) {
    return (paramObject == null) ? a(2620, 22671) : paramObject.toString().replace("\n", a(2622, -21808));
  }
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'ùW\\fÔ²é±¸=ÚÇ~kÌoÚ)ý\\röd;¥Z£ð)UeUwv6csæGõy¸Ê>1/QÉÆÄ§z$mÅò]wÌîï¬kí'
    //   11: dup
    //   12: astore_2
    ...
    //   123: goto -> 81
    //   126: aload #5
    //   128: putstatic net/portswigger/swagger/v3/oas/models/media/XML.a : [Ljava/lang/String;
    //   131: bipush #11
    //   133: anewarray java/lang/String
    //   136: putstatic net/portswigger/swagger/v3/oas/models/media/XML.b : [Ljava/lang/String;
    //   139: goto -> 300
    //   142: dup_x2
    //   143: pop
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\net\portswigger\swagger\v3\oas\models\media\XML.class
