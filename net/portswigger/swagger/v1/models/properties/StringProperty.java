...
public class StringProperty extends AbstractProperty implements Property {
  ...
  public StringProperty(StringProperty$Format paramStringProperty$Format) {
    this(paramStringProperty$Format.getName());
  }
  
  public StringProperty(String paramString) {
    this.type = b(-13223, 6597);
    this.format = paramString;
  }
  
  public static boolean isType(String paramString1, String paramString2) {
    return b(-13222, -12057).equals(paramString1);
  }
  
  public StringProperty pattern(String paramString) {
    setPattern(paramString);
    return this;
  }
  
  public StringProperty xml(Xml paramXml) {
    setXml(paramXml);
    return this;
  }
  
  public StringProperty example(String paramString) {
    setExample(paramString);
    return this;
  }
  
  public StringProperty minLength(Integer paramInteger) {
    setMinLength(paramInteger);
    return this;
  }
  
  public StringProperty maxLength(Integer paramInteger) {
    setMaxLength(paramInteger);
    return this;
  }
  
  public StringProperty _enum(String paramString) {
    if (this._enum == null)
  ...
  public StringProperty _enum(List<String> paramList) {
    this._enum = paramList;
    return this;
  }
  
  public StringProperty _default(String paramString) {
    this._default = paramString;
    return this;
  }
  
  public StringProperty vendorExtension(String paramString, Object paramObject) {
    setVendorExtension(paramString, paramObject);
    return this;
  }
  
  public StringProperty required(boolean paramBoolean) {
  ...
  public boolean equals(Object paramObject) {
    if (!super.equals(paramObject))
      return false; 
    if (!(paramObject instanceof StringProperty))
      return false; 
    StringProperty stringProperty = (StringProperty)paramObject;
    ...
    return !((this.pattern != null) ? !this.pattern.equals(stringProperty.pattern) : (stringProperty.pattern != null));
  }
  ...
  static {
    ...
    //   64: goto -> 22
    //   67: aload #5
    //   69: putstatic net/portswigger/swagger/v1/models/properties/StringProperty.c : [Ljava/lang/String;
    //   72: iconst_3
    //   73: anewarray java/lang/String
    //   76: putstatic net/portswigger/swagger/v1/models/properties/StringProperty.d : [Ljava/lang/String;
    //   79: sipush #-13224
    //   82: sipush #11559
    //   85: invokestatic b : (II)Ljava/lang/String;
    //   88: putstatic net/portswigger/swagger/v1/models/properties/StringProperty.TYPE : Ljava/lang/String;
    //   91: goto -> 239
    //   94: dup_x2
    //   95: pop
  ...
  private static String b(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFCC58) & 0xFFFF;
    if (d[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\net\portswigger\swagger\v1\models\properties\StringProperty.class
