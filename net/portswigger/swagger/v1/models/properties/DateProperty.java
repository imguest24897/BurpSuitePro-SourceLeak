...
public class DateProperty extends AbstractProperty implements Property {
  ...
  public DateProperty() {
    this.type = b(-3988, 234);
    this.format = b(-3986, 1738);
  }
  
  public DateProperty _enum(String paramString) {
    if (this._enum == null)
  ...
  public DateProperty _enum(List<String> paramList) {
    this._enum = paramList;
    return this;
  }
  
  public static boolean isType(String paramString1, String paramString2) {
    return (b(-3987, 1813).equals(paramString1) && b(-3985, -8373).equals(paramString2));
  }
  
  public DateProperty xml(Xml paramXml) {
    setXml(paramXml);
    return this;
  }
  
  public DateProperty example(String paramString) {
    setExample(paramString);
    return this;
  }
  
  public DateProperty vendorExtension(String paramString, Object paramObject) {
  ...
  static {
    ...
    //   122: goto -> 80
    //   125: aload #5
    //   127: putstatic net/portswigger/swagger/v1/models/properties/DateProperty.c : [Ljava/lang/String;
    //   130: iconst_4
    //   131: anewarray java/lang/String
    //   134: putstatic net/portswigger/swagger/v1/models/properties/DateProperty.d : [Ljava/lang/String;
    //   137: goto -> 296
    //   140: dup_x2
    //   141: pop
  ...
  private static String b(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFF06F) & 0xFFFF;
    if (d[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\net\portswigger\swagger\v1\models\properties\DateProperty.class
