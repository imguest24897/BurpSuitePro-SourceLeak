...
public class License {
  ...
  public License name(String paramString) {
    setName(paramString);
    return this;
  }
  
  public License url(String paramString) {
    setUrl(paramString);
    return this;
  }
  ...
  public boolean equals(Object paramObject) {
    ...
    if (this.name == null) {
      if (license.name != null)
        return false; 
    } else if (!this.name.equals(license.name)) {
      return false;
    } 
    if (this.url == null) {
      if (license.url != null)
    ...
    if (this.vendorExtensions == null) {
      if (license.vendorExtensions != null)
        return false; 
    } else if (!this.vendorExtensions.equals(license.vendorExtensions)) {
      return false;
    } 
    return true;
  }
  ...
  static {
    ...
    //   4: iconst_m1
    //   5: goto -> 14
    //   8: putstatic net/portswigger/swagger/v1/models/License.a : Ljava/lang/String;
    //   11: goto -> 154
    //   14: dup_x2
    //   15: pop
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\net\portswigger\swagger\v1\models\License.class
