...
public class Tag {
  ...
  public Tag externalDocs(ExternalDocs paramExternalDocs) {
  ...
  public void setVendorExtension(String paramString, Object paramObject) {
    if (paramString.startsWith(a(4060, 21805)))
  ...
  public String toString() {
    ...
    stringBuilder.append(a(4056, -14108));
    stringBuilder.append(a(4057, 11473)).append(getName()).append("\n");
    stringBuilder.append(a(4061, -16)).append(getDescription()).append("\n");
    stringBuilder.append(a(4062, 31271)).append(getExternalDocs()).append("\n");
    stringBuilder.append(a(4063, -13839)).append(this.vendorExtensions.toString());
  ...
  public boolean equals(Object paramObject) {
    ...
    if (this.vendorExtensions == null) {
      if (tag.vendorExtensions != null)
        return false; 
    } else if (!this.vendorExtensions.equals(tag.vendorExtensions)) {
      return false;
    } 
    return true;
  }
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'ä¤H1Íô]{þ½¤´~é\\f.×ø .fb¤úäëèoçßÑ Íãcé'
    //   11: dup
    //   12: astore_2
    ...
    //   123: goto -> 82
    //   126: aload #5
    //   128: putstatic net/portswigger/swagger/v1/models/Tag.a : [Ljava/lang/String;
    //   131: bipush #6
    //   133: anewarray java/lang/String
    //   136: putstatic net/portswigger/swagger/v1/models/Tag.b : [Ljava/lang/String;
    //   139: goto -> 300
    //   142: dup_x2
    //   143: pop
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\net\portswigger\swagger\v1\models\Tag.class
