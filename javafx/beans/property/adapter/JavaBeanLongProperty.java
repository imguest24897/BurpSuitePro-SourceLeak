...
/*     */   
/*     */   JavaBeanLongProperty(PropertyDescriptor<Number> paramPropertyDescriptor, Object paramObject) {
...
/*     */   
/*     */   public long get() {
/* 119 */     return ((Long)AccessController.<Long>doPrivileged(() -> {
/*     */           
/*     */           try {
...
/*     */           try {
/*     */             MethodHelper.invoke(this.descriptor.getSetter(), getBean(), new Object[] { Long.valueOf(paramLong) });
...
/* 167 */       unbind();
/* 168 */       set(((Number)paramObservableValue.getValue()).longValue());
...
/* 266 */     StringBuilder stringBuilder = new StringBuilder("LongProperty [");
/* 267 */     if (object != null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\javafx\beans\property\adapter\JavaBeanLongProperty.class
