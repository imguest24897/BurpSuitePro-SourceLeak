...
/*     */   
/*     */   JavaBeanFloatProperty(PropertyDescriptor<Number> paramPropertyDescriptor, Object paramObject) {
...
/*     */   
/*     */   public float get() {
/* 119 */     return ((Float)AccessController.<Float>doPrivileged(() -> {
/*     */           
/*     */           try {
...
/*     */           try {
/*     */             MethodHelper.invoke(this.descriptor.getSetter(), getBean(), new Object[] { Float.valueOf(paramFloat) });
...
/* 167 */       unbind();
/* 168 */       set(((Number)paramObservableValue.getValue()).floatValue());
...
/* 266 */     StringBuilder stringBuilder = new StringBuilder("FloatProperty [");
/* 267 */     if (object != null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\javafx\beans\property\adapter\JavaBeanFloatProperty.class
