...
/*     */ 
/*     */ 
/*     */ class TypedGenericBidirectionalBinding<T>
...
/* 617 */     super(paramProperty1, paramProperty2);
/* 618 */     this.oldValue = (T)paramProperty1.getValue();
/* 619 */     this.propertyRef1 = new WeakReference<>(paramProperty1);
/* 620 */     this.propertyRef2 = new WeakReference<>(paramProperty2);
/*     */   }
/*     */ 
/*     */   
...
/* 648 */           if (property1 == paramObservable) {
...
/*     */           try {
/* 661 */             if (property1 == paramObservable) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\com\sun\javafx\binding\BidirectionalBinding$TypedGenericBidirectionalBinding.class
