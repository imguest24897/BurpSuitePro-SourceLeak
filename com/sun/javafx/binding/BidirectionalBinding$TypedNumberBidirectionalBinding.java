...
/*     */ 
/*     */ 
/*     */ class TypedNumberBidirectionalBinding<T extends Number>
...
/* 694 */     super(paramProperty, paramProperty1);
/* 695 */     this.oldValue = (T)paramProperty.getValue();
/* 696 */     this.propertyRef1 = new WeakReference<>(paramProperty);
/* 697 */     this.propertyRef2 = new WeakReference<>(paramProperty1);
/*     */   }
/*     */ 
/*     */   
...
/* 725 */           if (property1 == paramObservable) {
...
/*     */           try {
/* 738 */             if (property1 == paramObservable) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\com\sun\javafx\binding\BidirectionalBinding$TypedNumberBidirectionalBinding.class
