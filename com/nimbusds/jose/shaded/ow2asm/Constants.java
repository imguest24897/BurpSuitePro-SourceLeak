...
/* 194 */     if (!internalName.startsWith("com/nimbusds/jose/shaded/ow2asm/")) {
/* 195 */       return false;
/*     */     }
/* 197 */     String member = "(Annotation|Class|Field|Method|Module|RecordComponent|Signature)";
/* 198 */     return (internalName.contains("Test$") || 
/* 199 */       Pattern.matches("com/nimbusds/jose/shaded/ow2asm/util/Trace" + member + "Visitor(\\$.*)?", internalName) || 
/*     */       
/* 201 */       Pattern.matches("com/nimbusds/jose/shaded/ow2asm/util/Check" + member + "Adapter(\\$.*)?", internalName));
/*     */   }
/*     */   
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\com\nimbusds\jose\shaded\ow2asm\Constants.class
