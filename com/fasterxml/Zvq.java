...
public abstract class Zvq extends Zv_ {
  protected final Class<?> Zh;
  
  protected final String ZX;
  
  protected final Collection<Object> Zz;
  
  protected transient String ZG;
  
  private static final String[] e;
  
  private static final String[] f;
  
  protected Zvq(Zg paramZg, String paramString1, Zm5 paramZm5, Class<?> paramClass, String paramString2, Collection<Object> paramCollection) {
    super(paramZg, paramString1, paramZm5);
    this.Zh = paramClass;
  ...
  public String ZF() {
    ...
    //   3: aload_0
    //   4: getfield ZG : Ljava/lang/String;
    //   7: astore_2
    //   8: astore_1
    //   9: aload_2
    //   10: ifnonnull -> 255
    //   13: aload_0
    //   14: getfield Zz : Ljava/util/Collection;
    //   17: ifnull -> 255
    ...
    //   29: astore_3
    //   30: aload_0
    //   31: getfield Zz : Ljava/util/Collection;
    ...
    //   48: sipush #-29745
    //   51: sipush #25516
    //   54: invokestatic c : (II)Ljava/lang/String;
    //   57: invokevirtual append : (Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   60: pop
    //   61: aload_3
    //   62: aload_0
    //   63: getfield Zz : Ljava/util/Collection;
    ...
    //   95: sipush #-29746
    //   98: sipush #-5368
    //   101: invokestatic c : (II)Ljava/lang/String;
    ...
    //   124: pop
    //   125: aload_0
    //   126: getfield Zz : Ljava/util/Collection;
    ...
    //   186: sipush #-29750
    //   189: sipush #17562
    //   192: invokestatic c : (II)Ljava/lang/String;
    ...
    //   250: dup
    //   251: astore_2
    //   252: putfield ZG : Ljava/lang/String;
    //   255: aload_2
    //   256: areturn
  }
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'éÎu1ûkYÄTOÍâ¤f(Ö\\nQ¿é0rm¾2µd¼1Áåúé9\\t®'
    //   11: dup
    //   12: astore_2
    ...
    //   123: goto -> 81
    //   126: aload #5
    //   128: putstatic com/fasterxml/Zvq.e : [Ljava/lang/String;
    //   131: bipush #6
    //   133: anewarray java/lang/String
    //   136: putstatic com/fasterxml/Zvq.f : [Ljava/lang/String;
    //   139: goto -> 300
    //   142: dup_x2
    //   143: pop
  ...
  private static String c(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFF8BCF) & 0xFFFF;
    if (f[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\com\fasterxml\Zvq.class
