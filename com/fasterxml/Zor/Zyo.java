...
public abstract class Zyo<T> implements Zzb {
  ...
  public abstract T deserialize(Zg paramZg, Zyg paramZyg) throws IOException, Zd;
  
  public T ZI(Zg paramZg, Zyg paramZyg, T paramT) throws IOException, Zd {
    paramZyg.Zd(this);
    return deserialize(paramZg, paramZyg);
  }
  
  public Object Zf(Zg paramZg, Zyg paramZyg, Zt paramZt) throws IOException, Zd {
    return paramZt.Zy(paramZg, paramZyg);
  }
  
  public Object ZY(Zg paramZg, Zyg paramZyg, Zt paramZt, T paramT) throws IOException, Zd {
    paramZyg.Zd(this);
    return Zf(paramZg, paramZyg, paramZt);
  }
  ...
  public Zv ZW(String paramString) {
    throw new IllegalArgumentException(a(7564, -28859) + paramString + a(7566, -29642) + getClass().getName() + a(7567, -5578));
  }
  ...
  static {
    ...
    //   7: istore_3
    //   8: iconst_0
    //   9: ldc 'GJBjWÖl¸!º«ú¦J]Öì·Õ¨ÕaÇÿÚA}:lEÓ&é´k}7ñ²í5i±©&ºd[|Ø"8Àý¨Hýo\\nMúû[ÖDhÝP8?âìµr²ñ'
    //   11: dup
    //   12: astore_2
    ...
    //   68: goto -> 26
    //   71: aload #5
    //   73: putstatic com/fasterxml/Zor/Zyo.a : [Ljava/lang/String;
    //   76: iconst_3
    //   77: anewarray java/lang/String
    //   80: putstatic com/fasterxml/Zor/Zyo.b : [Ljava/lang/String;
    //   83: goto -> 231
    //   86: dup_x2
    //   87: pop
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\com\fasterxml\Zor\Zyo.class
