...
class Zbjx extends ClassLoader {
  static Object ZT;
  ...
  static void ZJ(Object paramObject) {
    Zmig.ZR = a(-3437, 12171);
    Zmig.Zh = new BigInteger(a(-3429, 32572));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zspg.ZG.charAt(Math.abs(((BigInteger)Zz7m.Zh).intValue() % 32)) > Zz0f.ZW.charAt(Math.abs(((BigInteger)Zxy6.Zd).intValue() % 32))) {
          try {
            Ze08.ZT(Class.forName(a(-3430, 22158)));
            if (!bool)
              Zxxf.ZJ(Class.forName(a(-3427, 4376))); 
  ...
  static boolean Zd(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   11: astore_3
    //   12: getstatic burp/Zr17.Zu : Ljava/lang/String;
    //   15: astore #4
    //   17: iconst_0
    //   18: istore #5
    //   20: iload #5
    ...
    //   61: astore #5
    //   63: getstatic burp/Zedq.Zy : Ljava/lang/Object;
    ...
    //   2521: putstatic burp/Zrh_.Zb : Ljava/lang/Object;
    //   2524: sipush #-24997
    ...
    //   2850: iconst_0
    //   2851: istore_3
    //   2852: getstatic burp/Zb0q.Zr : Ljava/lang/String;
    //   2855: getstatic burp/Zssc.Zr : Ljava/lang/Object;
    ...
    //   2873: getstatic burp/Zzk_.ZX : Ljava/lang/String;
    //   2876: getstatic burp/Zsdl.Zx : Ljava/lang/Object;
    ...
    //   3580: iload_3
    //   3581: ireturn
    //   3582: getstatic burp/Zmz.Zp : Ljava/lang/String;
    //   3585: getstatic burp/Zos.ZB : Ljava/lang/Object;
    ...
    //   3603: getstatic burp/Zlab.Zp : Ljava/lang/String;
    //   3606: getstatic burp/Zrkw.ZV : Ljava/lang/Object;
    ...
    //   4311: iload_3
    //   4312: ireturn
    //   4313: getstatic burp/Zgsy.Zv : Ljava/lang/String;
    //   4316: getstatic burp/Zrfs.ZV : Ljava/lang/Object;
    ...
    //   4334: getstatic burp/Zb2u.ZM : Ljava/lang/String;
    //   4337: getstatic burp/Zgis.ZV : Ljava/lang/Object;
    ...
    //   5042: iload_3
    //   5043: ireturn
    //   5044: getstatic burp/Ze2k.ZY : Ljava/lang/String;
    //   5047: getstatic burp/Zzht.Zb : Ljava/lang/Object;
    ...
    //   5065: getstatic burp/Zx4u.ZL : Ljava/lang/String;
    //   5068: getstatic burp/Zg4l.ZI : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '\\tÞ*ß<ïÓ9 jè@\\nÈ/ÂVHBÝëäÝ$DØc7©-ß}ÝOCÊv揦短漶ロ柍ﻆꮫ쫐쥖頋䝖궂ꈆ鲐狽뜹錛㛤㑬燣ㆭТ⍿ᢰՃݪ胤눍॥ⰽᮼ婴动홯⧰⼒匍6ₜ녪櫝븞䫻塏탘ꨎ䏣㌦䔻Ȱ僀龳優䃣鋩㢭받?ၱ춅ጷ忰䐾쒁纂搔ᤞ怓佘≇邙䛤뢔?ହ㨳䧉⓼숆겍鄚㟱跋乽泧敀껦먘╶᳸둄瓓䮯譑灌떽䣔憖坶蛝ᵓ频槊軏鬛蝋칦⡈谵视뾏䊢䄏ⶳ뀵묩*É´ .Pï9æRàÌãp6ï3ë®5××«aß¬j6yo\\t´y,Þ)¢7ß\\tÛâÁ­ÌÉ<\\tØ¡cí\\tdG6jZSÜ\\tZ9ñÖ£_.=\\tåýNl°_\\tðïÿþÏMÃülâ Ù\\nÆíÙÛ4Ôbt\ìQA[@C\\bn</øÖk(î­tUó ÊXXóØ¬½Ò§Þ7²É¬­¯¾\\tà©¦Äxá7¬¢/¥\\t)»_©è>K\\tg·VfÒìßÞs]ú\\tNï]òxÁZ"ºÃ捊睖潁た朣ﺐꭶ쨚짭朗䜡궩ꋨ鳵爠랕鎠㙱㓞熵ㅰӨ⏄ᣩԴ݁耊닐৉Ⲇᬩ娃刚횁⦦⿏叇⃅넝櫶뻰䪞墒클ꪵ䍶㍑䖉˞傖齮几䁘銰㣚배?န촩ᎌ彥䑉쐳繬摂ᧃ惙俣∞郮䛏롺?௤㪈䥜⒋슴걣酌㝊趒上泌攥긻몴◍ᱭ됳琽䯹讌炆딆䢍憽垘蚸ᶎ頪楟躸鮩螥츰⢕賿襽뿖䋕䄤ⵝ끐믴\\tR¨»¹=\\tiðï^ÏÓD\\tÊõ{ª?¹\\tô$ (mìÀ\\tNosÂúJ\\b"\\t2õüO3bQñ\\t®úo®A¬:Â,'
    //   11: dup
    //   12: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zbjx.a : [Ljava/lang/String;
    //   132: bipush #28
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zbjx.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   497: putstatic burp/Zbjx.ZT : Ljava/lang/Object;
    //   500: sipush #-3434
    //   503: sipush #-988
    //   506: invokestatic a : (II)Ljava/lang/String;
    //   509: putstatic burp/Zbjx.ZA : Ljava/lang/String;
    //   512: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFF297) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zbjx.class
