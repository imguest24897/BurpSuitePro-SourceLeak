...
class Zx_x extends ClassLoader {
  static Object Zi;
  ...
  static boolean Zq(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   0: invokestatic ZN : ()Z
    //   3: istore_2
    //   4: getstatic burp/Zztz.Zq : Ljava/lang/Object;
    ...
    //   1015: iconst_0
    //   1016: istore_3
    //   1017: getstatic burp/Ztys.Zn : Ljava/lang/String;
    //   1020: getstatic burp/Zrs0.Zz : Ljava/lang/Object;
    ...
    //   1038: getstatic burp/Zm8i.Z_ : Ljava/lang/String;
    //   1041: getstatic burp/Zzxv.ZZ : Ljava/lang/Object;
    ...
    //   1745: iload_3
    //   1746: ireturn
    //   1747: getstatic burp/Zz35.ZH : Ljava/lang/String;
    //   1750: getstatic burp/Zecw.ZE : Ljava/lang/Object;
    ...
    //   1768: getstatic burp/Zgkn.ZV : Ljava/lang/String;
    //   1771: getstatic burp/Zxtc.ZF : Ljava/lang/Object;
    ...
    //   2476: iload_3
    //   2477: ireturn
    //   2478: getstatic burp/Zlb6.ZP : Ljava/lang/String;
    //   2481: getstatic burp/Zlps.ZU : Ljava/lang/Object;
    ...
    //   2499: getstatic burp/Zldt.Zj : Ljava/lang/String;
    //   2502: getstatic burp/Zmt7.Z_ : Ljava/lang/Object;
    ...
    //   3207: iload_3
    //   3208: ireturn
    //   3209: getstatic burp/Zeor.Zj : Ljava/lang/String;
    //   3212: getstatic burp/Zelc.ZR : Ljava/lang/Object;
    ...
    //   3230: getstatic burp/Zmtf.Zx : Ljava/lang/String;
    //   3233: getstatic burp/Ztkc.ZV : Ljava/lang/Object;
  ...
  static void Zm(Object paramObject) {
    Zb2k.Zu = a(28164, 1829);
    Zb2k.ZZ = new BigInteger(a(28181, -3504));
    boolean bool = Zt2e.ZK();
    try {
      try {
        if (Zzs9.Zg.charAt(Math.abs(((BigInteger)Zm8i.Zm).intValue() % 32)) <= Zb9h.Zf.charAt(Math.abs(((BigInteger)Zlav.Zp).intValue() % 32))) {
          try {
            Zx4y.ZD(Class.forName(a(28169, 7143)));
            if (bool)
              Zex.ZZ(Class.forName(a(28189, -31942))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '6@­×5I÷ &P96\\tw÷þoáæi~x¯¨Ùaü#Ä0\\tz<&\\f\5\\tîhÎÈ[µ, C\\nbã ³lóR(wõ§xñLÚ:¸áý¼¿¦|û\\tå$}A$èë)Ñe\¯\\tÐRFÒ6MG\\tM)õ½@rí\\tÿ£¸ÒÑék\\t0Zµ´)?Þ tfn\\ro&´ò&Ü¿Í¼gÃá6Íe'¾Ho¹z\\tÅäkb¨ÑçØ\\tÜ_Çs«]ÂP\\tBÚÃ|½©&ouMªI{8¬F¶sai}Ë§Ð+a¤_ÇäHh§dUeÿÞ÷7òq,_ò Í_=%«|©üùSÖÜà?Bã¦_\\fqÔ:\\\rt]jú_I\\tå<àâ&×gÔ\\tÍNåQBïÃ\E\\t=ûéø»¼Y\\t]F÷P ÏaG\\t@ªTÍt|p\\t¬ÌÉÇås\\t½fëTOäVP\\tÔ=Y©1\\tÞ¯þCYp¸'
    //   11: dup
    //   12: astore_2
    ...
    //   123: goto -> 81
    //   126: aload #5
    //   128: putstatic burp/Zx_x.a : [Ljava/lang/String;
    //   131: bipush #28
    //   133: anewarray java/lang/String
    //   136: putstatic burp/Zx_x.b : [Ljava/lang/String;
    //   139: goto -> 300
    //   142: dup_x2
    //   143: pop
    ...
    //   498: putstatic burp/Zx_x.Zi : Ljava/lang/Object;
    //   501: sipush #28161
    //   504: sipush #-16134
    //   507: invokestatic a : (II)Ljava/lang/String;
    //   510: putstatic burp/Zx_x.Zv : Ljava/lang/String;
    //   513: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zx_x.class
