...
class Zl1e extends ClassLoader {
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'ÙÒró¨¹±¶ß]a\\rW\\føêÿ\\f¾ª|ìÜ(\\tì¬ðÑÜ©h\\tCaíT`\\nF§ÁÅMgÝ:G³å+\Îò£Ë7ad\\f{å\\nÌX\\bKmóFk¦1JøkH«9Iúî\\n¹ÏcXª²èJá©h ¡ªPé*ºu4Ú\\t¦DÝ¹zs÷WM¡gAÝÑ{-¸0ËM\\bè)Ì¹RÎ"h>yôósÂTÊBò"¾ÍRÜ[G¼Ì~·s\\n³A\\tléüO!¤q¦¼éÄÚ\Ó¡[)'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc '²ãMWò8 NcÞ\\t §èùþe²ê¬üóQñÑà9K#ÞÖ¥X'
    //   70: dup
    //   71: astore_2
