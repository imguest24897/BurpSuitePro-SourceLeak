...
class Zsmn extends ClassLoader {
  static Object Zq;
  ...
  static void ZD(Object paramObject) {
    Ze08.Zh = a(23990, 963);
    Ze08.ZJ = new BigInteger(a(23983, 14359));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Ze08.Zh.charAt(Math.abs(((BigInteger)Zg7j.Zr).intValue() % 32)) <= Ztzw.Zi.charAt(Math.abs(((BigInteger)Zec_.ZN).intValue() % 32))) {
          try {
            Zxof.ZY(Class.forName(a(23987, 3887)));
            if (!bool)
              Zein.Zs(Class.forName(a(23996, 32098))); 
  ...
  static boolean ZW(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   19: putstatic burp/Zl6e.Zo : Ljava/lang/Object;
    //   22: sipush #23977
    //   25: sipush #-26359
    ...
    //   351: iconst_0
    //   352: istore_3
    //   353: getstatic burp/Zx_u.Z_ : Ljava/lang/String;
    //   356: getstatic burp/Zrcu.Zs : Ljava/lang/Object;
    ...
    //   374: getstatic burp/Zlxh.ZG : Ljava/lang/String;
    //   377: getstatic burp/Zkde.Zk : Ljava/lang/Object;
    ...
    //   1081: iload_3
    //   1082: ireturn
    //   1083: getstatic burp/Zl5d.Zh : Ljava/lang/String;
    //   1086: getstatic burp/Zmir.ZF : Ljava/lang/Object;
    ...
    //   1104: getstatic burp/Zlfi.Zg : Ljava/lang/String;
    //   1107: getstatic burp/Zl6e.Zo : Ljava/lang/Object;
    ...
    //   1817: getstatic burp/Zx_b.ZX : Ljava/lang/Object;
    ...
    //   1835: getstatic burp/Zec0.Zk : Ljava/lang/String;
    //   1838: getstatic burp/Zelz.Z_ : Ljava/lang/Object;
    ...
    //   2543: iload_3
    //   2544: ireturn
    //   2545: getstatic burp/Zty2.ZR : Ljava/lang/String;
    //   2548: getstatic burp/Zry9.Zw : Ljava/lang/Object;
    ...
    //   2566: getstatic burp/Zevf.ZL : Ljava/lang/String;
    //   2569: getstatic burp/Ztzw.Zk : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '_EÆSÃÓØ5ÀV>\\nþú¨¦m Ùê×c©\\t*±11ØE¨¤\\th÷yùÁl×\\tY_@Né2\\tuäÚðâE[\\tÍ(Í¾©7Î\\b<©ó2Õ¸Nø\\trI:.ì;~=  Q0B©\\nÀ<Àgþ(9x¥@÷»m -ãaX{ÑmNª\\tó{\\nhêó¶9\\tíÍÉ¾)¦ÉÞ\\t$/:4\\tEdr¼Å\\tTÅ!FØ(]\\tµ¥JH©ò\\tù8ùßµLüû¸ýªdcøÑ×b_öüj_au±ûÆê{¹ÄÄ18ú\/{Ñ ºoÏÙ¨ÂXµ½ÊíiÇ'òü#«r¤uaxQþ?ØV\³Vú9\\t·$ûz¸aQÛ^|\\t\FÿÏTkÜ\\tÛp\\tJß¨ ¹\\bÙ}O¨Bë²'
    //   11: dup
    //   12: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zsmn.a : [Ljava/lang/String;
    //   132: bipush #25
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zsmn.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   495: putstatic burp/Zsmn.Zq : Ljava/lang/Object;
    //   498: sipush #23998
    //   501: sipush #4725
    //   504: invokestatic a : (II)Ljava/lang/String;
    //   507: putstatic burp/Zsmn.Zo : Ljava/lang/String;
    //   510: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zsmn.class
