...
class Zr0g extends ClassLoader {
  static Object Zj;
  ...
  static void Ze(Object paramObject) {
    Zrdy.ZO = a(-7720, 20700);
    Zrdy.Zt = new BigInteger(a(-7719, 23230));
    boolean bool = Zt2e.ZK();
    try {
      try {
        if (Zg_p.ZO.charAt(Math.abs(((BigInteger)Zrbp.Z_).intValue() % 32)) > Zm__.Zf.charAt(Math.abs(((BigInteger)Zsde.Zx).intValue() % 32))) {
          try {
            Zzai.Zs(Class.forName(a(-7716, 16357)));
            if (bool)
              Zrm4.ZW(Class.forName(a(-7718, 5148))); 
  ...
  static boolean Zm(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   11: astore_3
    //   12: getstatic burp/Zr0g.Zf : Ljava/lang/String;
    //   15: astore #4
    //   17: iconst_0
    //   18: istore #5
    //   20: iload #5
    ...
    //   61: astore #5
    //   63: getstatic burp/Zrbp.Z_ : Ljava/lang/Object;
    ...
    //   2521: putstatic burp/Zb3z.ZR : Ljava/lang/Object;
    //   2524: sipush #-15245
    ...
    //   2849: athrow
    //   2850: getstatic burp/Zd1.ZN : Ljava/lang/String;
    //   2853: getstatic burp/Zshq.ZK : Ljava/lang/Object;
    ...
    //   2871: getstatic burp/Zx4l.Zy : Ljava/lang/String;
    //   2874: getstatic burp/Zl88.ZK : Ljava/lang/Object;
    ...
    //   2892: if_icmpgt -> 2999
    //   2895: getstatic burp/Zbp.Z_ : Ljava/lang/String;
    //   2898: getstatic burp/Zter.Zc : Ljava/lang/Object;
    ...
    //   2916: getstatic burp/Zl2q.ZI : Ljava/lang/String;
    //   2919: getstatic burp/Zg7p.Zb : Ljava/lang/Object;
    ...
    //   2946: athrow
    //   2947: getstatic burp/Zl2q.ZI : Ljava/lang/String;
    //   2950: getstatic burp/Zbsr.ZD : Ljava/lang/Object;
    ...
    //   2968: getstatic burp/Zzai.Zy : Ljava/lang/String;
    //   2971: getstatic burp/Zkfz.Zr : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '\\b-é¢Ü$íõM+²=WyÇ0þQJçU³IzS!+½Û½_üÈ_l,ª\\t-ô\\tvzü#@1,i\\tXnÿÀT\\tßàQpõ[$\\t;pÑ8ÛM­ÅBtg4ý§Îí,ÙµßÌ"¯ìÂ\\neº<HÆ.Æn3öÿîl­Xú´¬aÝqÅ^ª¼ð-írdª9+qK?¬éb ª¥`äX6Ïzà2¢ýµ¿$¾ýNèä}ÿ(¢ã4?ü'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc '挖矖澡わ枪ﻡꬆ쪑쥱﨓䝁괌ꊏ鰀物랹鍹㘇㑻熤ㅰк⌷ᠦԡ߹耍닀ঊⰑᬪ媰募홥⧮⾠卛‗녨樾뺮䩴壌큂꨿䌕㎒䔕ɕ傐齴兡䂾鈒㣶벗?ႋ쵿፶彟䓥쓡纒摙ᦹ怨作⋓邌䘝롷?ௗ㨝䤨⑒쉻곽鄧㞻贪乵汾斃깧뫵┭ᰄ뒊瓺䯽诡灭뗪䡕慖垊虐ᶧ颪楆蹘魹蜬칁⣥豴觡뽗䊵䆁ⴺ낥뮽捍眼濼モ朁﹌ꭳ쨤짟瘟䞔귚ꈵ鳚爾럢鎓㙬㐖焉ㄅҏ⎙ᢐ״ܯ肷늗৑⳻ᭁ嫭劲훎⥃⿕叮¥₡놽櫨블䪮墛퀙꫕䍾㏏䕸˾倽鼁凔䀐銤㠣뱁?ၑ촤᎜弴䒸쒌縹擴᧌悝俲≥遙䛋룍?஀㫷䥃␏숖걖醊㜕趜亠沨教기몮◇ᱯ듗瑑䭐讔烘땄䣣憀地蚊ᷰ顀椭踅鬔螇컬⢐賁襏뿡䉠䅗ⶀ끿믪'
    //   70: dup
    //   71: astore_2
    ...
    //   125: goto -> 83
    //   128: aload #5
    //   130: putstatic burp/Zr0g.a : [Ljava/lang/String;
    //   133: bipush #11
    //   135: anewarray java/lang/String
    //   138: putstatic burp/Zr0g.b : [Ljava/lang/String;
    //   141: goto -> 300
    //   144: dup_x2
    //   145: pop
    ...
    //   498: putstatic burp/Zr0g.Zj : Ljava/lang/Object;
    //   501: sipush #-7713
    //   504: sipush #-32421
    //   507: invokestatic a : (II)Ljava/lang/String;
    //   510: putstatic burp/Zr0g.Zf : Ljava/lang/String;
    //   513: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFE1DF) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zr0g.class
