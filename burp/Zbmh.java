...
public class Zbmh extends Zbv5 implements Zedo, Zt3u {
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'ÞåóZ¦÷WeIR£´*p­cMIèA´F\\tõ.@¶9ág#<YZ¯b@À¼&£^ÂFBôÖAo6eF8VÖÓ0 ´ýQáÞÓï!9>5öQïT»y±hT#Æ70ª8a})!I¼Ð0³\\tVÉ¹\\fp¬¸\\fÿÃzí«í*Û(d÷nëo-ï>¨ñXÜÓuÛ7/¬\\r¥IÅÚÆKTR¼´|¸í\\n5Ñ1¹÷ßÿÖ¡R±ë'ø¨r¥ZêcuHL'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc '$Tz¶å×¿c3mB^æ-ºó z]Ó&4Æÿ\\bk3}du+¼ãy$UOz²l¦¡y<Ë¦ÎÚ¼;4gfîÐY^Í­éUôÓú¬]ø»&§ÍÇÄ6×Z¡ÄÝ5³Pø¿ø¹âo»ÜRh`cåtH»°þ±,ÉÖHÈÑ'
    //   70: dup
    //   71: astore_2
