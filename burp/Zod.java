...
class Zod extends ClassLoader {
  ...
  static boolean ZG(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   1015: iconst_0
    //   1016: istore_3
    //   1017: getstatic burp/Zb2s.Zq : Ljava/lang/String;
    //   1020: getstatic burp/Zm0s.Zl : Ljava/lang/Object;
    ...
    //   1038: getstatic burp/Zg7p.ZA : Ljava/lang/String;
    //   1041: getstatic burp/Ze3j.Ze : Ljava/lang/Object;
    ...
    //   1745: iload_3
    //   1746: ireturn
    //   1747: getstatic burp/Zz1k.ZC : Ljava/lang/String;
    //   1750: getstatic burp/Zr0u.ZB : Ljava/lang/Object;
    ...
    //   1768: getstatic burp/Zbo7.ZZ : Ljava/lang/String;
    //   1771: getstatic burp/Zkmx.Zu : Ljava/lang/Object;
    ...
    //   2476: iload_3
    //   2477: ireturn
    //   2478: getstatic burp/Zl_k.Zw : Ljava/lang/String;
    //   2481: getstatic burp/Zzqj.Zq : Ljava/lang/Object;
    ...
    //   2499: getstatic burp/Zt4g.Zj : Ljava/lang/String;
    //   2502: getstatic burp/Zt3l.Zq : Ljava/lang/Object;
    ...
    //   3207: iload_3
    //   3208: ireturn
    //   3209: getstatic burp/Zd1.ZN : Ljava/lang/String;
    //   3212: getstatic burp/Zk8b.ZK : Ljava/lang/Object;
    ...
    //   3230: getstatic burp/Zsgl.ZG : Ljava/lang/String;
    //   3233: getstatic burp/Zxyp.ZZ : Ljava/lang/Object;
  ...
  static void Zr(Object paramObject) {
    Zkmx.Zg = a(25862, 27211);
    Zkmx.Zu = new BigInteger(a(25871, 14014));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zt4g.Zj.charAt(Math.abs(((BigInteger)Zxfu.ZA).intValue() % 32)) > Zl_k.Zw.charAt(Math.abs(((BigInteger)Zl_k.ZH).intValue() % 32))) {
          try {
            Zlv6.Zf(Class.forName(a(25870, 7512)));
            if (!bool)
              Zrvb.ZH(Class.forName(a(25860, 18697))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '»×ãõïÁo{Ö½mñÚØ|ÂÜ`WÅ(Îi"z®FÓ¯E#\\t[nô¼¦\\tîQôoKX®\\tÚì¤Hæ÷s\\t¸®N6´±b}\\tirtqÇIMw\\tHØPÅõmÎ\\f5MºcÖüñê@\\n³aÝcb¼X("ã5=æ}1ÜB8ÄóMÅÝQõ_NòÐÐÈØmÀN4ÉåÈ\\nþôPl÷¹ªÊ¯\\t@ÊÖ¦µO9\\tÝ© /\\nF5Û\\tM<ðYáþE+b Èðü]í}=Ô yÛwU.1ÄaJDM0t× f[Wt¨Ê·RÎPÄÊæúLxâ:SòÆ¨\\tZ««½ ÀàS\\bÉe`róÍ\\t¹unp2Û!Õ{\\tbV]WÄT×\\t¯ô¬@jÝ C\\bÆüAÏý¹|nQ\\tIðpÀñÍ_r\\t­ßì%bq+:\\b9V~0WvT\\tejr²;t'
    //   11: dup
    //   12: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zod.a : [Ljava/lang/String;
    //   132: bipush #28
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zod.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zod.ZS : Ljava/lang/String;
    ...
    //   507: putstatic burp/Zod.ZP : Ljava/lang/Object;
    //   510: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zod.class
