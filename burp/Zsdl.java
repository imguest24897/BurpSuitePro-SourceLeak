...
class Zsdl extends ClassLoader {
  static String ZJ;
  ...
  static boolean Zi(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   577: putstatic burp/Ztl6.ZQ : Ljava/lang/Object;
    //   580: sipush #-14913
    ...
    //   905: athrow
    //   906: getstatic burp/Zlgh.Zm : Ljava/lang/String;
    //   909: getstatic burp/Zmf2.Zx : Ljava/lang/Object;
    ...
    //   927: getstatic burp/Zlcc.Zw : Ljava/lang/String;
    //   930: getstatic burp/Zvh.Zb : Ljava/lang/Object;
    ...
    //   948: if_icmpgt -> 1055
    //   951: getstatic burp/Zvh.ZP : Ljava/lang/String;
    //   954: getstatic burp/Zz3b.Zu : Ljava/lang/Object;
    ...
    //   972: getstatic burp/Ztwp.ZK : Ljava/lang/String;
    //   975: getstatic burp/Zz4a.ZB : Ljava/lang/Object;
    ...
    //   1002: athrow
    //   1003: getstatic burp/Zsfg.Zh : Ljava/lang/String;
    //   1006: getstatic burp/Zlg2.ZO : Ljava/lang/Object;
    ...
    //   1024: getstatic burp/Zedu.ZD : Ljava/lang/String;
    //   1027: getstatic burp/Zm7v.ZP : Ljava/lang/Object;
  ...
  static void Zl(Object paramObject) {
    Zvob.Zn = a(-21258, -27583);
    Zvob.ZX = new BigInteger(a(-21262, 13710));
    boolean bool = Zt2e.ZK();
    try {
      try {
        if (Zxcn.ZF.charAt(Math.abs(((BigInteger)Zkf6.ZS).intValue() % 32)) > Zz66.ZM.charAt(Math.abs(((BigInteger)Zb3l.Zl).intValue() % 32))) {
          try {
            Zbo7.Zv(Class.forName(a(-21249, -10323)));
            if (bool)
              Zsn3.ZE(Class.forName(a(-21261, 21673))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '¨EkIÈ¡[&¨$áÂ¿ÙXÏ!ËÕrx·`¾võ *íwIäK?g3_Jw*Ò$ÙÄúAñÐ/A¹³µ£1\\b= ±i¶â\\t69°1°`UM}ÑÝÓòQûSe(Ì9:\\tcz\\nãä2Ñ èàßú76m½!ÿÖì¦ãÕ>üüôW ¿ûO=¬®³7(\\r'Ìæ`ù°x0MPïî÷w`ÿkªqBÌïÿY²8Ø\\f}Dþ9â±vmM\\rO©ÂEym¨WKë¥]È}, iA,oqFMÀ@'§ka¸'
    //   11: dup
    //   12: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zsdl.a : [Ljava/lang/String;
    //   132: bipush #9
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zsdl.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zsdl.ZJ : Ljava/lang/String;
    ...
    //   328: putstatic burp/Zsdl.Zx : Ljava/lang/Object;
    //   331: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFACF7) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zsdl.class
