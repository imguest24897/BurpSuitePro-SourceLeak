...
class Zs9u extends ClassLoader {
  static String ZM;
  ...
  static boolean ZW(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   11: astore_3
    //   12: getstatic burp/Zkul.ZJ : Ljava/lang/String;
    //   15: astore #4
    //   17: iconst_0
    //   18: istore #5
    //   20: iload #5
    ...
    //   61: astore #5
    //   63: getstatic burp/Zezz.Zu : Ljava/lang/Object;
    ...
    //   2521: putstatic burp/Zxd0.Za : Ljava/lang/Object;
    //   2524: sipush #12907
    ...
    //   2850: iconst_0
    //   2851: istore_3
    //   2852: getstatic burp/Zmhx.ZD : Ljava/lang/String;
    //   2855: getstatic burp/Zs59.Zw : Ljava/lang/Object;
    ...
    //   2873: getstatic burp/Zlno.ZM : Ljava/lang/String;
    //   2876: getstatic burp/Zmjr.ZU : Ljava/lang/Object;
    ...
    //   3580: iload_3
    //   3581: ireturn
    //   3582: getstatic burp/Zkvr.Zm : Ljava/lang/String;
    //   3585: getstatic burp/Zz58.ZD : Ljava/lang/Object;
    ...
    //   3603: getstatic burp/Zxsb.Zh : Ljava/lang/String;
    //   3606: getstatic burp/Zlyf.Zm : Ljava/lang/Object;
    ...
    //   4311: iload_3
    //   4312: ireturn
    //   4313: getstatic burp/Zezz.Zi : Ljava/lang/String;
    //   4316: getstatic burp/Zejg.ZR : Ljava/lang/Object;
    ...
    //   4334: getstatic burp/Zmjr.Zc : Ljava/lang/String;
    //   4337: getstatic burp/Zxsb.ZN : Ljava/lang/Object;
    ...
    //   5042: iload_3
    //   5043: ireturn
    //   5044: getstatic burp/Zei_.ZZ : Ljava/lang/String;
    //   5047: getstatic burp/Zzc7.ZG : Ljava/lang/Object;
    ...
    //   5065: getstatic burp/Zr3x.ZM : Ljava/lang/String;
    //   5068: getstatic burp/Zb3p.Zx : Ljava/lang/Object;
  ...
  static void ZJ(Object paramObject) {
    Zebj.ZF = a(17212, -29101);
    Zebj.Zf = new BigInteger(a(17194, -5616));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zty3.ZW.charAt(Math.abs(((BigInteger)Zs59.Zw).intValue() % 32)) <= Zr3x.ZM.charAt(Math.abs(((BigInteger)Zzc7.ZG).intValue() % 32))) {
          try {
            Zeyt.Zo(Class.forName(a(17196, -30481)));
            if (!bool)
              Zel.ZX(Class.forName(a(17215, -922))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'O\\f)8ðfí^\\tYú×C&v®Àâä\\tuãR¼óB¾s\\tÐJÏ(\\fÊMd¡k¼£ û~ò¢jøhó@,Vî°×àFé\\f)Ú·Æç:/7Æ¿}.'p/î¨öïo¤êExJ£»R©}Ò³p\\t2Yºëî¨£®E\\tÌ+e¥aÛ¡ "Þú:õú¨;ß5þ$Á­`Ï7¨(¾×)ÙÑÀM\\t,êyf¤{¯\\tªê©fç?Ç\\tã¸×©/VI\\tSÂkÆvX\\teÔPZ³)k\\tG¶;~B\\tã]k©¸B±P\\t<GH=~ò¾5ñÀt¶9^Ñ/ØHk¾V挥矷潄〿术ﻡ꬏쩞즄飼䜙괲ꊒ鱾爅랢錵㚂㓝熿ㅑҘ⏵ᡋկ߭耋닁দⰈ᮹娪剢훢⦘⾶厬ß⁐넽樂뻅䨕墘큸ꨌ䎝㌠䗅˥傳齴冼䁱鉽㣎벜?ჼ쵞፭徺䑠쑤縴摐ᦢ惝俾⊋郡䘀롣?஁㨱䦘Ⓛ싔걀鄆㝌赤串汸斂긆뫬┗Პ됂琪䯫诂点딷䠀愽垁蘄᷐颋槴躽鯉螩칁⣬費褔뽯䋭䆿ⴧ냛믑 Ò)Ø\\rÝÛ®òñ_U¶[G¥?W¦bá5s\\t+ï¥DaþÛ¹¥`HÌ\\tÌ¾e7ËSé掖睊濳ヱ柙︸ꯑ쩥쥟社䝢귞ꋽ鳣狨뜑鎈㛴㐓煦㆏ң⌮ᠬԔ܁聤눬कⲵᯏ媝劬혔⥁⽨厗‷녆櫮뺪䪈塵탋ꪱ䏫㎗䔋ȓ偪龪冇䂪鈚㢵뱰?ၡ췭Ꮠ忌䓗쒪绂撉᥼惦伥⋬邚䛬렌?୬㪌䧮⑶숚겶釟㞗贃义沔攟껫멟▪᳨뒵瓜䬲謜炂뗬䡧懑埮蚙ᴽ頶概踊鬇蝟캘⠲貀觏뼈䊖䅓ⵈ끆물\\t¬q,ûóE\\t©ïÉ=rsâµ'
    //   11: dup
    //   12: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zs9u.a : [Ljava/lang/String;
    //   132: bipush #28
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zs9u.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zs9u.ZM : Ljava/lang/String;
    ...
    //   510: putstatic burp/Zs9u.Zd : Ljava/lang/Object;
    //   513: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zs9u.class
