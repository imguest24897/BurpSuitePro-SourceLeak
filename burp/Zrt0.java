...
public class Zrt0 {
  ...
  public static String Zm(EnumSet<Zklf> paramEnumSet) {
    StringBuilder stringBuilder = new StringBuilder();
    Iterator<Zklf> iterator = paramEnumSet.iterator();
    int[] arrayOfInt = Zk8m.ZO();
    while (iterator.hasNext()) {
      Zklf zklf = iterator.next();
      stringBuilder.append(zklf.Zf());
  ...
  public static EnumSet<Zklf> Zg(String paramString) {
    // Byte code:
    //   0: invokestatic ZO : ()[I
    //   3: astore_1
    //   4: ldc burp/Zklf
    //   6: invokestatic noneOf : (Ljava/lang/Class;)Ljava/util/EnumSet;
    //   9: astore_2
    //   10: aload_0
    //   11: ifnonnull -> 16
    //   14: aload_2
    ...
    //   62: ifeq -> 77
    //   65: aload_2
    //   66: getstatic burp/Zklf.CHROME : Lburp/Zklf;
    ...
    //   91: ifeq -> 106
    //   94: aload_2
    //   95: getstatic burp/Zklf.FIREFOX : Lburp/Zklf;
    ...
    //   120: ifeq -> 135
    //   123: aload_2
    //   124: getstatic burp/Zklf.OPERA : Lburp/Zklf;
    ...
    //   149: ifeq -> 164
    //   152: aload_2
    //   153: getstatic burp/Zklf.IE11 : Lburp/Zklf;
    ...
    //   178: ifeq -> 193
    //   181: aload_2
    //   182: getstatic burp/Zklf.IE11_COMPATIBILITY_MODE : Lburp/Zklf;
    ...
    //   207: ifeq -> 222
    //   210: aload_2
    //   211: getstatic burp/Zklf.SAFARI : Lburp/Zklf;
    ...
    //   236: ifeq -> 247
    //   239: aload_2
    //   240: getstatic burp/Zklf.EDGE : Lburp/Zklf;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'êÓk%ºÖrÄg2ÁLå)F]ñÞd²sP ÅRg¦b¹ôJ¾dT"&©;Yã£Q¾â{ê½VhôþÑ=f6¿*'
    //   11: dup
    //   12: astore_2
    ...
    //   123: goto -> 81
    //   126: aload #5
    //   128: putstatic burp/Zrt0.a : [Ljava/lang/String;
    //   131: bipush #7
    //   133: anewarray java/lang/String
    //   136: putstatic burp/Zrt0.b : [Ljava/lang/String;
    //   139: goto -> 300
    //   142: dup_x2
    //   143: pop
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zrt0.class
