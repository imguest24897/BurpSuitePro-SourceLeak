...
class Zsi2 extends ClassLoader {
  ...
  private static boolean ZJ(String paramString) {
    if (!paramString.startsWith(a(-6958, 6941)))
      return false; 
    if (paramString.startsWith(a(-6957, 4517)))
      return false; 
    paramString = paramString.substring(5);
    return !Zt05.Zm.contains(paramString);
  }
  ...
  static {
    ...
    //   63: goto -> 21
    //   66: aload #5
    //   68: putstatic burp/Zsi2.a : [Ljava/lang/String;
    //   71: iconst_2
    //   72: anewarray java/lang/String
    //   75: putstatic burp/Zsi2.b : [Ljava/lang/String;
    //   78: goto -> 227
    //   81: dup_x2
    //   82: pop
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFE4D2) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zsi2.class
