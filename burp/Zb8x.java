...
class Zb8x extends ClassLoader {
  static String Zp;
  ...
  static boolean ZD(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   11: astore_3
    //   12: getstatic burp/Ztgt.ZQ : Ljava/lang/String;
    //   15: astore #4
    //   17: iconst_0
    //   18: istore #5
    //   20: iload #5
    ...
    //   61: astore #5
    //   63: getstatic burp/Ztvn.Zl : Ljava/lang/Object;
    ...
    //   2521: putstatic burp/Zrug.Zp : Ljava/lang/Object;
    //   2524: sipush #20990
    //   2527: getstatic burp/Zkw.ZY : Ljava/lang/Object;
    //   2530: checkcast java/math/BigInteger
    //   2533: getstatic burp/Zb9d.Ze : Ljava/lang/Object;
    //   2536: checkcast java/math/BigInteger
    //   2539: invokevirtual add : (Ljava/math/BigInteger;)Ljava/math/BigInteger;
    //   2542: putstatic burp/Zz5h.ZD : Ljava/lang/Object;
    ...
    //   2867: athrow
    //   2868: getstatic burp/Zr_z.ZE : Ljava/lang/String;
    //   2871: getstatic burp/Zk7b.ZR : Ljava/lang/Object;
    ...
    //   2889: getstatic burp/Zvof.ZR : Ljava/lang/String;
    //   2892: getstatic burp/Zgil.ZG : Ljava/lang/Object;
    ...
    //   2910: if_icmpgt -> 3017
    //   2913: getstatic burp/Zmcb.Zl : Ljava/lang/String;
    //   2916: getstatic burp/Zzx8.Zi : Ljava/lang/Object;
    ...
    //   2934: getstatic burp/Zbu6.ZQ : Ljava/lang/String;
    //   2937: getstatic burp/Zgil.ZG : Ljava/lang/Object;
    ...
    //   2964: athrow
    //   2965: getstatic burp/Zgb9.Zk : Ljava/lang/String;
    //   2968: getstatic burp/Zmwx.Zk : Ljava/lang/Object;
    ...
    //   2986: getstatic burp/Ztvn.ZU : Ljava/lang/String;
    //   2989: getstatic burp/Zvof.Zl : Ljava/lang/Object;
  ...
  static void ZK(Object paramObject) {
    Ztvn.ZU = a(-1196, -26883);
    Ztvn.Zl = new BigInteger(a(-1187, -24315));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zzuh.ZX.charAt(Math.abs(((BigInteger)Ztvn.Zl).intValue() % 32)) <= Zvof.ZR.charAt(Math.abs(((BigInteger)Zgx6.Zo).intValue() % 32))) {
          try {
            Zl8l.ZO(Class.forName(a(-1194, -6931)));
            if (!bool)
              Zezz.ZO(Class.forName(a(-1195, -11216))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'ÏP4þ1\\fj1okø[òtwwí5\~Ø¸3©®oÅñÊ½ð"MÞðjXî£O6À»Ê\\tÒ¸[V<_Èì³ÚÌ&Ì+C#'}M> Ïà-ÄíDrRÖAx×õ±3µ¼¨{ÇÆº\\r¡~úG{W7$¸aXûæãV\\rÁÚ¹âa MG&9~x)¶Å"D;& Pj9^`Â§ªpëÎ´ðËxG/Q±]ü"®"í揷眂漄サ枎ﺫꭶ쩾쥢𣏕䜽귄ꈍ鳭犟뜙鎘㘍㐷熋ㅁӠ⌏ᣭԫݴ胪눃ँ⳹᭖婙勶홅⧴⾺厈Eₙ넇櫲빼䫳堆킿ꪒ䌌㌺䔉ɞ傃鼘凷䂕鋝㢬뱰?ၺ췧᎚彳䑦쓴绯搏ᦰ惿佂∷郟䚌룩?ଙ㫚䤍⒧숫곥鄰㞬趸乣沊攢꺂멑▜ᱤ됚瓗䯁诔烧떸䢢憗坾蛸ᴴ顾楧軽魃蜈츋⢕貛觲뾕䋉䅉ⶸ끈뭋\\t¬ý ULÙ3ô揺睩潩め朣︭ꯃ쪮짔頋䟫궇ꋗ鲅狄뜔鏳㚬㐃焍ㇴа⎹᣷׽ܷ耰뉘ऌⲒ᯷娴勂훨⥲⼏単ó₃뇑檱뺦䪛塝킲꫹䎭㍗䔽˳倅龭儧䀣鋇㡺밳?ဒ췪Ᏹ忒䐋쓀繂撉ᤅ怯俴∭选䛏렳?ୂ㪱䦬Ⓤ숟걈醶㜚趢亵泉敊껙멜◷᳅둷瑺䭇譡瀷딎䢸懔垤蚐ᵯ頕槆躐魷螥캍⠠豋襄뾏䈟䄊ⵢ뀠묐y(wÛ!*Ç¹(ÕÓCq-.Ü\\t_Þ,ù Ë\\tâ$iºl+æ ÏæÈ*É³mBfy-QöØÒ) ªc'
    //   11: dup
    //   12: astore_2
    ...
    //   123: goto -> 81
    //   126: aload #5
    //   128: putstatic burp/Zb8x.a : [Ljava/lang/String;
    //   131: bipush #12
    //   133: anewarray java/lang/String
    //   136: putstatic burp/Zb8x.b : [Ljava/lang/String;
    //   139: goto -> 300
    //   142: dup_x2
    //   143: pop
    ...
    //   309: putstatic burp/Zb8x.Zp : Ljava/lang/String;
    ...
    //   328: putstatic burp/Zb8x.Zz : Ljava/lang/Object;
    //   331: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFFB5D) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zb8x.class
