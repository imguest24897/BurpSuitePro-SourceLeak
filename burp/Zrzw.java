...
class Zrzw {
  ...
  void Zf(List<String> paramList) {
    ZD(paramList);
  }
  
  String ZD(List<String> paramList) {
    this.Zm = ZB(paramList);
    this.Zq = this.Zm.ZZ;
    return this.Zm.Zh;
  }
  ...
  String Z_() {
    return this.Zq.isEmpty() ? Zrgs.NO_SEED_URLS_SPECIFIED.ZN(new Object[0]) : (this.Zm.Zh() ? this.Zm.Zh : "");
  }
  
  List<String> ZG() {
    return Zgvb.ZX(this.Zq, this.ZK);
  }
  
  private Zeln ZB(List<String> paramList) {
    // Byte code:
    ...
    //   104: aload #6
    //   106: aload_0
    //   107: getfield ZS : Lburp/Zbnt;
    //   110: invokespecial <init> : (Ljava/lang/String;Lburp/Zbnt;)V
    //   113: astore #7
    //   115: aload #7
    //   117: invokevirtual ZW : ()Z
    //   120: ifeq -> 139
    //   123: aload_3
    //   124: aload #7
    //   126: invokevirtual Zo : ()Ljava/lang/String;
    ...
    //   139: aload_3
    //   140: aload #7
    //   142: invokevirtual Zo : ()Ljava/lang/String;
    //   145: sipush #-1466
    //   148: sipush #-15903
    ...
    //   165: pop
    //   166: getstatic burp/Zrgs.INVALID_SEED_URL : Lburp/Zrgs;
    //   169: iconst_0
    //   170: anewarray java/lang/Object
    //   173: invokevirtual ZN : ([Ljava/lang/Object;)Ljava/lang/String;
    //   176: astore #4
    //   178: aload_2
    //   179: ifnonnull -> 24
    //   182: new burp/Zeln
    ...
    //   186: aload_3
    //   187: aload #4
    //   189: invokespecial <init> : (Ljava/util/List;Ljava/lang/String;)V
    //   192: areturn
  }
  ...
  static {
    ...
    //   63: goto -> 21
    //   66: aload #5
    //   68: putstatic burp/Zrzw.a : [Ljava/lang/String;
    //   71: iconst_2
    //   72: anewarray java/lang/String
    //   75: putstatic burp/Zrzw.b : [Ljava/lang/String;
    //   78: goto -> 227
    //   81: dup_x2
    //   82: pop
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFFA47) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zrzw.class
