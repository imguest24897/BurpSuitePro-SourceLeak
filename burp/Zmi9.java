...
public class Zmi9 implements Ze0c {
  ...
  public Zmi9(Zbnt paramZbnt) {
    this.ZS = paramZbnt;
  }
  
  public void ZE(Zlit paramZlit, Zs68 paramZs68, byte[] paramArrayOfbyte, Zm4 paramZm4) {
    if (ZA(paramZlit))
      Zz(this.ZS, paramZlit, paramZs68, paramArrayOfbyte, paramZm4); 
  }
  
  public static void Zz(Zbnt paramZbnt, Zlit paramZlit, Zs68 paramZs68, byte[] paramArrayOfbyte, Zm4 paramZm4) {
    // Byte code:
    //   0: invokestatic ZK : ()Z
    //   3: istore #5
    ...
    //   25: getfield Zk : I
    //   28: isub
    //   29: invokespecial <init> : ([BII)V
    //   32: invokespecial <init> : (Ljava/io/InputStream;)V
    //   35: invokespecial <init> : (Ljava/io/Reader;)V
    //   38: astore #6
    //   40: aconst_null
    //   41: aload #6
    ...
    //   225: iconst_0
    //   226: iload #10
    //   228: invokevirtual substring : (II)Ljava/lang/String;
    ...
    //   240: aload #7
    //   242: aload #4
    //   244: invokestatic Zl : (Lburp/Zbnt;BLburp/Zlit;Ljava/lang/String;Lburp/Zm4;)V
    //   247: aload #7
    //   249: ldc '/'
    ...
    //   273: aload_1
    //   274: aload #7
    //   276: <illegal opcode> makeConcatWithConstants : (Ljava/lang/String;)Ljava/lang/String;
    //   281: aload #4
    //   283: invokestatic Zl : (Lburp/Zbnt;BLburp/Zlit;Ljava/lang/String;Lburp/Zm4;)V
    //   286: goto -> 293
    ...
    //   306: astore #7
    //   308: aload #7
    //   310: getstatic net/portswigger/Zk_.UNEXPECTED : Lnet/portswigger/Zk_;
    //   313: invokestatic Zl : (Ljava/lang/Throwable;Lnet/portswigger/Zk_;)V
    //   316: return
    // Exception table:
    //   from	to	target	type
    //   40	303	306	java/lang/Exception
    //   124	146	149	java/lang/Exception
    //   165	187	190	java/lang/Exception
    //   236	263	266	java/lang/Exception
    //   257	286	289	java/lang/Exception
  }
  
  private static void Zl(Zbnt paramZbnt, byte paramByte, Zlit paramZlit, String paramString, Zm4 paramZm4) {
    Zlit zlit = Zry3.ZL(paramString, paramZlit, paramZbnt);
    if (zlit != null && !zlit.Zdw().contains("*")) {
      Zsq8 zsq8 = new Zsq8(paramByte, zlit, Zry3.ZK(paramString), null, null, (short)0, -1, -1);
      paramZm4.Zt(zsq8);
    } 
  }
  
  public static boolean ZA(Zlit paramZlit) {
    return Zkb.ZG(paramZlit.ZdH()).equalsIgnoreCase(a(-6765, 6841));
  }
  ...
  static {
    ...
    //   123: goto -> 81
    //   126: aload #5
    //   128: putstatic burp/Zmi9.a : [Ljava/lang/String;
    //   131: iconst_4
    //   132: anewarray java/lang/String
    //   135: putstatic burp/Zmi9.b : [Ljava/lang/String;
    //   138: goto -> 300
    //   141: dup_x2
    //   142: pop
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFE592) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zmi9.class
