...
class Zrne {
  ...
  Zrne(String paramString) {
    this.Zl = ZH(paramString);
  }
    ...
    if (paramString != null) {
      ...
      while (b < i) {
        ...
        if (arrayOfString3.length > 1) {
          String str1 = Zi(arrayOfString3[0]);
          if (str1 != null) {
            byte b1 = 1;
            while (b1 < arrayOfString3.length) {
              if (ZM(arrayOfString3[b1]))
                return str1; 
              b1++;
  ...
  private String Zi(String paramString) {
    ...
    return (str.startsWith("<") && str.endsWith(">")) ? str.substring(1, str.length() - 1) : null;
  }
  ...
  private boolean ZM(String paramString) {
    ...
    if (str.startsWith("\"") && str.endsWith("\"")) {
      if (Zc(str))
        return true; 
    } else if (a(-28313, 1463).equals(str)) {
      return true;
    } 
    return false;
  }
  
  private String ZV(String paramString) {
    String[] arrayOfString = paramString.trim().split("=");
    return (arrayOfString.length >= 2 && a(-28314, -31316).equals(arrayOfString[0])) ? arrayOfString[1] : null;
  }
  
  private boolean Zc(String paramString) {
    paramString = paramString.substring(1, paramString.length() - 1);
    String[] arrayOfString2 = paramString.split(a(-28315, -26119));
    String[] arrayOfString3 = arrayOfString2;
    int i = arrayOfString3.length;
    String[] arrayOfString1 = Zeun.ZG();
    byte b = 0;
    while (b < i) {
      String str = arrayOfString3[b];
      if (a(-28316, 3431).equals(str))
        return true; 
      b++;
  ...
  static {
    ...
    //   122: goto -> 80
    //   125: aload #5
    //   127: putstatic burp/Zrne.a : [Ljava/lang/String;
    //   130: iconst_4
    //   131: anewarray java/lang/String
    //   134: putstatic burp/Zrne.b : [Ljava/lang/String;
    //   137: goto -> 296
    //   140: dup_x2
    //   141: pop
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFF9164) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zrne.class
