...
public class Zl46 extends Zl4o implements Zxgl {
  private final Zebs ZL;
  
  private final Zb5q ZW;
  
  private final Zgo8 Zg;
  
  private final Zgol ZF;
  
  private final Ze2h ZV;
  
  private Zmpu Zr = Zmpu.CANCEL_CONTINUE;
  
  private static final String[] c;
  
  private static final String[] d;
  
  public Zl46(String paramString, Zebs paramZebs, Zgo8 paramZgo8) {
    super(paramString, Zk97.DESKTOP_SCANNING_API_SCAN_LAUNCHER, paramZebs, true);
    this.ZL = paramZebs;
    this.Zg = paramZgo8;
    this.ZW = new Zb5q();
    this.ZF = new Zgol(paramZebs, Zz6x.SCAN_LAUNCHER);
    this.ZV = new Ze2h();
    setName(b(-22068, -25989));
    Zd(new Zx8l[] { this.ZW, paramZgo8, this.ZF });
  }
  ...
  public void Zk(List<String> paramList) {
    this.ZW.ZC(paramList);
  }
  ...
  public void Zz(int paramInt, Zkbn paramZkbn) {
    this.Zg.Zu(paramInt, paramZkbn);
  }
  
  public void Zw(Zmln... paramVarArgs) {
    this.Zg.ZX(paramVarArgs);
  }
  
  public void Zt(Zmln... paramVarArgs) {
    this.Zg.ZK(paramVarArgs);
  }
  ...
  protected void Zhi() {
    ...
    //   0: invokestatic Zu : ()[I
    //   3: astore_1
    //   4: getstatic burp/Zetq.ZJ : [I
    //   7: aload_0
    //   8: getfield Zr : Lburp/Zmpu;
    //   11: invokevirtual ordinal : ()I
    //   14: iaload
    //   15: tableswitch default -> 85, 1 -> 44, 2 -> 44, 3 -> 55, 4 -> 73
    //   44: aload_0
    //   45: getfield ZL : Lburp/Zebs;
    //   48: invokevirtual Za : ()V
    //   51: aload_1
    //   52: ifnull -> 85
    //   55: aload_0
    //   56: getfield ZL : Lburp/Zebs;
    //   59: invokevirtual ZW : ()Z
    //   62: ifeq -> 85
    //   65: aload_0
    ...
    //   70: ifnull -> 85
    //   73: aload_0
    //   74: getfield ZL : Lburp/Zebs;
    //   77: invokevirtual Zw : ()Z
    //   80: pop
    //   81: aload_0
  ...
  protected void ZhY() {
    ...
    //   49: ifnull -> 59
    //   52: aload_0
    //   53: getfield ZL : Lburp/Zebs;
    //   56: invokevirtual ZK : ()V
    //   59: return
  }
  
  public void ZX(Zmpu paramZmpu) {
    // Byte code:
    //   0: invokestatic Zu : ()[I
    //   3: astore_2
    //   4: getstatic burp/Zetq.ZJ : [I
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '±æHº¼\\rãÁnDü >ÿ@'\\bÙ.5ÁÒ¦\\b,ýñ =@Ý\\b8ñ\\t:UÙîv'
    //   11: dup
    //   12: astore_2
    ...
    //   123: goto -> 81
    //   126: aload #5
    //   128: putstatic burp/Zl46.c : [Ljava/lang/String;
    //   131: bipush #9
    //   133: anewarray java/lang/String
    //   136: putstatic burp/Zl46.d : [Ljava/lang/String;
    //   139: goto -> 300
    //   142: dup_x2
    //   143: pop
  ...
  private static String b(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFA9CB) & 0xFFFF;
    if (d[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zl46.class
