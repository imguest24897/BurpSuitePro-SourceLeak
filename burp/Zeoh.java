...
public class Zeoh implements Zl2h {
  private final Zgf3 Zs;
  
  private final Zeg4 Zl;
  
  private final Zkb3 ZQ;
  
  private final Zb_j ZZ;
  
  private final Zlok Zw;
  
  private final Ztou Zk;
  ...
  public Zeoh(Zgf3 paramZgf3, Zeg4 paramZeg4, Zkb3 paramZkb3, Zb_j paramZb_j, Zlok paramZlok, Ztou paramZtou, boolean paramBoolean) {
    this.Zs = paramZgf3;
    this.Zl = paramZeg4;
    this.ZQ = paramZkb3;
    this.ZZ = paramZb_j;
  ...
  public Zmot ZX(Ztj1 paramZtj1, Zlog paramZlog, Zlfb paramZlfb, Zskh paramZskh, Supplier<Zbs1> paramSupplier, Zl1k paramZl1k, Zsju paramZsju, Consumer<Zs4l<LoggerCaptureHttpRequestResponse, Boolean>> paramConsumer) {
    throw new UnsupportedOperationException(a(-14140, 4546));
  }
  ...
  public Zmor ZE(Ztj1 paramZtj1, Zr5h paramZr5h, Zlfb paramZlfb, Zskh paramZskh, Supplier<Zbs1> paramSupplier, Zl1k paramZl1k, Zsju paramZsju, Zlli<Zt1o> paramZlli, Consumer<Zs4l<LoggerCaptureHttpRequestResponse, Boolean>> paramConsumer) {
    throw new UnsupportedOperationException(a(-14139, 25916));
  }
  ...
  public Zmau Zu(Ztj1 paramZtj1, Zzys paramZzys, Zlfb paramZlfb, Supplier<Zbs1> paramSupplier) {
    Zmz1 zmz1 = paramZzys.ZNH();
    Zsh8 zsh8 = zmz1.ZeY();
    Zz1y zz1y = paramZzys.ZNJ();
    try {
    
    } catch (UnsupportedOperationException unsupportedOperationException) {
      throw a(null);
    } 
    Zbvw zbvw = new Zbvw(paramZlfb, paramZtj1, zz1y.Zf7(), this.Zl, this.ZW, !zsh8.ZPQ(), new Zb_x(zmz1.Zek(), zz1y));
    return new Zmau(this.Zs, this.Zw, this.ZQ, this.ZZ, paramZlfb, zbvw, this.Zk, paramZtj1.Zr());
  }
  ...
  static {
    ...
    //   6: iconst_0
    //   7: istore_3
    //   8: ldc '>y}6ÌJ¢ªYA¾;ÅÇ:ò#â¸l@\}G|[£RÄ³sÑ-!yQ,cæåÇ7á*¾§ç iÙS¿CÕ'®T»eâ\\fØO£¼Îº]]@ÚöbÊáÏ×ëJUõvÇgö \\rh<Æf.ê²¤½3Éq8ª ÀM{ t=på~»âì¨¿¼zðmQ`¶b9Ùkè4'
    //   10: dup
    //   11: astore_2
    ...
    //   64: goto -> 22
    //   67: aload #5
    //   69: putstatic burp/Zeoh.a : [Ljava/lang/String;
    //   72: iconst_2
    //   73: anewarray java/lang/String
    //   76: putstatic burp/Zeoh.b : [Ljava/lang/String;
    //   79: goto -> 227
    //   82: dup_x2
    //   83: pop
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFC8C4) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zeoh.class
