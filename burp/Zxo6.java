...
class Zxo6 extends ClassLoader {
  static String Z_;
  ...
  static boolean ZD(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   10: getstatic burp/Zkyc.ZD : Ljava/lang/Object;
    ...
    //   707: athrow
    //   708: getstatic burp/Zbp.Z_ : Ljava/lang/String;
    //   711: getstatic burp/Zxl5.Zh : Ljava/lang/Object;
    ...
    //   729: getstatic burp/Ze13.Zg : Ljava/lang/String;
    //   732: getstatic burp/Ze3d.Ze : Ljava/lang/Object;
    ...
    //   750: if_icmpgt -> 857
    //   753: getstatic burp/Ze13.Zg : Ljava/lang/String;
    //   756: getstatic burp/Zxyp.ZZ : Ljava/lang/Object;
    ...
    //   774: getstatic burp/Zes_.ZM : Ljava/lang/String;
    //   777: getstatic burp/Zsm3.ZC : Ljava/lang/Object;
    ...
    //   804: athrow
    //   805: getstatic burp/Zkbm.Zb : Ljava/lang/String;
    //   808: getstatic burp/Zkmx.Zu : Ljava/lang/Object;
    ...
    //   826: getstatic burp/Zr3q.ZM : Ljava/lang/String;
    //   829: getstatic burp/Zt3l.Zq : Ljava/lang/Object;
  ...
  static void Zg(Object paramObject) {
    Zr0g.Zf = a(-13799, -18693);
    Zr0g.Zj = new BigInteger(a(-13800, -10389));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zx54.Zs.charAt(Math.abs(((BigInteger)Zsxj.Zi).intValue() % 32)) <= Zl_u.Zc.charAt(Math.abs(((BigInteger)Zbsr.ZD).intValue() % 32))) {
          try {
            Zz1k.ZG(Class.forName(a(-13798, -10235)));
            if (!bool)
              Zgss.Zg(Class.forName(a(-13797, 1085))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '\\nì\\tá5m§È¦ç\\tW2ãZ}.öf0LÊªë¬¶Îe\\bZ,%ÇÜAêM~Cn0R¥àt¶ûÏ§¶e4Sb/åòI¬z%HõaO9gÝmv(iÐ?Eoj@\\tÖçvM(ª2MFâäÆ$Ä\\ru+(pe2¬Íkp`åÕäµf°f&tÐÈò¾Uf¹Hv¯À;VcÕ?èðÞXº`[\\t­¡|AÝ¡ Ióze)W®\\biÔý\\n§ÁÛ i\\tÛ§hBÔU\\tñ7Nç¬¥\\\f\\t9®.ÉÄ\Þm¢\\t^YÂ7YrÓ \\t¾ÞÚ´\\thà'
    //   11: dup
    //   12: astore_2
    ...
    //   63: istore_1
    //   64: goto -> 22
    //   67: ldc '\vûòÅáÜ®åÑ§¨c:w ª9Ú.(qÃPn\\n'
    //   69: dup
    //   70: astore_2
    ...
    //   123: goto -> 81
    //   126: aload #5
    //   128: putstatic burp/Zxo6.a : [Ljava/lang/String;
    //   131: bipush #12
    //   133: anewarray java/lang/String
    //   136: putstatic burp/Zxo6.b : [Ljava/lang/String;
    //   139: goto -> 300
    //   142: dup_x2
    //   143: pop
    ...
    //   309: putstatic burp/Zxo6.Z_ : Ljava/lang/String;
    ...
    //   328: putstatic burp/Zxo6.Zw : Ljava/lang/Object;
    //   331: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFCA1C) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zxo6.class
