...
class Zkcd extends ClassLoader {
  static String Zj;
  ...
  static void Zg(Object paramObject) {
    Zgvl.Zc = a(30427, 6494);
    Zgvl.ZK = new BigInteger(a(30429, -4070));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zs9k.Zx.charAt(Math.abs(((BigInteger)Zr9p.ZC).intValue() % 32)) > Zkaw.ZI.charAt(Math.abs(((BigInteger)Ze0w.ZU).intValue() % 32))) {
          try {
            Zkk6.ZW(Class.forName(a(30428, -14230)));
            if (!bool)
              Zs8s.ZO(Class.forName(a(30425, 10877))); 
  ...
  static boolean Zo(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   0: invokestatic ZN : ()Z
    //   3: istore_2
    //   4: getstatic burp/Zdm.ZA : Ljava/lang/Object;
    ...
    //   350: athrow
    //   351: getstatic burp/Zl3n.Zy : Ljava/lang/String;
    //   354: getstatic burp/Ze_b.Zp : Ljava/lang/Object;
    ...
    //   372: getstatic burp/Zl5b.Zi : Ljava/lang/String;
    //   375: getstatic burp/Zek5.ZP : Ljava/lang/Object;
    ...
    //   393: if_icmpgt -> 500
    //   396: getstatic burp/Zldx.Zm : Ljava/lang/String;
    //   399: getstatic burp/Zldx.ZM : Ljava/lang/Object;
    ...
    //   417: getstatic burp/Zgkp.ZS : Ljava/lang/String;
    //   420: getstatic burp/Zz3k.Zz : Ljava/lang/Object;
    ...
    //   447: athrow
    //   448: getstatic burp/Zr_y.Zb : Ljava/lang/String;
    //   451: getstatic burp/Zm84.Zf : Ljava/lang/Object;
    ...
    //   469: getstatic burp/Zete.ZH : Ljava/lang/String;
    //   472: getstatic burp/Zrm4.ZB : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'zr%Dw7Nk(Ád;ÌqfÇ\\fG7ajåúÜ\\nÎr½ ¨Û6OüCµ¨A÷÷æGqý8sÆÜ\\f\\tÅk\\rèÙ­Ô\\tîÄhuFo+Ð4\\tÂEí-ÅPJ­'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc 'nFÓ£LDÙO£i#:w¾ýBåi÷(*>´¾bHwóèÕî¹+Ê#js¹»g¥Ãg$úQ¬ÿ}ÉßiTª\\rÉ[(ó½g\\t·ý{yar8$'
    //   70: dup
    //   71: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zkcd.a : [Ljava/lang/String;
    //   132: bipush #8
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zkcd.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zkcd.Zj : Ljava/lang/String;
    ...
    //   508: putstatic burp/Zkcd.ZE : Ljava/lang/Object;
    //   511: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zkcd.class
