...
class Zty4 extends ClassLoader {
  static String Zu;
  ...
  static boolean Zm(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   0: invokestatic ZN : ()Z
    //   3: istore_2
    //   4: getstatic burp/Zz16.ZK : Ljava/lang/Object;
    //   7: checkcast java/math/BigInteger
    //   10: getstatic burp/Zcc.Zd : Ljava/lang/Object;
    //   13: checkcast java/math/BigInteger
    //   16: invokevirtual add : (Ljava/math/BigInteger;)Ljava/math/BigInteger;
    //   19: putstatic burp/Zsyu.Zj : Ljava/lang/Object;
    //   22: sipush #-18846
    //   25: getstatic burp/Zb6e.ZD : Ljava/lang/Object;
    //   28: checkcast java/math/BigInteger
    //   31: getstatic burp/Zvi.Zs : Ljava/lang/Object;
    //   34: checkcast java/math/BigInteger
    //   37: invokevirtual subtract : (Ljava/math/BigInteger;)Ljava/math/BigInteger;
    //   40: putstatic burp/Zsyu.Zj : Ljava/lang/Object;
    //   43: sipush #-2805
    ...
    //   368: athrow
    //   369: getstatic burp/Zlfi.Zg : Ljava/lang/String;
    //   372: getstatic burp/Ze08.ZJ : Ljava/lang/Object;
    ...
    //   390: getstatic burp/Zk5y.ZZ : Ljava/lang/String;
    //   393: getstatic burp/Zx_b.ZX : Ljava/lang/Object;
    ...
    //   411: if_icmpgt -> 526
    //   414: getstatic burp/Ze08.Zh : Ljava/lang/String;
    //   417: getstatic burp/Zxxd.Zn : Ljava/lang/Object;
    ...
    //   435: getstatic burp/Zty2.ZR : Ljava/lang/String;
    //   438: getstatic burp/Zboa.Zh : Ljava/lang/Object;
    ...
    //   465: athrow
    //   466: getstatic burp/Zgfm.ZE : Ljava/lang/String;
    //   469: getstatic burp/Zm81.Zy : Ljava/lang/Object;
    ...
    //   487: getstatic burp/Zsdn.Zf : Ljava/lang/String;
    //   490: getstatic burp/Zgr4.ZL : Ljava/lang/Object;
  ...
  static void ZD(Object paramObject) {
    Zl4v.ZD = a(-18843, 2000);
    Zl4v.ZT = new BigInteger(a(-18847, -28672));
    boolean bool = Zt2e.ZK();
    try {
      try {
        if (Zelz.ZK.charAt(Math.abs(((BigInteger)Zec0.Zg).intValue() % 32)) > Zl4v.ZD.charAt(Math.abs(((BigInteger)Zboa.Zh).intValue() % 32))) {
          try {
            Zlbr.Zv(Class.forName(a(-18848, -31036)));
            if (bool)
              Ze3z.Zz(Class.forName(a(-18844, 2744))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'û¨,¸L4£\$ £;FÜLj¸ø"ZÚüî\\t;q-òj)U\\táÍ*øÜù BTÊWé³ó-d¾(öÃùF¡^\\r~¥ÀÊ`M¼-âuÄhÔTJ\\bì¢ö¢³düÂÏÆ{×Ì0¸7|ÜGî3Ú¦Ù%Qã­»¾EÞÐí2º4¼ÚìÝ7¿òn\\tÃn<pÐ yÌÑ'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc 'ýDwuT*8M84ÂÚåWCKÎÁ-Åzüö\\bÒOúÝ¸"9Æã@ôµws\\nQ\\t;v#×dÓE3gsç¸å¼¿wÍ,£\¹Kp÷ÆrÎN1øò'
    //   70: dup
    //   71: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zty4.a : [Ljava/lang/String;
    //   132: bipush #9
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zty4.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zty4.Zu : Ljava/lang/String;
    ...
    //   328: putstatic burp/Zty4.ZQ : Ljava/lang/Object;
    //   331: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFB665) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zty4.class
