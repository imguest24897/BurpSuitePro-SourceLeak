...
class Zt_t extends Ztn0 {
  private static final Ztwu ZJ;
  
  private final List<Zmj3> ZW = new ArrayList<>();
  ...
  protected Comparator<?> ZS(int paramInt) {
    return (paramInt == 1) ? ZJ : super.ZS(paramInt);
  }
  ...
  public Object getValueAt(int paramInt1, int paramInt2) {
    try {
      if (paramInt1 >= this.ZW.size())
        return Zl(paramInt2); 
      Zmj3 zmj3 = this.ZW.get(paramInt1);
      switch (paramInt2) {
        case 0:
          return (zmj3.Ze2()).toolName;
        case 1:
          return zmj3.Zod();
        case 2:
          return Zkb.ZG(zmj3.ZlL().ZdH());
        case 3:
          return zmj3.ZJ();
        case 4:
          return Long.valueOf(zmj3.ZoB());
      } 
  ...
  private Object Zl(int paramInt) {
    switch (paramInt) {
      case 0:
      case 2:
      case 3:
  ...
  Zll9 ZZ(int paramInt) {
    return (paramInt < 0 || paramInt > this.ZW.size()) ? null : this.ZW.get(paramInt);
  }
  
  void Zb(Zmj3 paramZmj3) {
    String str = Zl41.ZU();
    synchronized (this.ZW) {
      for (Zmj3 zmj3 : this.ZW) {
        if (Zewd.ZI(paramZmj3.ZoO(), zmj3.ZoO()))
          return; 
        if (str != null)
          break; 
      } 
      int i = this.ZW.size();
      this.ZW.add(paramZmj3);
  ...
  Zmj3[] ZK() {
    synchronized (this.ZW) {
      Zmj3[] arrayOfZmj3 = new Zmj3[this.ZW.size()];
      this.ZW.toArray(arrayOfZmj3);
      return arrayOfZmj3;
    } 
  }
  ...
  static {
    ...
    //   122: goto -> 80
    //   125: aload #5
    //   127: putstatic burp/Zt_t.a : [Ljava/lang/String;
    //   130: iconst_5
    //   131: anewarray java/lang/String
    //   134: putstatic burp/Zt_t.b : [Ljava/lang/String;
    //   137: goto -> 296
    //   140: dup_x2
    //   141: pop
    ...
    //   303: putstatic burp/Zt_t.ZJ : Lburp/Ztwu;
    //   306: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zt_t.class
