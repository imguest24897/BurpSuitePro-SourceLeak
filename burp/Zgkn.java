...
class Zgkn extends ClassLoader {
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'øCå`¸£4ÐÌû*ëYÙÒõ=DÐÒjuÙÓÅbÈ\\t=?FÌaDS:µ\\nWj\\tÑßÛÐÒ"cû\\tÇ$¯y'ßÚãA\\bÏÒËÖc\\tµ)WCMP¿Md ³áÈ\Y1«­=UÃ¤ß%gÎ_L?\\f[â9´ÚÔ)^<bY6ÄsN³ÕÙÅÙBpÕ¯çzfÊû­U'f|iþõsá½H'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc 'OÜÕ\\rH¾®?\\fDrJÑM 1S¥ÁMëòÎ`í§\\b)¼ãòØÖ'
    //   70: dup
    //   71: astore_2
