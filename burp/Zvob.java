...
class Zvob extends ClassLoader {
  static String Zn;
  ...
  static void ZT(Object paramObject) {
    Ze1k.ZI = a(30792, -15562);
    Ze1k.ZD = new BigInteger(a(30793, 12449));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zegv.ZA.charAt(Math.abs(((BigInteger)Zti7.Zw).intValue() % 32)) <= Zlo0.ZD.charAt(Math.abs(((BigInteger)Zkjj.Zh).intValue() % 32))) {
          try {
            Zeyd.ZJ(Class.forName(a(30797, 5305)));
            if (!bool)
              Zssc.Zk(Class.forName(a(30795, -1469))); 
  ...
  static boolean ZO(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   577: putstatic burp/Zsbo.ZG : Ljava/lang/Object;
    //   580: sipush #13931
    //   583: getstatic burp/Zle9.ZI : Ljava/lang/Object;
    //   586: checkcast java/math/BigInteger
    //   589: getstatic burp/Zk7o.ZO : Ljava/lang/Object;
    //   592: checkcast java/math/BigInteger
    //   595: invokevirtual subtract : (Ljava/math/BigInteger;)Ljava/math/BigInteger;
    //   598: putstatic burp/Zk7o.ZO : Ljava/lang/Object;
    ...
    //   923: athrow
    //   924: getstatic burp/Zr36.Ze : Ljava/lang/String;
    //   927: getstatic burp/Zrex.Zr : Ljava/lang/Object;
    ...
    //   945: getstatic burp/Zb9q.Zk : Ljava/lang/String;
    ...
    //   966: if_icmpgt -> 1081
    //   969: getstatic burp/Zkjj.ZT : Ljava/lang/String;
    //   972: getstatic burp/Zm_u.Zf : Ljava/lang/Object;
    ...
    //   990: getstatic burp/Zelt.ZJ : Ljava/lang/String;
    //   993: getstatic burp/Zzi_.Zf : Ljava/lang/Object;
    ...
    //   1020: athrow
    //   1021: getstatic burp/Zttd.Ze : Ljava/lang/String;
    //   1024: getstatic burp/Zs_m.Z_ : Ljava/lang/Object;
    ...
    //   1042: getstatic burp/Zrjq.Zx : Ljava/lang/String;
    //   1045: getstatic burp/Zbow.ZS : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '*¯%\Û"ÉàÐ:x#JãÖÍ:}«ãF6á!n)cÈø8W¨ê9¿WzíâZSDöOÚ%~\\b,ë9½l ú,ï7ø\\r´s`ùí¶VÁ"ðc÷ê<©wAuïÓ\\t_ç°ß9¿~&P)\\t¨NáæxÂw \\nµÁÏèÆµnØµ[^|\\fÍ'xÌë­wf8\\tå]çÓUÌhë'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc 'VGÛªË\\rM7ÄgôYEÚÞÕÀí1=ÞÊsíVn1%x¢¬L }>ª©*tb$?ÏH=)ðÎUµfîoòç1(¸#¸BïFõ®'
    //   70: dup
    //   71: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zvob.a : [Ljava/lang/String;
    //   132: bipush #9
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zvob.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zvob.Zn : Ljava/lang/String;
    ...
    //   328: putstatic burp/Zvob.ZX : Ljava/lang/Object;
    //   331: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zvob.class
