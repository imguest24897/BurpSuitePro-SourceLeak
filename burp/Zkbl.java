...
class Zkbl extends SwingWorker<Void, Void> {
  final Zbgc ZT;
  
  Zkbl(Zbgc paramZbgc) {}
  
  protected Void Zp() throws Exception {
    this.ZT.ZB();
    return null;
  }
  ...
  protected void done() {
    ...
    //   8: pop
    //   9: aload_0
    //   10: getfield ZT : Lburp/Zbgc;
    //   13: getfield ZO : Lburp/Zrk1;
    //   16: invokevirtual ZH : ()V
    //   19: goto -> 136
    //   22: astore_2
    //   23: aload_2
    ...
    //   122: astore #5
    //   124: aload_0
    //   125: getfield ZT : Lburp/Zbgc;
    //   128: getfield ZO : Lburp/Zrk1;
    //   131: aload #5
    //   133: invokevirtual ZU : (Ljava/lang/String;)V
    //   136: return
    // Exception table:
    //   from	to	target	type
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zkbl.class
