...
class Zem6 extends ClassLoader {
  static String Zp;
  ...
  static void Ze(Object paramObject) {
    Zm81.ZY = a(-31969, -25192);
    Zm81.Zy = new BigInteger(a(-31980, 3703));
    boolean bool = Zt2e.ZK();
    try {
      try {
        if (Zgr4.Zi.charAt(Math.abs(((BigInteger)Zm81.Zy).intValue() % 32)) > Zcc.Zb.charAt(Math.abs(((BigInteger)Zgr4.ZL).intValue() % 32))) {
          try {
            Zzwl.ZU(Class.forName(a(-31984, 22340)));
            if (bool)
              Zeoi.ZR(Class.forName(a(-31978, -32603))); 
  ...
  static boolean ZX(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   577: putstatic burp/Zcc.Zd : Ljava/lang/Object;
    //   580: sipush #-10781
    //   583: getstatic burp/Zelz.Z_ : Ljava/lang/Object;
    //   586: checkcast java/math/BigInteger
    //   589: getstatic burp/Zex0.Ze : Ljava/lang/Object;
    //   592: checkcast java/math/BigInteger
    //   595: invokevirtual add : (Ljava/math/BigInteger;)Ljava/math/BigInteger;
    //   598: putstatic burp/Zmy3.Zx : Ljava/lang/Object;
    ...
    //   923: athrow
    //   924: getstatic burp/Zgds.ZA : Ljava/lang/String;
    //   927: getstatic burp/Zb20.Zq : Ljava/lang/Object;
    ...
    //   945: getstatic burp/Ztp.ZG : Ljava/lang/String;
    //   948: getstatic burp/Zkfb.ZN : Ljava/lang/Object;
    ...
    //   966: if_icmple -> 1073
    //   969: getstatic burp/Zlxm.Zv : Ljava/lang/String;
    //   972: getstatic burp/Zttj.ZF : Ljava/lang/Object;
    ...
    //   990: getstatic burp/Zry0.Zz : Ljava/lang/String;
    //   993: getstatic burp/Zk9s.ZY : Ljava/lang/Object;
    ...
    //   1020: athrow
    //   1021: getstatic burp/Zbli.ZW : Ljava/lang/String;
    //   1024: getstatic burp/Zrnu.Zs : Ljava/lang/Object;
    ...
    //   1042: getstatic burp/Zryq.Zb : Ljava/lang/String;
    //   1045: getstatic burp/Zkk2.Zq : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'X?J<Ô¨\\tÒWj`¢P\ gCþV9iÄWoî7IgKËm½©B(lÀî|6sMWãøeÓÌ$òAëÇí¼ËÍwþÛ &S;Á'ãß\\rÏÛÒ|ÒX¢AÈÎVÇ+}öÈ#YÅ~EÒÍ»³(J{µý~5òxâ¦?(|MbµÑöZUfjr\\fXQòkÑ)0>¡ë*êlh6W\\fD  î|íóÞ¿Ô\\n4Aù^`sö¬Ñwò\\t±;íþ!Üb'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc 'gcìprÛ ãýã\\rG¥íY^ÌL×zo[i:` ^¼ùß'
    //   70: dup
    //   71: astore_2
    ...
    //   123: goto -> 82
    //   126: aload #5
    //   128: putstatic burp/Zem6.a : [Ljava/lang/String;
    //   131: bipush #9
    //   133: anewarray java/lang/String
    //   136: putstatic burp/Zem6.b : [Ljava/lang/String;
    //   139: goto -> 300
    //   142: dup_x2
    //   143: pop
    ...
    //   309: putstatic burp/Zem6.Zp : Ljava/lang/String;
    ...
    //   328: putstatic burp/Zem6.Zm : Ljava/lang/Object;
    //   331: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFF8317) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zem6.class
