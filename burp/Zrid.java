...
public class Zrid implements Zm51 {
  private final Zs88 Zf;
  
  private final Zgsj ZK;
  
  private final Object Zi = new Object();
  
  private volatile Zm51 Zn = Zd;
  ...
  public Zrid(Zs88 paramZs88, ScheduledExecutorService paramScheduledExecutorService) {
    this.Zf = paramZs88;
    this.ZK = new Zgsj(this::Ze, paramScheduledExecutorService);
  }
  
  public void Zl() {
    Zm51 zm51 = ZW();
    zm51.compile(a(2143, 22062), a(2142, -1456));
    zm51.complete(a(2140, 13033), 4);
  }
  
  public CompilationResult compile(String paramString1, String paramString2) {
    this.ZK.Zz(1L, TimeUnit.MINUTES);
    return ZW().compile(paramString1, paramString2);
  }
  
  public List<CompletionProposal> complete(String paramString, int paramInt) {
    this.ZK.Zz(30L, TimeUnit.MINUTES);
    return ZW().complete(paramString, paramInt);
  }
  
  public JavadocNode javadoc(String paramString1, String paramString2, Signature paramSignature) {
    this.ZK.Zz(30L, TimeUnit.MINUTES);
    return ZW().javadoc(paramString1, paramString2, paramSignature);
  }
  ...
  static {
    ...
    //   7: istore_3
    //   8: iconst_0
    //   9: ldc '.úè:uªOñïa½=åh17*yõ¯/,u{\)TqVêª£Ày5JÎ¤80Y`:^FÙ©¤!'
    //   11: dup
    //   12: astore_2
    ...
    //   68: goto -> 26
    //   71: aload #5
    //   73: putstatic burp/Zrid.a : [Ljava/lang/String;
    //   76: iconst_3
    //   77: anewarray java/lang/String
    //   80: putstatic burp/Zrid.b : [Ljava/lang/String;
    //   83: goto -> 231
    //   86: dup_x2
    //   87: pop
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zrid.class
