...
public class Zlcq {
  ...
  static String Ze(byte[] paramArrayOfbyte, Zs68 paramZs68, Zkk3 paramZkk3, boolean paramBoolean) {
    int[] arrayOfInt = paramZkk3.Zh(paramArrayOfbyte, null, paramZs68.Zk);
    if (arrayOfInt == null)
      return null; 
  ...
  public static Zlwx Zu(Zmo2 paramZmo2) {
    Zzqp zzqp = new Zzqp();
    zzqp.Zm(a(-31048, 11527), paramZmo2.ZuR());
    zzqp.Zj(a(-31045, -22113), paramZmo2.ZuY());
    paramZmo2.Zu7().ZY(zzqp);
    return zzqp;
  }
  
  public static Zmo2 ZS(Zlwx paramZlwx, Zr_4 paramZr_4) throws Zzam {
    Zmo2 zmo2 = paramZr_4.<Zmo2>ZH(new Zmah());
    Zvt zvt = paramZlwx.Zf();
    zmo2.ZoJ(zvt.ZC(a(-31046, -9909)));
    String[] arrayOfString = ZY();
    try {
      zmo2.Znt(zvt.Z_(a(-31047, -30989)));
      zmo2.Zu7().Zs(zvt);
      if (Zbqc.Zwu() == null)
        ZU(new String[2]); 
    } catch (Zzam zzam) {
  ...
  static {
    ...
    //   130: goto -> 88
    //   133: aload #5
    //   135: putstatic burp/Zlcq.b : [Ljava/lang/String;
    //   138: iconst_4
    //   139: anewarray java/lang/String
    //   142: putstatic burp/Zlcq.c : [Ljava/lang/String;
    //   145: goto -> 304
    //   148: dup_x2
    //   149: pop
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFF86B9) & 0xFFFF;
    if (c[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zlcq.class
