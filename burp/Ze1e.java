...
class Ze1e extends DocumentFilter {
  ...
  public void insertString(DocumentFilter.FilterBypass paramFilterBypass, int paramInt, String paramString, AttributeSet paramAttributeSet) throws BadLocationException {
    try {
      if (paramString != null)
        try {
          if (paramString.matches(a(32284, -13326)))
  ...
  public void replace(DocumentFilter.FilterBypass paramFilterBypass, int paramInt1, int paramInt2, String paramString, AttributeSet paramAttributeSet) throws BadLocationException {
    try {
      if (paramString != null)
        try {
          if (paramString.matches(a(32285, 22544)))
  ...
  static {
    ...
    //   63: goto -> 21
    //   66: aload #5
    //   68: putstatic burp/Ze1e.a : [Ljava/lang/String;
    //   71: iconst_2
    //   72: anewarray java/lang/String
    //   75: putstatic burp/Ze1e.b : [Ljava/lang/String;
    //   78: goto -> 227
    //   81: dup_x2
    //   82: pop
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Ze1e.class
