...
class Zrva extends ClassLoader {
  static Object ZE;
  ...
  static boolean Zm(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   11: astore_3
    //   12: getstatic burp/Zxzz.ZT : Ljava/lang/String;
    //   15: astore #4
    //   17: iconst_0
    //   18: istore #5
    //   20: iload #5
    ...
    //   61: astore #5
    //   63: getstatic burp/Zli5.Zt : Ljava/lang/Object;
    ...
    //   2521: putstatic burp/Ztkh.Zh : Ljava/lang/Object;
    //   2524: sipush #-29124
    ...
    //   2849: athrow
    //   2850: getstatic burp/Zsxh.Z_ : Ljava/lang/String;
    //   2853: getstatic burp/Zm8v.ZU : Ljava/lang/Object;
    ...
    //   2871: getstatic burp/Zsf7.ZS : Ljava/lang/String;
    //   2874: getstatic burp/Zk7f.Za : Ljava/lang/Object;
    ...
    //   2892: if_icmpgt -> 2999
    //   2895: getstatic burp/Zevr.Zk : Ljava/lang/String;
    //   2898: getstatic burp/Zeuc.Zd : Ljava/lang/Object;
    ...
    //   2916: getstatic burp/Zztn.ZY : Ljava/lang/String;
    //   2919: getstatic burp/Zr2i.ZD : Ljava/lang/Object;
    ...
    //   2946: athrow
    //   2947: getstatic burp/Zram.Ze : Ljava/lang/String;
    //   2950: getstatic burp/Zlrm.ZM : Ljava/lang/Object;
    ...
    //   2968: getstatic burp/Zzc_.Zg : Ljava/lang/String;
    //   2971: getstatic burp/Zl39.ZA : Ljava/lang/Object;
  ...
  static void ZO(Object paramObject) {
    Zm3p.ZE = a(5625, 16240);
    Zm3p.Zz = new BigInteger(a(5626, -13740));
    boolean bool = Zt2e.ZK();
    try {
      try {
        if (Zs34.Zq.charAt(Math.abs(((BigInteger)Zkt7.ZY).intValue() % 32)) <= Zxn5.ZI.charAt(Math.abs(((BigInteger)Ze_t.Za).intValue() % 32))) {
          try {
            Zt98.Zi(Class.forName(a(5628, 14972)));
            if (bool)
              Zt5t.ZP(Class.forName(a(5620, 21715))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'p:<óà¥­Õï(6åY*UÐ+°Q8¬°.(î#>揷矞漿れ柶ﻛꯣ쫴줜蘒䝒귥ꊷ鱓牌뜂鍂㛎㐘燪㇏Ѭ⍾ᡣՒܿ聁닖कⱜᮃ婷勈홌⦓⼻卻"⁽녯檢뻑䩙墬킽꩝䏈㌏䔱ɘ傛龏兮䃣鈢㣂밯?჆췴ፎ徱䑜쒳绿摽ᤶ恽伲⋇郎䛅롑?ூ㨁䦰⒋숆곤酙㞣赞丘泒斉깖먻║Ჳ됧瓐䮧謫灼뗝䡕應埒蘬᷶颢榫軆魺蝰칻⠀谑覌뽤䊦䅨ⴂ냶뮘\\t¨ìí|Þ³¶3GÝ\\rk§®.£\\fÚûÆÍx`M%ÌllwÈq}ùÝd¬i¹?0rÀÌFÏÙ-0)Ä¦À!P´÷j¢I Ä-TNhã$Ös'k^­Àµf×Fä\\tAÀÑÛ³IW´\\tYÒL»êE|5 ÇùÅ~¼pûÆßwL<¡¥==³«,§28ìêÞ{挓矠濸〟朎ﺩ꯼쪺짿﫩䜮규ꈸ鱴犽럦鍼㙒㒋熘㇐Т⎝ᢪԮ܆胎눧ৱⱢᬟ媰剛횴⧡⼤匵Á₴넓檛빞䩾塝큙ꩣ䍔㏈䖢ʠ僩龐儠䀀鋫㢾밖?ს촐፰弭䒛쐠縇搏ᤩ怳俑∎邲䛼룞?ଳ㨿䤬⑌슕개鄫㝀趗乤泫斮꺧뫟╯ᰯ든琨䯕謴瀲딾䢜懰坝蘋ᴇ颜椷踁鯩螈츉⠟豟襯뾭䋚䅑ⶍ냑뭩'
    //   11: dup
    //   12: astore_2
    ...
    //   123: goto -> 81
    //   126: aload #5
    //   128: putstatic burp/Zrva.a : [Ljava/lang/String;
    //   131: bipush #11
    //   133: anewarray java/lang/String
    //   136: putstatic burp/Zrva.b : [Ljava/lang/String;
    //   139: goto -> 300
    //   142: dup_x2
    //   143: pop
    ...
    //   498: putstatic burp/Zrva.ZE : Ljava/lang/Object;
    //   501: sipush #5630
    //   504: sipush #-16065
    //   507: invokestatic a : (II)Ljava/lang/String;
    //   510: putstatic burp/Zrva.Zr : Ljava/lang/String;
    //   513: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zrva.class
