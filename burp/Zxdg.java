...
class Zxdg extends ClassLoader {
  static Object ZK;
  ...
  static void ZH(Object paramObject) {
    Zgt7.ZO = a(29532, -6369);
    Zgt7.Zn = new BigInteger(new byte[] { 
          29, 122, 121, 67, -90, 61, 111, 46, -5, -102, 
          119, 22, 70, 91, -62, -117, 92, -92, -114, 24, 
          20, -121, -13, -47, -77, -37, 120, 63, -110, 11, 
          44, -85 });
    boolean bool = Zt2e.ZK();
    try {
      try {
        if (Zm14.ZE.charAt(Math.abs(((BigInteger)Zl2q.Zg).intValue() % 32)) <= Zm1l.Zp.charAt(Math.abs(((BigInteger)Zrqd.Zi).intValue() % 32))) {
          try {
            Ztkc.Ze(Class.forName(a(29529, -10238)));
            if (bool)
              Zzip.ZQ(Class.forName(a(29535, 7206))); 
  ...
  static boolean ZI(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   446: athrow
    //   447: getstatic burp/Zmtf.Zx : Ljava/lang/String;
    //   450: getstatic burp/Zefm.ZP : Ljava/lang/Object;
    ...
    //   468: getstatic burp/Zztz.Zp : Ljava/lang/String;
    //   471: getstatic burp/Zl8y.ZD : Ljava/lang/Object;
    ...
    //   489: if_icmpgt -> 604
    //   492: getstatic burp/Zr5k.Zq : Ljava/lang/String;
    //   495: getstatic burp/Ztkc.ZV : Ljava/lang/Object;
    ...
    //   513: getstatic burp/Zmlu.ZF : Ljava/lang/String;
    //   516: getstatic burp/Zry0.Zr : Ljava/lang/Object;
    ...
    //   543: athrow
    //   544: getstatic burp/Zmji.Zs : Ljava/lang/String;
    //   547: getstatic burp/Zxpb.Zo : Ljava/lang/Object;
    ...
    //   565: getstatic burp/Zejj.ZQ : Ljava/lang/String;
    //   568: getstatic burp/Zzs9.ZO : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '1mKÄÓ\\t\\nL,¹aWF^ ^\\bzF[8 ù½©ÁõkÝ kç±gw¯uQÒc0^wLOSµ*/ñÖ»SWÏ!îÁ\\fô7'K!DþÔÑó ´]âNVùsÀ_ ÿ¸â¡x¬fQ\5dªIB©e¶ÕuµÃ\\t×OÙMª\\th]pOy&'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc '±Û½©±»©ç *« ?_¹ðóÛpAJj"õ3xA*B¨¹Vò'
    //   70: dup
    //   71: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zxdg.a : [Ljava/lang/String;
    //   132: bipush #9
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zxdg.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   316: putstatic burp/Zxdg.ZK : Ljava/lang/Object;
    //   319: sipush #29526
    //   322: sipush #-28469
    //   325: invokestatic a : (II)Ljava/lang/String;
    //   328: putstatic burp/Zxdg.ZG : Ljava/lang/String;
    //   331: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zxdg.class
