...
class Ze84 extends ClassLoader {
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'ûvi[é\àãMhÆcÏ\\t0ÿy£½ÿs'ú¤3Fô°·(\\n ÐP¢0[þ±ßH;¹c¹¨_7ôí%K³ç¾LÑ%åV*õDù·I¹ìN<¨1°Oÿ\\tãUê¼ÈS.·­ Âr]æd?eÑPãNíGü@ÛÙ§kÍÃmß#3\\t»º 3zH{o¡à x¯ÿJ)E«î2mï'½öÌ¬k·V\V×#÷ \\fh Æã§NCqØþ©ÖuÁ4¯­êÌ{¨»²Xl'
    //   11: dup
    //   12: astore_2
