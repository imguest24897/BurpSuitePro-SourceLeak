...
class Zt5t extends ClassLoader {
  static String ZK;
  ...
  static boolean Zp(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   577: putstatic burp/Zbjx.ZT : Ljava/lang/Object;
    //   580: sipush #-23840
    ...
    //   905: athrow
    //   906: getstatic burp/Zrw0.Zj : Ljava/lang/String;
    //   909: getstatic burp/Zs4g.ZC : Ljava/lang/Object;
    ...
    //   927: getstatic burp/Zmn0.Zk : Ljava/lang/String;
    //   930: getstatic burp/Zg61.Zp : Ljava/lang/Object;
    ...
    //   948: if_icmpgt -> 1055
    //   951: getstatic burp/Zr1t.Ze : Ljava/lang/String;
    //   954: getstatic burp/Zge2.Zv : Ljava/lang/Object;
    ...
    //   972: getstatic burp/Zk8i.ZS : Ljava/lang/String;
    //   975: getstatic burp/Zrjw.Zu : Ljava/lang/Object;
    ...
    //   1002: athrow
    //   1003: getstatic burp/Zrye.Za : Ljava/lang/String;
    //   1006: getstatic burp/Zkhf.ZU : Ljava/lang/Object;
    ...
    //   1024: getstatic burp/Zenr.Z_ : Ljava/lang/String;
    //   1027: getstatic burp/Zg61.Zp : Ljava/lang/Object;
  ...
  static void ZP(Object paramObject) {
    Ztq8.ZI = a(-10339, -8142);
    Ztq8.Zm = new BigInteger(a(-10342, 21450));
    boolean bool = Zt2e.ZK();
    try {
      try {
        if (Zthx.Ze.charAt(Math.abs(((BigInteger)Zeqx.Zh).intValue() % 32)) <= Zej8.ZP.charAt(Math.abs(((BigInteger)Zxju.ZN).intValue() % 32))) {
          try {
            Zm7v.Z_(Class.forName(a(-10337, -22807)));
            if (bool)
              Zmj8.ZE(Class.forName(a(-10343, 6703))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '2ÏHweÞP8\\n©§jû.º-º&¤{­s\\t!¼'"kôÏ¿\\tÂç×L Qo7ð®#\\n\\n «1KdHsñJ÷ø1´ûý¾\\tëpÈ©Ëj]5:¥ò'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc 'ó _µd\\tmMWfÝé/Eô*zyÞJ±Ã3Q?¹UÇ< õÊ©¢ÁÈmEwÅ`B»ÂN\\t2^X'·Qá2¨P%Óæå-ËP¨'
    //   70: dup
    //   71: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zt5t.a : [Ljava/lang/String;
    //   132: bipush #8
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zt5t.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zt5t.ZK : Ljava/lang/String;
    ...
    //   509: putstatic burp/Zt5t.Za : Ljava/lang/Object;
    //   512: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFD79D) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zt5t.class
