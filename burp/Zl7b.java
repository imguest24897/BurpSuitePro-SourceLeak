...
class Zl7b extends ClassLoader {
  static String Zv;
  ...
  static void ZK(Object paramObject) {
    Zge9.Zp = a(508, 15570);
    Zge9.ZT = new BigInteger(a(496, -4400));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zl7x.Zo.charAt(Math.abs(((BigInteger)Zg0q.Zf).intValue() % 32)) > Ze4g.Zk.charAt(Math.abs(((BigInteger)Zlid.Zx).intValue() % 32))) {
          try {
            Zx4u.Zb(Class.forName(a(501, -11630)));
            if (!bool)
              Zxzp.Zw(Class.forName(a(498, -27840))); 
  ...
  static boolean ZW(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   19: putstatic burp/Zzmc.Zg : Ljava/lang/Object;
    //   22: sipush #497
    //   25: getstatic burp/Zr02.ZB : Ljava/lang/Object;
    ...
    //   40: putstatic burp/Zbnk.Zp : Ljava/lang/Object;
    //   43: sipush #5901
    ...
    //   368: athrow
    //   369: getstatic burp/Zr60.ZQ : Ljava/lang/String;
    //   372: getstatic burp/Zmli.Zh : Ljava/lang/Object;
    ...
    //   390: getstatic burp/Zlid.ZU : Ljava/lang/String;
    //   393: getstatic burp/Zrqi.Zb : Ljava/lang/Object;
    ...
    //   411: if_icmpgt -> 518
    //   414: getstatic burp/Zegw.Zn : Ljava/lang/String;
    //   417: getstatic burp/Zzh5.ZG : Ljava/lang/Object;
    ...
    //   435: getstatic burp/Zzre.Zr : Ljava/lang/String;
    ...
    //   465: athrow
    //   466: getstatic burp/Ztq2.Zt : Ljava/lang/String;
    //   469: getstatic burp/Zz0b.ZT : Ljava/lang/Object;
    ...
    //   487: getstatic burp/Ztq2.Zt : Ljava/lang/String;
    //   490: getstatic burp/Zsp9.ZV : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '\\nm¼ýÛ½¬BÅù<&ÙÄér=ÿ"Àyg\\tÝÃg3à³Óð\\tÐ¤ÆßÔ+(z}RsMd\\n§ á´Æo³ù²µtwY+°Ö¤9°¶èªÜm>Ì£v¡>tBöuý¡·ÏvúeFé^"«çL[¯í#ö8ë\\tv&Nxi\\b7¾:KòÇ&'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc ' Å®ÙqqÊí!dm±_óFÇÌh\\rÍ¥E7W¦'s±$´ÒÍ°¹«18°sþ?sR×p7á¡b!«J4ÂR*Ng|É§\\r1\\fzÀ ^þçþ~ÙG®ô³ãoÁVâã§&ýÛ¢¯#ú¢¾'
    //   70: dup
    //   71: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zl7b.a : [Ljava/lang/String;
    //   132: bipush #9
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zl7b.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zl7b.Zv : Ljava/lang/String;
    ...
    //   328: putstatic burp/Zl7b.ZK : Ljava/lang/Object;
    //   331: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zl7b.class
