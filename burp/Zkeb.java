...
class Zkeb extends ClassLoader {
  static String ZW;
  ...
  static boolean ZE(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   0: invokestatic ZK : ()Z
    //   3: istore_2
    //   4: getstatic burp/Zk5k.Zr : Ljava/lang/Object;
    ...
    //   351: iconst_0
    //   352: istore_3
    //   353: getstatic burp/Zzk_.ZX : Ljava/lang/String;
    //   356: getstatic burp/Zxju.ZN : Ljava/lang/Object;
    ...
    //   374: getstatic burp/Zmdf.Zo : Ljava/lang/String;
    //   377: getstatic burp/Zrm6.Z_ : Ljava/lang/Object;
    ...
    //   1081: iload_3
    //   1082: ireturn
    //   1083: getstatic burp/Zssc.ZR : Ljava/lang/String;
    //   1086: getstatic burp/Zes.Zx : Ljava/lang/Object;
    ...
    //   1104: getstatic burp/Zk92.Zc : Ljava/lang/String;
    //   1107: getstatic burp/Zt5t.Za : Ljava/lang/Object;
    ...
    //   1812: iload_3
    //   1813: ireturn
    //   1814: getstatic burp/Zxan.ZJ : Ljava/lang/String;
    //   1817: getstatic burp/Zld9.ZF : Ljava/lang/Object;
    ...
    //   1835: getstatic burp/Zrl5.ZG : Ljava/lang/String;
    //   1838: getstatic burp/Zreu.Zi : Ljava/lang/Object;
    ...
    //   2543: iload_3
    //   2544: ireturn
    //   2545: getstatic burp/Zlid.ZU : Ljava/lang/String;
    //   2548: getstatic burp/Zr60.Ze : Ljava/lang/Object;
    ...
    //   2566: getstatic burp/Ze4g.Zk : Ljava/lang/String;
    //   2569: getstatic burp/Zxzv.Zg : Ljava/lang/Object;
  ...
  static void ZK(Object paramObject) {
    Ze7e.Zc = a(4267, 14223);
    Ze7e.Z_ = new BigInteger(a(4261, -2990));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zkhf.Zb.charAt(Math.abs(((BigInteger)Zbx5.ZL).intValue() % 32)) > Zz4a.ZC.charAt(Math.abs(((BigInteger)Zt85.Zl).intValue() % 32))) {
          try {
            Zedq.ZB(Class.forName(a(4274, -31862)));
            if (!bool)
              Zgco.ZZ(Class.forName(a(4270, 5130))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'ZÛ MÆ%0ÛEU2Ô~Z³ 6CJå}-ÙÛ÷2\\bÏ3¯æ®K»ptRÌòS MØ¬­v6±ûý¢ºHÉÚ4ªhtÐC)­Î`\\tãÒì*¨¦+C\\tëA\\rBJÀ\\to"}4ey®\\tÀÒhoîÍ\\n\\tJkÙ@áV\\t¡ä¤ì¡~Áj\\tg¥|Äº{w~\\b\\tkTýú¼{Ò\\t9y·_Ã\\bO\\b§\\t4àl÷nÀ>\\ta¼¢¢·uêj\\t@#&ì©|\\tâ>Ì·¬³®G 7M?èrX^É?Á}2ä%Ö~tÓ¥P÷DNc Ð?#QÞôUÊP Ú3 \\r]>9n©\6áìº:ÀMÎìR®:¿ÿ\\t\£ëÊèä!ÿ?oz*3ã'¢«#*GP3]V4\\b\\f¿à4é²¼k¼éO ×{CLMu¼3uOØ·Ð,¦þ\\tö\\bNqüÍ¡¸\\t3ÕöÊëºH\\bW\\t%bÔyyq\\t¤µÓ~8\\t4[÷ÔL9\\tKùò\\n½véÏ'
    //   11: dup
    //   12: astore_2
    ...
    //   122: goto -> 80
    //   125: aload #5
    //   127: putstatic burp/Zkeb.a : [Ljava/lang/String;
    //   130: bipush #26
    //   132: anewarray java/lang/String
    //   135: putstatic burp/Zkeb.b : [Ljava/lang/String;
    //   138: goto -> 300
    //   141: dup_x2
    //   142: pop
    ...
    //   309: putstatic burp/Zkeb.ZW : Ljava/lang/String;
    ...
    //   328: putstatic burp/Zkeb.ZH : Ljava/lang/Object;
    //   331: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zkeb.class
