...
class Zlna extends ClassLoader {
  static String Zo;
  ...
  static boolean ZL(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   0: invokestatic ZN : ()Z
    //   3: istore_2
    //   4: getstatic burp/Zx_x.Zi : Ljava/lang/Object;
    ...
    //   1371: athrow
    //   1372: getstatic burp/Zzxv.Z_ : Ljava/lang/String;
    //   1375: getstatic burp/Zzrb.Zj : Ljava/lang/Object;
    ...
    //   1393: getstatic burp/Zr04.ZA : Ljava/lang/String;
    //   1396: getstatic burp/Zlnq.ZO : Ljava/lang/Object;
    ...
    //   1414: if_icmple -> 1529
    //   1417: getstatic burp/Zgt6.Zu : Ljava/lang/String;
    //   1420: getstatic burp/Zrod.ZX : Ljava/lang/Object;
    ...
    //   1438: getstatic burp/Zzrb.ZA : Ljava/lang/String;
    //   1441: getstatic burp/Zmpp.Z_ : Ljava/lang/Object;
    ...
    //   1468: athrow
    //   1469: getstatic burp/Zrhu.ZJ : Ljava/lang/String;
    //   1472: getstatic burp/Zejj.Zy : Ljava/lang/Object;
    ...
    //   1490: getstatic burp/Zrs0.Zt : Ljava/lang/String;
    //   1493: getstatic burp/Zlav.Zp : Ljava/lang/Object;
  ...
  static void Zt(Object paramObject) {
    Zzou.ZN = a(-27374, 24256);
    Zzou.Zz = new BigInteger(a(-27362, -17966));
    boolean bool = Zt2e.ZK();
    try {
      try {
        if (Ztdx.Zl.charAt(Math.abs(((BigInteger)Zzxs.Zg).intValue() % 32)) > Ztdx.Zl.charAt(Math.abs(((BigInteger)Zlnq.ZO).intValue() % 32))) {
          try {
            Zkfa.Zm(Class.forName(a(-27365, 15554)));
            if (bool)
              Zlhm.Z_(Class.forName(a(-27372, -3773))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '©?«´DäÕD×­.ªÙæF¶Âã¢«¢¬Ü!¶4-|uÔ9î°èïh)8ÉiM0ýuÅë\\fGùZÐAÔ©1ØLOøT°¦FæÃswÈ\\tÎ0Ö ÂG÷ÉpçZ µ»IÔ'lTÔóóB·­E"\\tSÒÃ ®~ÆãRÎdl +ñQS ÅYÆS¾½b*g2\\no\\tmÑ¢LÀ;n«LRÜ0¸t(ö7B0^T~aOZÿ¿O`ä/­q`×ÁßKç;*îöÇ6ÛíÂÊ&~Ôh®Ù«Ô{\\b0Z§ö)l/ P\\t¼åØnë\\tâÌú\\fíÁ\\téÇ2^^yeã y¸D&eÞU8ÿhÍíbÔWvréw°:§\ïàÕdá{Ãø\\t'
    //   11: dup
    //   12: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zlna.a : [Ljava/lang/String;
    //   132: bipush #15
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zlna.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zlna.Zo : Ljava/lang/String;
    ...
    //   328: putstatic burp/Zlna.ZG : Ljava/lang/Object;
    //   331: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFF9519) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zlna.class
