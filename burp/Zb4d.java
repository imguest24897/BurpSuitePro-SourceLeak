...
class Zb4d extends ClassLoader {
  static String ZS;
  ...
  static boolean Zo(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   596: athrow
    //   597: getstatic burp/Zl_a.ZD : Ljava/lang/String;
    //   600: getstatic burp/Zt4p.Zh : Ljava/lang/Object;
    ...
    //   618: getstatic burp/Zmc_.Zb : Ljava/lang/String;
    //   621: getstatic burp/Zthx.ZH : Ljava/lang/Object;
    ...
    //   639: if_icmple -> 746
    //   642: getstatic burp/Zr14.ZL : Ljava/lang/String;
    //   645: getstatic burp/Zsko.ZD : Ljava/lang/Object;
    ...
    //   663: getstatic burp/Zg61.ZX : Ljava/lang/String;
    //   666: getstatic burp/Zrjw.Zu : Ljava/lang/Object;
    ...
    //   693: athrow
    //   694: getstatic burp/Zsdl.ZJ : Ljava/lang/String;
    //   697: getstatic burp/Zgio.ZP : Ljava/lang/Object;
    ...
    //   715: getstatic burp/Zka9.ZM : Ljava/lang/String;
    //   718: getstatic burp/Zebe.Zw : Ljava/lang/Object;
  ...
  static void Zj(Object paramObject) {
    Zk8f.ZV = a(12782, 28104);
    Zk8f.ZG = new BigInteger(a(12773, -20522));
    boolean bool = Zt2e.ZK();
    try {
      try {
        if (Zz7j.ZP.charAt(Math.abs(((BigInteger)Zebc.Zr).intValue() % 32)) <= Zej8.ZP.charAt(Math.abs(((BigInteger)Zz4j.Zu).intValue() % 32))) {
          try {
            Zr14.ZL(Class.forName(a(12768, -20599)));
            if (bool)
              Ze_l.Zv(Class.forName(a(12770, 29782))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'S¬=¸ \\bíúÚê}Ëµîu­n µ£?9d$û|\\t%´¶faRñ÷:lMãû¼é§ê0×Y¹Îk4ÿAü>O\ÉYë8ËÕ¥&à~]Bü·©zHñïÌ¶¡Q$º6¬ Ò-¢NFÔa´½ÖoÖ\\t×zØÙ.\\t´Dq£ãvâ\\t6#!O~?M3'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc 'I%`PÖx×æ Øö\\tæÉUÖ-i¡'éøc-¾»òâJA^Y[R`>¦S¬PÃ\\f@y¦Uv{Ö9. ú¨ô2@â\\ff5µd*#Ïn·zóÃ­ëÁIË@ '
    //   70: dup
    //   71: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zb4d.a : [Ljava/lang/String;
    //   132: bipush #9
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zb4d.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zb4d.ZS : Ljava/lang/String;
    ...
    //   328: putstatic burp/Zb4d.Ze : Ljava/lang/Object;
    //   331: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zb4d.class
