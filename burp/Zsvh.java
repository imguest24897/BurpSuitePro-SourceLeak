...
class Zsvh extends ClassLoader {
  static Object Zv;
  ...
  static boolean Zn(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   11: astore_3
    //   12: getstatic burp/Zgil.ZK : Ljava/lang/String;
    //   15: astore #4
    //   17: iconst_0
    //   18: istore #5
    //   20: iload #5
    ...
    //   61: astore #5
    //   63: getstatic burp/Zgmo.Zo : Ljava/lang/Object;
    ...
    //   2850: iconst_0
    //   2851: istore_3
    //   2852: getstatic burp/Zssb.ZY : Ljava/lang/String;
    //   2855: getstatic burp/Zlfg.Zv : Ljava/lang/Object;
    ...
    //   2873: getstatic burp/Zstq.ZL : Ljava/lang/String;
    //   2876: getstatic burp/Zs4v.ZB : Ljava/lang/Object;
    ...
    //   3580: iload_3
    //   3581: ireturn
    //   3582: getstatic burp/Zsvh.ZV : Ljava/lang/String;
    //   3585: getstatic burp/Zmjw.ZD : Ljava/lang/Object;
    ...
    //   3603: getstatic burp/Zx0t.Ze : Ljava/lang/String;
    //   3606: getstatic burp/Zg8.ZX : Ljava/lang/Object;
    ...
    //   4311: iload_3
    //   4312: ireturn
    //   4313: getstatic burp/Zts_.Zx : Ljava/lang/String;
    //   4316: getstatic burp/Zmjw.ZD : Ljava/lang/Object;
    ...
    //   4334: getstatic burp/Zmwu.ZM : Ljava/lang/String;
    //   4337: getstatic burp/Ztjh.ZU : Ljava/lang/Object;
    ...
    //   5042: iload_3
    //   5043: ireturn
    //   5044: getstatic burp/Zgil.ZK : Ljava/lang/String;
    //   5047: getstatic burp/Zgb9.Zb : Ljava/lang/Object;
    ...
    //   5065: getstatic burp/Zb9d.Zh : Ljava/lang/String;
    //   5068: getstatic burp/Zge1.ZK : Ljava/lang/Object;
  ...
  static void ZT(Object paramObject) {
    Zgfq.Zn = a(-27417, 9180);
    Zgfq.Za = new BigInteger(a(-27398, 20798));
    boolean bool = Zt2e.ZK();
    try {
      try {
        if (Zm54.Zg.charAt(Math.abs(((BigInteger)Zzuh.ZV).intValue() % 32)) > Zg8.ZE.charAt(Math.abs(((BigInteger)Zlfg.Zv).intValue() % 32))) {
          try {
            Zbu6.ZX(Class.forName(a(-27404, 15880)));
            if (bool)
              Zm5p.Zh(Class.forName(a(-27393, -16299))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '@'*òïÄX\\tNîÏJcìõ\\tÈ{¡Ðm\\t0Â\\t3x÷°M\\t6ÕÉt+$ç:g\\tGç/îOFf\\tfLÃGjBÐñm\\t=^µa2MÉ=Oa­ ­UÜ=\  ¼Zì®`!&u*.ìuñ¾2ªòÖ´ÎrpÞ\\n¹OÂi|P$}¢þ\\tüTÓj~[ìET+}K$ß\\tÌ½yÀó揉眩澑す柪ﻀꮠ쪾즂塀䝲괏ꈒ鳎狑띇鎡㚕㓒熚ㇷв⎊ᡡխ޿肏뉟ऺⲤᯇ媨剩홁⧷⽩匾É―넻橙븋䫕堾킍꫏䏧㎫䖄ȿ僤鿂允䁣鈱㢂벾?ၕ춯Ꭷ徊䒒쐝纇摨ᤐ怩侦⊾邕䙋룺?ୁ㪂䦐⑚싂곷鄷㜬贸丩氷敥꺿멯◍᳹뒝瓗䮣謂灝딸䡘愸坨蛛ᴀ顕榚蹨鮯蝬칠⡃豛褒뽽䊆䆂⶧끫묅\\t©:=U\\r$E\\t`rÀ\\n\\t`­rÔUD!ä+R\\tAù'ñöO-Z ºÚ7·±¶`kÅaÛSªÈ*%>­n} \\r\\tY$Þq\Ê\\tâôSPx ô:\\tB0GÈú³ÅÚ#\\tÎÍÖwÈDh¾ ªz¾òQ-Ê%®§Õ½QO°lR'pÇ±ãKèg\\trA_:AÅ捒矪濩〷查︍ꭁ쨇즾﨎䟵귩ꋢ鰒狏럜鍢㛦㒼煗ㄖҋ⎶ᡖתݙ聿뉁ডⱧ᮴嫐切홎⤺⾈厇õ•놼檿뻻䨉堠퀖ꨌ䎔㏓䗪Ȱ倩鼣凸䁟鈆㠅뱘?ႉ촴፤忹䓪쑳纈撥᧱悐侚⊉递䚭렊?ୟ㩁䧣␢슬곸釺㜐贏亮泑方꺡뫴┎ᲊ듥瓘䭮诣烤딄䡯懞垘蘇ᴞ颖槩踐鯁蝣캭⢢賢褮뽊䈁䅤ⵗ낷묛Ðw'ih´"íï\\fýeä\¶\\t.-·ËtÞ"'
    //   11: dup
    //   12: astore_2
    ...
    //   123: goto -> 81
    //   126: aload #5
    //   128: putstatic burp/Zsvh.a : [Ljava/lang/String;
    //   131: bipush #28
    //   133: anewarray java/lang/String
    //   136: putstatic burp/Zsvh.b : [Ljava/lang/String;
    //   139: goto -> 300
    //   142: dup_x2
    //   143: pop
    ...
    //   497: putstatic burp/Zsvh.Zv : Ljava/lang/Object;
    //   500: sipush #-27422
    //   503: sipush #-5283
    //   506: invokestatic a : (II)Ljava/lang/String;
    //   509: putstatic burp/Zsvh.ZV : Ljava/lang/String;
    //   512: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFF94F2) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zsvh.class
