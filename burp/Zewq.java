...
class Zewq extends ClassLoader {
  static String ZV;
  ...
  static boolean ZT(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   19: putstatic burp/Zrly.ZB : Ljava/lang/Object;
    //   22: sipush #-6299
    //   25: sipush #-7681
    ...
    //   350: athrow
    //   351: getstatic burp/Zgja.Zb : Ljava/lang/String;
    //   354: getstatic burp/Zva.Zu : Ljava/lang/Object;
    ...
    //   372: getstatic burp/Zz0.ZX : Ljava/lang/String;
    //   375: getstatic burp/Zx58.ZE : Ljava/lang/Object;
    ...
    //   393: if_icmpgt -> 508
    //   396: getstatic burp/Zl39.ZI : Ljava/lang/String;
    //   399: getstatic burp/Zzc_.Zi : Ljava/lang/Object;
    ...
    //   417: getstatic burp/Zeh9.ZF : Ljava/lang/String;
    //   420: getstatic burp/Zxo6.Zw : Ljava/lang/Object;
    ...
    //   447: athrow
    //   448: getstatic burp/Zxzd.ZM : Ljava/lang/String;
    //   451: getstatic burp/Zrye.Zx : Ljava/lang/Object;
    ...
    //   469: getstatic burp/Zk8b.ZT : Ljava/lang/String;
    //   472: getstatic burp/Zlem.ZI : Ljava/lang/Object;
  ...
  static void ZD(Object paramObject) {
    Zmec.Zi = a(-6297, 7108);
    Zmec.ZY = new BigInteger(a(-6304, 26675));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zlzs.Zp.charAt(Math.abs(((BigInteger)Zefn.ZJ).intValue() % 32)) <= Zrp3.Zf.charAt(Math.abs(((BigInteger)Ztsc.Zr).intValue() % 32))) {
          try {
            Ztdg.Zn(Class.forName(a(-6303, -13258)));
            if (!bool)
              Zgia.ZR(Class.forName(a(-6301, -13874))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '+³n]È%6M¤ìáàÒiØçóÚ&õÓüÄÑïçû¾hë5-tã0ºaj*[a6Ñø$[eÜcQõG/i÷i[8R(\\tb/GÎíã(J\\béø8%#å\\tÖÊÑr?tÄÏËrº'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc 'ES³Óo¹hÞV¥Ì°ÜLàá®úí 6y ¼ùYohØÚìlµàAjÛmý¶¦Ýs`=@Wî}×'
    //   70: dup
    //   71: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zewq.a : [Ljava/lang/String;
    //   132: bipush #8
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zewq.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zewq.ZV : Ljava/lang/String;
    ...
    //   509: putstatic burp/Zewq.ZO : Ljava/lang/Object;
    //   512: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFE761) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zewq.class
