...
class Zlqm extends ClassLoader {
  static String ZQ;
  ...
  static void ZB(Object paramObject) {
    Zsq6.Zm = a(4593, -19404);
    Zsq6.ZS = new BigInteger(a(4599, 19790));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zsji.Zr.charAt(Math.abs(((BigInteger)Zxz_.Zv).intValue() % 32)) <= Zxti.ZD.charAt(Math.abs(((BigInteger)Zk7b.ZR).intValue() % 32))) {
          try {
            Zep8.ZN(Class.forName(a(4597, 20740)));
            if (!bool)
              Zexn.Zg(Class.forName(a(4595, 24806))); 
  ...
  static boolean ZZ(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   19: putstatic burp/Zb8x.Zz : Ljava/lang/Object;
    //   22: sipush #4598
    //   25: sipush #-11169
    ...
    //   350: athrow
    //   351: getstatic burp/Zm3s.Ze : Ljava/lang/String;
    //   354: getstatic burp/Zz80.ZR : Ljava/lang/Object;
    ...
    //   375: getstatic burp/Zeyd.Zl : Ljava/lang/Object;
    ...
    //   393: if_icmple -> 508
    //   396: getstatic burp/Zz5h.Zk : Ljava/lang/String;
    ...
    //   417: getstatic burp/Zg_i.ZW : Ljava/lang/String;
    //   420: getstatic burp/Zltp.ZT : Ljava/lang/Object;
    ...
    //   447: athrow
    //   448: getstatic burp/Zlqm.ZQ : Ljava/lang/String;
    ...
    //   469: getstatic burp/Zmou.ZP : Ljava/lang/String;
    //   472: getstatic burp/Zxz_.Zv : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'ð]¯ÿÁÓû]Dn;_¾=IJ¹ÑÙSÌh[ÉÝI5¥\\tØeUïÅ\\tÁ?´Z1æ]\\tY§S>U¢ ã\\fÜRgØOÒ.Òýaæ¯\\fnV­ )f9ÇÏ'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc 'ª á÷´?¹ÒJ\\fÁ®sPéDüø¯ï[$¬ZdØñqh_cã«6êhP\\fx¾{úÌ¹ùÀÔ@ÖÖÔfs¾O\\t¶ïJ{¥f£q'
    //   70: dup
    //   71: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zlqm.a : [Ljava/lang/String;
    //   132: bipush #8
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zlqm.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zlqm.ZQ : Ljava/lang/String;
    ...
    //   509: putstatic burp/Zlqm.Zw : Ljava/lang/Object;
    //   512: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zlqm.class
