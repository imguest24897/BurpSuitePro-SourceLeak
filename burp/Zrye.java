...
class Zrye extends ClassLoader {
  static String Za;
  ...
  static void ZF(Object paramObject) {
    Zx4u.ZL = a(11476, 76);
    Zx4u.Zn = new BigInteger(a(11472, -13961));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zgeq.ZF.charAt(Math.abs(((BigInteger)Zzn6.ZO).intValue() % 32)) > Zlcc.Zw.charAt(Math.abs(((BigInteger)Zmlr.Zh).intValue() % 32))) {
          try {
            Zs9k.Za(Class.forName(a(11478, -13652)));
            if (!bool)
              Zmh3.Zs(Class.forName(a(11479, 19120))); 
  ...
  static boolean Zp(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   0: invokestatic ZN : ()Z
    //   3: istore_2
    //   4: getstatic burp/Zk7o.ZO : Ljava/lang/Object;
    //   7: checkcast java/math/BigInteger
    //   10: getstatic burp/Zb_1.ZK : Ljava/lang/Object;
    ...
    //   350: athrow
    //   351: getstatic burp/Zek4.Zo : Ljava/lang/String;
    //   354: getstatic burp/Zsfg.Zm : Ljava/lang/Object;
    ...
    //   372: getstatic burp/Zelt.ZJ : Ljava/lang/String;
    //   375: getstatic burp/Zelt.ZC : Ljava/lang/Object;
    ...
    //   393: if_icmple -> 508
    //   396: getstatic burp/Zz4a.ZC : Ljava/lang/String;
    //   399: getstatic burp/Zgsb.Zl : Ljava/lang/Object;
    ...
    //   417: getstatic burp/Ze2w.Za : Ljava/lang/String;
    //   420: getstatic burp/Zea9.Zt : Ljava/lang/Object;
    ...
    //   447: athrow
    //   448: getstatic burp/Zlt1.ZA : Ljava/lang/String;
    //   451: getstatic burp/Zmdf.ZH : Ljava/lang/Object;
    ...
    //   469: getstatic burp/Zz0f.ZW : Ljava/lang/String;
    //   472: getstatic burp/Zxxh.Za : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '\\tÌXàùR\\tC»§ÎTÐçMÛÙ­©þDö{|Ú/ßüóq}¼Àº&86ú¤V(\\f18é®x._÷äðÄ0ÌPÊÇ&Ô\\tø©Ä](y5âïwE¼ÿ{© ÞQl;Ò^Y³/Hü%Óxö1~iUíÑ\ÅR\\t %ÏÝ´ò\\t´]YÒRU·®'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc '>3xäUdT÷³°H@ÿMsÔ¤" `ÁÕ\\r ªÚ'
    //   70: dup
    //   71: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zrye.a : [Ljava/lang/String;
    //   132: bipush #8
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zrye.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   171: bipush #7
    //   173: irem
    //   174: tableswitch default -> 240, 0 -> 212, 1 -> 217, 2 -> 221, 3 -> 225, 4 -> 230, 5 -> 235
    //   212: bipush #83
    //   214: goto -> 242
    //   217: iconst_3
    //   218: goto -> 242
    ...
    //   309: putstatic burp/Zrye.Za : Ljava/lang/String;
    ...
    //   508: putstatic burp/Zrye.Zx : Ljava/lang/Object;
    //   511: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zrye.class
