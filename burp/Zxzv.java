...
class Zxzv extends ClassLoader {
  static Object Zg;
  ...
  static void Zd(Object paramObject) {
    Zrzg.ZX = a(20968, -32695);
    Zrzg.ZA = new BigInteger(a(20960, 15845));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zs8w.ZR.charAt(Math.abs(((BigInteger)Zskf.ZQ).intValue() % 32)) > ZI.charAt(Math.abs(((BigInteger)Zkjj.Zh).intValue() % 32))) {
          try {
            Zxcn.ZE(Class.forName(a(20975, 27979)));
            if (!bool)
              Zbqk.Zm(Class.forName(a(20970, 28556))); 
  ...
  static boolean Z_(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   11: astore_3
    //   12: getstatic burp/Zmn0.Zk : Ljava/lang/String;
    //   15: astore #4
    //   17: iconst_0
    //   18: istore #5
    //   20: iload #5
    ...
    //   61: astore #5
    //   63: getstatic burp/Zka9.Zd : Ljava/lang/Object;
    ...
    //   2521: putstatic burp/Zzh5.ZG : Ljava/lang/Object;
    //   2524: sipush #-10460
    //   2527: getstatic burp/Zr1h.Z_ : Ljava/lang/Object;
    //   2530: checkcast java/math/BigInteger
    //   2533: getstatic burp/Zeqz.ZG : Ljava/lang/Object;
    //   2536: checkcast java/math/BigInteger
    //   2539: invokevirtual add : (Ljava/math/BigInteger;)Ljava/math/BigInteger;
    //   2542: putstatic burp/Zlab.ZM : Ljava/lang/Object;
    ...
    //   2867: athrow
    //   2868: getstatic burp/Zxwf.ZX : Ljava/lang/String;
    //   2871: getstatic burp/Zso.ZA : Ljava/lang/Object;
    ...
    //   2889: getstatic burp/Zsjw.ZQ : Ljava/lang/String;
    //   2892: getstatic burp/Zg7e.Zr : Ljava/lang/Object;
    ...
    //   2910: if_icmple -> 3017
    //   2913: getstatic burp/Zlcc.Zw : Ljava/lang/String;
    //   2916: getstatic burp/Zlgh.Zd : Ljava/lang/Object;
    ...
    //   2934: getstatic burp/Ztle.ZR : Ljava/lang/String;
    //   2937: getstatic burp/Ze4g.Zz : Ljava/lang/Object;
    ...
    //   2964: athrow
    //   2965: getstatic burp/Zvh.ZP : Ljava/lang/String;
    //   2968: getstatic burp/Zly9.Zz : Ljava/lang/Object;
    ...
    //   2986: getstatic burp/Zxd1.ZQ : Ljava/lang/String;
    //   2989: getstatic burp/Zedq.Zy : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '¡,4RÖE\\fÕAc,¶u¶î¿©æ4yßáM`7í´º5·õWüÀ>£ÚPtFÍ-Ýüùýò^<Ûl;çdÈÆ¡YU_!L"B\àAá×ÜMº£»ò¬Rz\\f\\t²ýÓ5à\\t\\fæmYÎÏRà ÆÛdÍ$?DúPÑeí`Ë÷§éùqÎDd¶7捱瞩濊リ柎ﺥꬃ쨚줕﫦䞭궻ꋺ鱿狄랒鍈㘂㐳熮ㄹӿ⍾ᢗנ݆耶눣ঌⱤᬂ媗務홅⦪⿄叚o₮뇧櫍뻛䩪填큩ꩂ䍳㏹䕝ɘ傐鼽凨䂔鋧㠷뱉?Ⴘ촚ፇ彷䒣쓭纲摑ᦾ惭伸∋选䛮롎?଴㨁䥄␹쉿겓酣㞛跟仸泃新꺩몚├ᱠ뒯瓚䮔诬炨뗂䣮憥埒蘧ᵄ飕楮踳鬜蝈츅⣠賿覅뾢䉙䄶ⵏ냚묐ÿ\z\\t)ÉÇVi®M»WÃS°A<d</Q\\fëFL!Â5f`ÛÊÖ¶:üK99æÙ?Y­Ê»Hsf+NFU¦Ãq\\nR)C¡õgá¼yÃ¦Øó\+¥Ñ*AÝÈ'VøW£MÏ®'
    //   11: dup
    //   12: astore_2
    ...
    //   64: istore_1
    //   65: goto -> 23
    //   68: ldc '掲瞰漁【束︒ꯙ쨄즦鬒䜳괶ꋁ鰦牋띑鍑㚒㓉焙㇣ӡ⏍ᢼվߋ耍늬ॏⱽᮒ婜刣훔⤝⼞叄Ü₅녹橀뻠䨳壤킪꩛䏣㌲䖧ˉ倧鿧凶䀧鋌㢩별?ს췙፞忧䑨쐗縣擦ᥤ想例∠邗䙣롵?஻㨘䧔⓲슅갂釔㜨跴书汎早긦멙┅ᳰ둤瑋䬣謶炶땱䣅愨埩虾᷋飌槾軸鯦蟙캲⠺賡褶뾉䋇䆻⵴낃뮟\\tószmfÎ='
    //   70: dup
    //   71: astore_2
    ...
    //   125: goto -> 83
    //   128: aload #5
    //   130: putstatic burp/Zxzv.a : [Ljava/lang/String;
    //   133: bipush #12
    //   135: anewarray java/lang/String
    //   138: putstatic burp/Zxzv.b : [Ljava/lang/String;
    //   141: goto -> 300
    //   144: dup_x2
    //   145: pop
    ...
    //   316: putstatic burp/Zxzv.Zg : Ljava/lang/Object;
    //   319: sipush #20972
    //   322: sipush #19469
    //   325: invokestatic a : (II)Ljava/lang/String;
    //   328: putstatic burp/Zxzv.ZI : Ljava/lang/String;
    //   331: return
  }
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zxzv.class
