...
class Zzju extends ClassLoader {
  static String Zp;
  ...
  static void ZC(Object paramObject) {
    Ze69.ZA = a(-12550, -24178);
    Ze69.ZH = new BigInteger(a(-12546, 7933));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zr9b.ZC.charAt(Math.abs(((BigInteger)Zs75.Zo).intValue() % 32)) > Zr3j.Zj.charAt(Math.abs(((BigInteger)Zgmt.ZX).intValue() % 32))) {
          try {
            Zr8s.Zz(Class.forName(a(-12545, -26688)));
            if (!bool)
              Zkqx.Zt(Class.forName(a(-12547, 16839))); 
  ...
  static boolean ZR(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   446: athrow
    //   447: getstatic burp/Ze8m.Zx : Ljava/lang/String;
    //   450: getstatic burp/Zli5.Zt : Ljava/lang/Object;
    ...
    //   468: getstatic burp/Zram.Ze : Ljava/lang/String;
    //   471: getstatic burp/Zx6d.ZU : Ljava/lang/Object;
    ...
    //   489: if_icmpgt -> 596
    //   492: getstatic burp/Ze5f.Zt : Ljava/lang/String;
    //   495: getstatic burp/Zzmu.Zy : Ljava/lang/Object;
    ...
    //   513: getstatic burp/Ztcv.Zl : Ljava/lang/String;
    //   516: getstatic burp/Zke7.Zj : Ljava/lang/Object;
    ...
    //   543: athrow
    //   544: getstatic burp/Zli5.Zq : Ljava/lang/String;
    //   547: getstatic burp/Zkll.Zl : Ljava/lang/Object;
    ...
    //   565: getstatic burp/Zs4z.Zs : Ljava/lang/String;
    //   568: getstatic burp/Zkb_.ZG : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'Agq±\\tßq¢s¹¦M¯ªez;6:(kßDëPKjMÙ£àãµã"+ÿôþfýà³¶¡K#ÁAOÚý(ÜÆcÖ1ÆÓûüÍzíßOûü¡c`¢\\n©!ä\\tÔ¥Ãé H ç_ NlÅ³ªbNrÂM=.¸vyVH·$Ûø*gV\\t`8Qß_í1  ê°O§\\t9§¶Jº<¢7}rGåº­ñÝ-·M»º2ÉýÝµ(rVÝÔÐáÕ.+¹LsJYÒUUÖÀïYËÚ¼!7Ë+¡F[`âb¥X×C\\bôg»ydsÐ\\rSÍy§'
    //   11: dup
    //   12: astore_2
    ...
    //   123: goto -> 81
    //   126: aload #5
    //   128: putstatic burp/Zzju.a : [Ljava/lang/String;
    //   131: bipush #10
    //   133: anewarray java/lang/String
    //   136: putstatic burp/Zzju.b : [Ljava/lang/String;
    //   139: goto -> 300
    //   142: dup_x2
    //   143: pop
    ...
    //   309: putstatic burp/Zzju.Zp : Ljava/lang/String;
    ...
    //   328: putstatic burp/Zzju.ZG : Ljava/lang/Object;
    //   331: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFCEFC) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zzju.class
