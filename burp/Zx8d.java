...
public class Zx8d {
      ...
      if (paramString != null)
        try {
          if (!paramString.isEmpty()) {
            String str = paramString.replaceAll(a(-18948, -32478), "");
            try {
              MessageDigest messageDigest = MessageDigest.getInstance(a(-18947, -7857));
  ...
  static {
    ...
    //   64: goto -> 22
    //   67: aload #5
    //   69: putstatic burp/Zx8d.a : [Ljava/lang/String;
    //   72: iconst_2
    //   73: anewarray java/lang/String
    //   76: putstatic burp/Zx8d.b : [Ljava/lang/String;
    //   79: goto -> 227
    //   82: dup_x2
    //   83: pop
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zx8d.class
