...
class Zx4y extends ClassLoader {
  static String Zh;
  ...
  static boolean Zk(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   16: invokestatic ZT : (Ljava/lang/Object;)V
    //   19: sipush #-30582
    //   22: getstatic burp/Zmlr.Zh : Ljava/lang/Object;
    //   25: checkcast java/math/BigInteger
    //   28: getstatic burp/Zxn5.Zd : Ljava/lang/Object;
    //   31: checkcast java/math/BigInteger
    //   34: invokevirtual add : (Ljava/math/BigInteger;)Ljava/math/BigInteger;
    //   37: putstatic burp/Zxn5.Zd : Ljava/lang/Object;
    //   40: sipush #-18558
    ...
    //   366: iconst_0
    //   367: istore_3
    //   368: getstatic burp/Zlna.Zo : Ljava/lang/String;
    //   371: getstatic burp/Zrs0.Zz : Ljava/lang/Object;
    ...
    //   389: getstatic burp/Zgt6.Zu : Ljava/lang/String;
    //   392: getstatic burp/Zlsw.ZJ : Ljava/lang/Object;
    ...
    //   1096: iload_3
    //   1097: ireturn
    //   1098: getstatic burp/Zlr2.ZV : Ljava/lang/String;
    //   1101: getstatic burp/Ztkc.ZV : Ljava/lang/Object;
    ...
    //   1119: getstatic burp/Zl8y.ZY : Ljava/lang/String;
    //   1122: getstatic burp/Zeqo.ZZ : Ljava/lang/Object;
    ...
    //   1827: iload_3
    //   1828: ireturn
    //   1829: getstatic burp/Zdk.Ze : Ljava/lang/String;
    //   1832: getstatic burp/Zefm.ZP : Ljava/lang/Object;
    ...
    //   1850: getstatic burp/Zr5k.Zq : Ljava/lang/String;
    //   1853: getstatic burp/Zro5.ZT : Ljava/lang/Object;
    ...
    //   2558: iload_3
    //   2559: ireturn
    //   2560: getstatic burp/Zkco.Zz : Ljava/lang/String;
    //   2563: getstatic burp/Zbzc.Zp : Ljava/lang/Object;
    ...
    //   2581: getstatic burp/Zeb3.ZG : Ljava/lang/String;
    //   2584: getstatic burp/Zme.Zd : Ljava/lang/Object;
  ...
  static void ZD(Object paramObject) {
    Zmji.Zs = a(-30568, 28687);
    Zmji.ZB = new BigInteger(a(-30575, -9123));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zrod.ZQ.charAt(Math.abs(((BigInteger)Zzxs.Zg).intValue() % 32)) > Zb20.ZL.charAt(Math.abs(((BigInteger)Zecw.ZE).intValue() % 32))) {
          try {
            Zxpb.Zz(Class.forName(a(-30579, 30583)));
            if (!bool)
              Zxyp.ZC(Class.forName(a(-30571, 27985))); 
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'Cè7NáÄ  ÃÅ=òXyðôæ<VáµÎ9²#í\\tòÚ\\t9¨Ö!/»\\t4»£óâm·r\\tin\\bI:kÿ\\t¾ôS\\byê\Û\\tõ·(åð@\\tY2ÂWKæ\\t1W¢|GeØ]Mj«¿ÑU&Ï4oýH¼2Yp_uä¯JyRùbýuÚ ->\\báÂ#æÜæNõG¯.©¸OÉÓ³ Ì½<'Ä4èÚÎO¾Zÿ\\tôÇnP&~\\r\\tç`Ù­P: ûz®x²?h´A®²ÈR¤\\t%#õs¸K9;\\tµäh\\t7\\t·èÓì i Q\\tz<jÛsJ\\tMw-x¶ðì_\\tTõ¯:cT®5\\trgÊzJ²dR\\t¬Ì°°ú&®Î¤ü\\t5`æ07+\\t&kR~¦ëú\\tÁ÷5íSÊo'
    //   11: dup
    //   12: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zx4y.a : [Ljava/lang/String;
    //   132: bipush #26
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zx4y.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zx4y.Zh : Ljava/lang/String;
    ...
    //   507: putstatic burp/Zx4y.Zc : Ljava/lang/Object;
    //   510: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFF8898) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zx4y.class
