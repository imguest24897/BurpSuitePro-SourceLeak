...
class Zs34 extends ClassLoader {
  static String Zq;
  ...
  static void ZT(Object paramObject) {
    Zxg7.Zi = a(-899, -13214);
    Zxg7.Zy = new BigInteger(a(-902, 31232));
    boolean bool = Zt2e.ZK();
    try {
      try {
        if (Zk7e.ZP.charAt(Math.abs(((BigInteger)Zlhy.ZN).intValue() % 32)) <= Ze8i.ZM.charAt(Math.abs(((BigInteger)Zmx6.ZJ).intValue() % 32))) {
          try {
            Zxn5.Ze(Class.forName(a(-905, 7033)));
            if (bool)
              Zz6t.Zk(Class.forName(a(-908, 20179))); 
  ...
  static boolean Zd(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   11: astore_3
    //   12: getstatic burp/Zefo.Zb : Ljava/lang/String;
    //   15: astore #4
    //   17: iconst_0
    //   18: istore #5
    //   20: iload #5
    ...
    //   61: astore #5
    //   63: getstatic burp/Zb8y.ZI : Ljava/lang/Object;
    ...
    //   2521: putstatic burp/Zs_3.ZZ : Ljava/lang/Object;
    //   2524: sipush #-1092
    //   2527: getstatic burp/Zg4w.ZR : Ljava/lang/Object;
    //   2530: checkcast java/math/BigInteger
    //   2533: getstatic burp/Zg_5.ZA : Ljava/lang/Object;
    //   2536: checkcast java/math/BigInteger
    //   2539: invokevirtual add : (Ljava/math/BigInteger;)Ljava/math/BigInteger;
    //   2542: putstatic burp/Zz2e.Zm : Ljava/lang/Object;
    ...
    //   2867: athrow
    //   2868: getstatic burp/Zg4w.ZC : Ljava/lang/String;
    //   2871: getstatic burp/Zg6f.Zl : Ljava/lang/Object;
    ...
    //   2889: getstatic burp/Zs4z.Zs : Ljava/lang/String;
    //   2892: getstatic burp/Zqp.ZA : Ljava/lang/Object;
    ...
    //   2910: if_icmpgt -> 3017
    //   2913: getstatic burp/Zkll.ZX : Ljava/lang/String;
    //   2916: getstatic burp/Ze82.ZR : Ljava/lang/Object;
    ...
    //   2934: getstatic burp/Ze8m.Zx : Ljava/lang/String;
    //   2937: getstatic burp/Zlem.ZI : Ljava/lang/Object;
    ...
    //   2964: athrow
    //   2965: getstatic burp/Zztn.ZY : Ljava/lang/String;
    //   2968: getstatic burp/Zrhp.Zw : Ljava/lang/Object;
    ...
    //   2986: getstatic burp/Zzmw.Zd : Ljava/lang/String;
    //   2989: getstatic burp/Zlck.Zr : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc 'bJrS%Ø捜瞗漡と杭ﺋꯘ쨏짋難䟴궴ꊯ鰱犾럾錫㘍㒬熍ㆣҷ⎯ᡀ֤ܓ聮누৯ⱞᬐ婿剋훽⧔⽑友£‣놮櫙뻞䩪堕퀗ꨢ䍬㍐䖒˯傷龵冣䁕鈫㠣뱒?Ⴅ쵩፦張䐅쑻縘搬᤻惧侤⋈遄䛨롈?୑㨯䥟⒂슳갴酟㝞贁仯泈旽껃뫭┯ᰡ됙琠䮧譭炰땝䠽懳垚蘳ᴳ飫楮軘鮞蟫츫⠻質襛뼬䈀䄹ⴚ낔뭪Üàð>\\rã\\nA6 ¤6øÄ Û ¿$ºsZKJWµmßÔàêS°T!FÏM¿`7 ´Áý!¥ 6ÝïLÍ«S55pz0ÆPN­@oY=sBa9¶ôÉ1ÖÒ1Ll¼Zç\\të2¶êæ°ÀÔ[(âÂÐs@捣睾漜ゔ柊︔ꬬ쫼쥕猪䜧굻ꋕ鳈狱럁鏂㛪㑐焒ㅗф⌱ᠾշߜ耔뉋৐ⲷ᯷婂劷홚⥋⾥匸=⁝녽樖뺤䪓塚퀨꫋䎋㍭䕮Ɉ倨齁児䃋鉕㣰벝?ၜ쵖ᎏ忒䐸쒇线撳᧏怔伺⊶邗䘧렲?ଞ㫆䦸Ⓙ쉏겓釀㟀赿丼氇攄꺌뫒◆᳆됤璇䬸讙灃뗃䡃愼埠蛊ᵼ頂榉軥魢蝌캴⣏谙觅뽒䋓䇶ⵠ끭묥 á·\\fþ9ja(Òyå¦-z|@\\tTâ&|¦ê§PÎvì4\\tTRÃãÅGH»'
    //   11: dup
    //   12: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zs34.a : [Ljava/lang/String;
    //   132: bipush #11
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zs34.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zs34.Zq : Ljava/lang/String;
    ...
    //   508: putstatic burp/Zs34.ZE : Ljava/lang/Object;
    //   511: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFFC7E) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zs34.class
