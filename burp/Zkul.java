...
class Zkul extends ClassLoader {
  static String ZJ;
  ...
  static void Zz(Object paramObject) {
    Zl_9.ZP = a(-13283, 2306);
    Zl_9.ZM = new BigInteger(a(-13288, -4409));
    boolean bool = Zt2e.ZN();
    try {
      try {
        if (Zmjr.Zc.charAt(Math.abs(((BigInteger)Zeyt.ZR).intValue() % 32)) <= Zeyt.ZS.charAt(Math.abs(((BigInteger)Zeyt.ZR).intValue() % 32))) {
          try {
            Zzwl.ZU(Class.forName(a(-13294, 20905)));
            if (!bool)
              Zm5s.ZC(Class.forName(a(-13284, 19899))); 
  ...
  static boolean Zd(Object[] paramArrayOfObject, Object paramObject) throws Throwable {
    ...
    //   0: invokestatic ZN : ()Z
    //   3: istore_2
    //   4: getstatic burp/Zead.ZI : Ljava/lang/Object;
    ...
    //   4364: putstatic burp/Zty5.Zf : Ljava/lang/Object;
    //   4367: sipush #-13292
    //   4370: sipush #11529
    ...
    //   5052: athrow
    //   5053: getstatic burp/Zbxp.ZS : Ljava/lang/String;
    //   5056: getstatic burp/Zls_.ZR : Ljava/lang/Object;
    ...
    //   5074: getstatic burp/Zmiy.ZT : Ljava/lang/String;
    //   5077: getstatic burp/Zkvr.Zb : Ljava/lang/Object;
    ...
    //   5095: if_icmple -> 5202
    //   5098: getstatic burp/Zty5.Za : Ljava/lang/String;
    //   5101: getstatic burp/Zkul.Zb : Ljava/lang/Object;
    ...
    //   5119: getstatic burp/Zxnm.Zw : Ljava/lang/String;
    //   5122: getstatic burp/Zghe.ZJ : Ljava/lang/Object;
    ...
    //   5149: athrow
    //   5150: getstatic burp/Zzv.Zy : Ljava/lang/String;
    //   5153: getstatic burp/Zl1u.Zq : Ljava/lang/Object;
    ...
    //   5171: getstatic burp/Zmt6.Zx : Ljava/lang/String;
    //   5174: getstatic burp/Zr8g.ZF : Ljava/lang/Object;
  ...
  static {
    ...
    //   7: iconst_0
    //   8: istore_3
    //   9: ldc '\\fkãtüè³Ø¦qX©þ:AûìKÊ§Á®÷e°¹«Ä¦¢¤3ÃW2ç¬ÅcÍu<7ËþµÂ®µc´¸ÑbèÈ"\\tûbnP¦íh¢ C]~r<4*ÙÔUFÖ;¬\\bIi l6Ô¥Ñ¿'ÔSn>E·Àaºaw_A±\\ne\\t5!ºO°R| áÒ9 Çåö:E4XMVAÅõºÀAÝ×¯b$õp6Ú\\t1Â:3 Ømµ\\tj\ìàz¢6úºDF\\t¥ï¥áßÛG\\tR'
    //   11: dup
    //   12: astore_2
    ...
    //   124: goto -> 82
    //   127: aload #5
    //   129: putstatic burp/Zkul.a : [Ljava/lang/String;
    //   132: bipush #13
    //   134: anewarray java/lang/String
    //   137: putstatic burp/Zkul.b : [Ljava/lang/String;
    //   140: goto -> 300
    //   143: dup_x2
    //   144: pop
    ...
    //   309: putstatic burp/Zkul.ZJ : Ljava/lang/String;
    ...
    //   509: putstatic burp/Zkul.Zb : Ljava/lang/Object;
    //   512: return
  }
  ...
  private static String a(int paramInt1, int paramInt2) {
    int i = (paramInt1 ^ 0xFFFFCC18) & 0xFFFF;
    if (b[i] == null) {
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zkul.class
