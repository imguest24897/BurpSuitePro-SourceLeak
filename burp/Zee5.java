...
public class Zee5 {
  ...
  public Zee5(Zl0 paramZl0, Zrzg paramZrzg) {
    this.Zp = paramZl0;
    this.Zh = paramZrzg;
    this.ZY = paramZl0.Zh(paramZrzg.Zc(), a(25975, -9760));
  }
  
  public File ZI(String paramString) {
    return this.Zp.Zh(this.ZY, paramString);
  }
  
  public File ZS(String paramString) {
    return this.Zp.ZJ(a(25974, -23328), paramString);
  }
  ...
  public String ZC(String paramString) {
    return this.Zp.Zh(this.Zh.Zc(), paramString).getAbsolutePath();
  }
  
  public boolean ZO(File paramFile) {
    int[] arrayOfInt = ZA();
    ...
    return paramFile.exists() ? paramFile.delete() : true;
  }
  ...
  static {
    ...
    //   67: goto -> 25
    //   70: aload #5
    //   72: putstatic burp/Zee5.a : [Ljava/lang/String;
    //   75: iconst_2
    //   76: anewarray java/lang/String
    //   79: putstatic burp/Zee5.b : [Ljava/lang/String;
    //   82: goto -> 231
    //   85: dup_x2
    //   86: pop
...
/* Location:              C:\Program Files\BurpSuitePro\burpsuite_pro.jar!\burp\Zee5.class
